...
Ext.define('Mplm.store.MachineCuringStore', {
	...
	fields:[     
	     ...
	     proxy: {
	         type: 'ajax',
	         url: CONTEXT_PATH + '/production/machine.do?method=read&&start=0&&limit=100&&orderBy=name_ko&&ascDesc=asc&menu_key=SRO5_SUB',
	         reader: {
	         	type:'json',
	             root: 'datas',
	             totalProperty: 'count',
