console_log('loading MainWareHouseStore....');
/**
 * Item Store
 */
Ext.define('Mplm.store.MainWareHouseStore', {
    extend: 'Ext.data.Store',
	initComponent: function(params) {
		
		console_log('MainWareHouseStore.......');
	...
	fields:[     
	     ...
	     proxy: {
	         type: 'ajax',
	         url: CONTEXT_PATH + '/sales/delivery.do?method=query&main_flag=Y',
	         reader: {
	         	type:'json',
	             root: 'datas',
	             totalProperty: 'count',
