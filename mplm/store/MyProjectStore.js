 ...
 * ProjectStore Store
 */
Ext.define('Mplm.store.MyProjectStore', {
    extend: 'Ext.data.Store',
	initComponent: function(params) {
		
		console_log('MyProjectStore.initComponent');
	...
	fields:[     
	     ...
	     proxy: {
	         type: 'ajax',
	         url: CONTEXT_PATH + '/sales/poreceipt.do?method=myprojectquery', /*1recoed, search by cond, search */
	         reader: {
	         	type:'json',
	             root: 'datas',
	             totalProperty: 'count',
