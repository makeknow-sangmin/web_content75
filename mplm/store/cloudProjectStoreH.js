 ...
 * ProjectStore Store
 */
Ext.define('Mplm.store.cloudProjectStoreH', {
    extend: 'Ext.data.Store',
	initComponent: function(params) {
		
		console_log('cloudProjectStoreUlvc.initComponent');
	...
	fields:[     
	     ...
	     proxy: {
	         type: 'ajax',
	         url: CONTEXT_PATH + '/sales/poreceipt.do?method=hanaroprojectlist&not_complished=Y', /*1recoed, search by cond, search */
	         reader: {
	         	type:'json',
	             root: 'datas',
	             totalProperty: 'count',
