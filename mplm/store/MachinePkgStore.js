...
Ext.define('Mplm.store.MachinePkgStore', {
	...
	proxy: {
		type: 'ajax',
		url: CONTEXT_PATH + '/production/machine.do?method=read&&start=0&&limit=100&&orderBy=name_ko&&ascDesc=desc&reserved_varchar3=PKG&menu_key=SRO5_SUB',
		reader: {
			type: 'json',
			root: 'datas',
			totalProperty: 'count',
