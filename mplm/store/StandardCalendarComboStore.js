/**
 * StandardCalendar Combo Store
 */
Ext.define("Mplm.store.StandardCalendarComboStore", {
    ...
    proxy: {
      type: "ajax",
      url: CONTEXT_PATH + "/admin/calendar.do?method=readCalendar&parentCalendarOnly=Y",
      reader: {
        type: "json",
        root: "datas",
        totalProperty: "count",
