...
(function() {
	...
	*/
    document.write('<link rel="stylesheet" type="text/css" href="' + G_RFXSHARE + '/ext-4.2.2.1144/resources/css/ext-all-debug.css"/>');
    document.write('<script type="text/javascript" src="' + G_RFXSHARE + '/ext-4.2.2.1144/ext-all.js"></script>');
//    if (neptune) {
