(function() {
    ...
    Ext.themeName = theme = 'azzurra-medium';  //getQueryParam('theme') || defaultTheme;
    
    selectedLang = getQueryParam('selectedLanguage') || vLANG;
                    ...
                    listeners: {
                        select: function(combo) {
                            ...
                            if (theme !== defaultTheme) {
                                setParam({ selectedLanguage: theme });
                            } else {
                                removeParam('selectedLanguage');
                            }
                        }
                    }
                }, {
