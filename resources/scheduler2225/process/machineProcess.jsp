...
function lfn_gotoMain() {
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/com/main.css">

	<!--Scheduler styles-->
    <link href="${rfxshare}/scheduler-2.2.25/resources/css/sch-all.css" rel="stylesheet" type="text/css" />
    
	<!--Implementation specific styles-->
    <link href="columnsummary.css" rel="stylesheet" type="text/css" />
    ...
    <script src="machineProcess.js" type="text/javascript"></script>
  </head>
  <body>
  </body>
</html>
