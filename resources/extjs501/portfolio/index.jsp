...
function lfn_gotoMain() {
    ...
    <script id="microloader" type="text/javascript" src="${pageContext.request.contextPath}/view/extjs501/portfolio/bootstrap.js"></script>
...
<body>
<!-- 
<div style="posotion:absolute;top:0;left:0;z-index:-500"><img style="margin: 1px;" src="${pageContext.request.contextPath}/media/ceo.png"/></div>
 -->
 </body>
</html>
