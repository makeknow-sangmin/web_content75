...
Ext.define('Ext.ux.upload.Panel', {
    ...
    config : {
        ...
        selectionMessageText : '선택된 {0} 파일, {1}',
        uploadMessageText : '업로드 진행률 {0}% ({1} / {2})',
        ...
        return {
            ...
            items : [
                ...
                '-',
                {
                    ...
                    cls : 'x-btn-text-icon',
                    glyph: 'xf093@FontAwesome',//iconCls : 'ux-mu-icon-action-upload',
                    scope : this,
                ...
                '-',
                {
                    itemId : 'button_abort',
                    text : this.textAbort,
                    glyph: 'xf04d@FontAwesome', //iconCls : 'ux-mu-icon-action-abort',
                    scope : this,
                ...
                '->',
                {
                    ...
                    glyph: 'xf014@FontAwesome', //         iconCls : 'ux-mu-icon-action-remove',
                    scope : this,
                ...
                '-',
                {
                    ...
                    glyph: 'xf1f8@FontAwesome', //iconCls : 'ux-mu-icon-action-remove',
                    scope : this,
