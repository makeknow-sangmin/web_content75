		         		                    	...
		         		                    	name : 'user_id_srch',
		         		                     	listeners : {
		         									specialkey : function(field, e) {
		         			                          var user_id =	Ext.getCmp('user_id_srch').value;
		         			                          store.getProxy().setExtraParam('user_id_srch', user_id);
			     		                    	...
			     		                    	name : 'user_name_srch',
			     		                     	listeners : {
			     									specialkey : function(field, e) {
			     			                          ...
			     			                          var user_name =	Ext.getCmp('user_name_srch').value;
			     			                     	  var enValue = Ext.JSON.encode(user_name);
			     			                     	console_log(enValue);
			     			                          store.getProxy().setExtraParam('user_name_srch', enValue);
			     			                          if (e.getKey() == Ext.EventObject.ENTER) {
			     						        			store.load(function(){});
			     			                          } 
			     		                     		}
			     				            ...
			     				            },'-',
			     				           {
			    		                        ...
			    		                        handler: function (){	
				    		                          ...
				    		                          if( user_name!=null && user_name!='' ){
				    		                        	  store.getProxy().setExtraParam('user_name_srch', user_name);
				    		                          }
