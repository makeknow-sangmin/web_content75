	...
	Ext.define('Stdmaterial', {
	    	 ...
	    	 fields: /*(G)*/vCENTER_FIELDS,
	    	    proxy: {
					type: 'ajax',
			        api: {
			            read: CONTEXT_PATH + '/admin/stdmaterial.do?method=read', /*1recoed, search by cond, search */
			            create: CONTEXT_PATH + '/admin/stdmaterial.do?method=cloudcreate', /*create record, update*/
			            update: CONTEXT_PATH + '/admin/stdmaterial.do?method=cloudcreate',
