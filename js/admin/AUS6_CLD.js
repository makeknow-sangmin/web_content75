    ...
    handler: function(widget, event) {
    	...
    	var form = Ext.create('Ext.form.Panel', {
            ...
            defaults: {
             ...
             items: [ 
            {
				fieldLabel: getColName('systemCode'),
//			    value: systemCode,
//			    readOnly: true,
...
//				fieldStyle: 'background-color: #E7EEF6; background-image: none;',
				...
				fieldLabel: getColName('codeNameKr'),
//				value: codeNameKr,
				//y: 0 + 1*lineGap,
				name: 'codeNameKr',
				xtype: 'textfield',
//				fieldStyle: 'background-color: #E7EEF6; background-image: none;',
				...
				fieldLabel: getColName('codeNameEn'),
//				value: codeNameEn,
				//y: 0 + 1*lineGap,
				name: 'codeNameEn',
				xtype: 'textfield',
//				fieldStyle: 'background-color: #E7EEF6; background-image: none;',
				...
				fieldLabel: getColName('codeNameZh'),
//				value: codeNameZh,
				//y: 0 + 1*lineGap,
				name: 'codeNameZh',
				xtype: 'textfield',
...
var editHandler = function() {
		var rec = grid.getSelectionModel().getSelection()[0];
		var selectsystemcode = rec.get('systemCode');
		var unique_id = rec.get('unique_id');
...
//						var unique_id = authorities.get('unique_id');
						var systemCode = authorities.get('systemCode');
						var codeNameKr = authorities.get('codeNameKr');
						var codeNameEn = authorities.get('codeNameEn');
						var codeNameZh = authorities.get('codeNameZh');
