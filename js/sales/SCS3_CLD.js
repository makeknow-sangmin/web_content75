	...
	Ext.define('ComBst', {
   	 ...
   	 fields: /*(G)*/vCENTER_FIELDS,
   	    proxy: {
				type: 'ajax',
		        api: {
		            read: CONTEXT_PATH + '/sales/buyer.do?method=read&wa_group=RETAIL', /*1recoed, search by cond, search */
		            create: CONTEXT_PATH + '/sales/buyer.do?method=cloudcreate&wa_group=RETAIL', /*create record, update*/
