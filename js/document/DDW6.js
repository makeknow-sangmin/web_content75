...
function backupConfirm(btn){
    ...
    if (selections) {
        ...
        if(result=='yes') {
        	...
        	Ext.Ajax.request({
    			url: CONTEXT_PATH +  '/supercom.do?method=rollback&rptype=project',
    			params:{
...
//	myprojectStore.load();
//	console_log('storeasdasd');
//	console_log(myprojectStore);
//	console_log('store:adsas');
//	var defualtpjname = myprojectStore.data.items [0];
//	console_log(defualtpjname);
