...
//		    	        layout: 'absolute',
					...
					if(rtg_type=='SO'){
						...
						tabPanel.add({	            
				        	id: 'people-form-panel-div',
				            title: 'PROJECT 진행자 명단',
				            border: false,
				            defaults: {
			    	            anchor: '100%',
			    	            labelWidth: 150
						...
						var simplepanel2 = Ext.getCmp('simple2-form-panel-div');
						simplepanel2.removeAll();
						var datepanel = Ext.getCmp('date-form-panel-div');
						datepanel.removeAll();
						var detailpanel = Ext.getCmp('detail-form-panel-div');
						detailpanel.removeAll();
						var peoplepanel = Ext.getCmp('people-form-panel-div');
						...
						projectStore.load(  function(record) {
							...
							simplepanel2.add({
								fieldLabel:'PROJECT 명',
								xtype:  'displayfield',
								value:record[0].get('pj_name') + '('+record[0].get('pj_code')+')',
								name: 'pj_code',
								anchor: '100%'
							});
							simplepanel2.add({
							...
							simplepanel2.add({
								fieldLabel:'※종전 P/J',
								xtype:  'displayfield',
								value: record[0].get('previouscont'),
								name: 'previouscont',
								anchor: '100%'
							});
							simplepanel2.add({
								fieldLabel:'자체 개발',
								xtype:  'displayfield',
								value: record[0].get('selfdevelopment'),
							...
							simplepanel2.add({
								fieldLabel:'수주일',
								xtype:  'displayfield',
								value: record[0].get('regist_date').substring(0,10),
								name: 'regist_date',
								anchor: '100%'
							});
							simplepanel2.add({
								fieldLabel:'수주금액',
								xtype:  'displayfield',
								value: record[0].get('selling_price'),
								name: 'selling_price',
								anchor: '100%'
							});
							simplepanel2.add({
								fieldLabel:'납품일',
								xtype:  'displayfield',
								value: record[0].get('delivery_plan').substring(0,10),
								name: 'delivery_plan',
								anchor: '100%'
							});
							...
							datepanel.add({
								fieldLabel:'설계완료',
								xtype:  'displayfield',
								value: record[0].get('reserved_timestamp1').substring(0,10),
							...
							datepanel.add({
								fieldLabel:'제작완료',
								xtype:  'displayfield',
								value: record[0].get('end_plan').substring(0,10),
								name: 'end_plan',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'TEST완료',
								xtype:  'displayfield',
								value: record[0].get('reserved_timestamp4').substring(0,10),
							...
							datepanel.add({
								fieldLabel:'납품검사',
								xtype:  'displayfield',
								value: record[0].get('reserved_timestamp5').substring(0,10),
							...
							datepanel.add({
								fieldLabel:'SET_UP기간',
								xtype:  'displayfield',
								value: record[0].get('reserved_timestamp7').substring(0,10) +'~'+ record[0].get('reserved_timestamp8').substring(0,10),								name: 'delivery_plan',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'전체',
								xtype:  'displayfield',
								value: record[0].get('reserved_double7'),
							...
							detailpanel.add({
								fieldLabel:'TOTAL금액',
								xtype:  'displayfield',
								value: record[0].get('total_cost_add')+'원',
								name: 'total_cost_add',
								anchor: '100%'
							});
							detailpanel.add({
								fieldLabel:'설계공수',
								xtype:  'displayfield',
								value: record[0].get('reserved_double1')+'(M/H)',
							...
							detailpanel.add({
								fieldLabel:'설계인건비',
								xtype:  'displayfield',
								value: record[0].get('reserved_double8')+'원',
							...
							detailpanel.add({
								fieldLabel:'제조공수',
								xtype:  'displayfield',
								value: record[0].get('human_plan')+'(M/H)',
								name: 'human_plan',
								anchor: '100%'
							});
							detailpanel.add({
								fieldLabel:'제조인건비',
								xtype:  'displayfield',
								value: record[0].get('reserved_double9')+'원',
							...
							detailpanel.add({
								fieldLabel:'재료비',
								xtype:  'displayfield',
								value: record[0].get('purchase_plan')+'원',
								name: 'purchase_plan',
								anchor: '100%'
							});
							detailpanel.add({
								fieldLabel:'관리비',
								xtype:  'displayfield',
								value: record[0].get('reserved_doublec')+'원',
							...
							detailpanel.add({
								fieldLabel:'기업이윤',
								xtype:  'displayfield',
								value: record[0].get('reserved_doubled')+'원',
							...
							peoplepanel.add({
								fieldLabel:'설계 P/M',
								xtype:  'displayfield',
								value: record[0].get('delivery_plan'),
								name: 'delivery_plan',
								anchor: '100%'
							});
							peoplepanel.add({
						...
						simplepanel2.doLayout();
						datepanel.doLayout();
						detailpanel.doLayout();
						peoplepanel.doLayout();
					...
					if(rtg_type=='FN'){
						...
						projectStore.load(  function(record) {
							...
							simplepanel2.add({
								fieldLabel:'수주일',
								xtype:  'displayfield',
								value:record[0].get('regist_date'),
								name: 'regist_date',
								anchor: '100%'
							});
							simplepanel2.add({
							...
							simplepanel2.add({
								fieldLabel:'납품일',
								xtype:  'displayfield',
								value:record[0].get('delivery_date'),
								name: 'delivery_date',
								anchor: '100%'
							});
							//진행 일정 실적
							datepanel.add({
								fieldLabel:'설계완료(계획/실적)',
								xtype:  'displayfield',
								value:record[0].get('reserved_timestamp1')+' / '+record[0].get('reserved_timestamp2'),
								name: 'reserved_timestamp1',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'조립완료(계획/실적)',
								xtype:  'displayfield',
								value:record[0].get('end_plan')+' / '+record[0].get('reserved_timestampb'),
								name: 'end_plan',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'TEST완료(계획/실적)',
								xtype:  'displayfield',
								value:record[0].get('reserved_timestamp4')+' / '+record[0].get('reserved_timestamp3'),
								name: 'reserved_timestamp4',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'납품검사(계획/실적)',
								xtype:  'displayfield',
								value:record[0].get('reserved_timestamp5')+' / '+record[0].get('reserved_timestamp6'),
								name: 'reserved_timestamp4',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'납품일(계획/실적)',
								xtype:  'displayfield',
								value:record[0].get('delivery_plan')+' / '+record[0].get('delivery_date'),
								name: 'delivery_plan',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'SET-UP 예상',
								xtype:  'displayfield',
								value:record[0].get('reserved_timestamp7')+' ~ '+record[0].get('reserved_timestamp8'),
								name: 'reserved_timestamp7',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'SET-UP 실적',
								xtype:  'displayfield',
								value:record[0].get('reserved_timestamp9')+' ~ '+record[0].get('reserved_timestampa'),
								name: 'reserved_timestamp9',
								anchor: '100%'
							});
							datepanel.add({
								fieldLabel:'전체(계획/실적)',
								xtype:  'displayfield',
								value:record[0].get('reserved_double7') + ' / ' + record[0].get('reserved_doublef'),
								name: 'reserved_double7',
								anchor: '100%'
							});
							...
							detailpanel.add({
						    	fieldLabel:'재료비 (계획/실적)',
						    	xtype:  'displayfield',
						    	value: record[0].get('purchase_plan') + ' / ' + record[0].get('purchase_cost'),
						    	name: 'purchase_plan',
						    	anchor: '100%'
							},{
						    	fieldLabel: '설계 인건비(계획/실적)',
						    	xtype:  'displayfield',
						    	value: record[0].get('reserved_double8') + ' / ' + record[0].get('reserved_doublea'),
						    	name: 'reserved_double8',
						    	anchor: '100%'
							},{
						    	fieldLabel: '제조인건비(계획/실적)',
						    	xtype:  'displayfield',
						    	value: record[0].get('reserved_double9') + ' / ' + record[0].get('reserved_doubleb'),
						    	name: 'reserved_double9',
						    	anchor: '100%'
						    },{
						    	fieldLabel: '기업이윤(계획/실적)',
						    	xtype:  'displayfield',
						    	value: record[0].get('reserved_doubled') + ' / ' + record[0].get('reserved_doublee'),
						    	name: 'reserved_doubled',
						    	anchor: '100%'
						    },{
						    	fieldLabel: '합계(계획/실적)',
						    	xtype:  'displayfield',
						    	value: record[0].get('total_cost_add') + ' / ' + record[0].get('total_cost_end'),
						    	name: 'total_cost_add',
						    	anchor: '100%'
						    },{
						    	fieldLabel: '수주금액',
...
function doSanction(sancType, uidRtgast, rtgType, comment, po_user_uid, win,coord_key3) {
...
//Define sancAction
var sancAction = Ext.create('Ext.Action', {  //오토윈버전
