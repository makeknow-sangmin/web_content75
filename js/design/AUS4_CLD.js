...
var parent_system_code = 'STD_PROCESS_NAME';
var menu_key = "";
		    ...
		    grid.getSelectionModel().on({
		        selectionchange: function(sm, selections) {
		            if (selections.length) {
			        	...
			        	console_log(record);
			        	group_code = record.get('unique_id');
...
//							    			        		Ext.Ajax.request({
//							    			        			url: CONTEXT_PATH + '/production/schdule.do?method=createMemeberCLD',
//							    			        			params:{
//							    			        				dept_code : dept_code,
//							    			        				dept_name : dept_name,
//							    			        				user_name : user_name,
