...
Ext.onReady(function() { 
	...
	target.removeAll();
	target.add({  tag : 'h2', html: '<div id="chartdiv" align="center">Chart will load here</div>'  });
	
	
	if (GALLERY_RENDERER && GALLERY_RENDERER.search(/javascript|flash/i)==0)  FusionCharts.setCurrentRenderer(GALLERY_RENDERER); 
    var chart = new FusionCharts( CONTEXT_PATH + "/Charts/MSColumn2D.swf", "ChartId", "560", "400", "0", "0");
