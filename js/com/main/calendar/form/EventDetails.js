...
Ext.define('Ext.calendar.form.EventDetails', {
    ...
    onSave: function(){
        ...
        this.fireEvent(this.activeRecord.phantom ? 'eventadd' : 'eventadd'/*'eventupdate'*/, this, this.activeRecord);
    },
