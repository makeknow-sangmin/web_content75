...
var storeEquipStateTable1 = new Ext.data.Store({  
	model: 'EquipStateTable1'//,
//	data: [
//	       {
//			pre_mass: 	'', 
//            car: 		'', 
...
var storeEquipStateTable2 = new Ext.data.Store({  
	model: 'EquipStateTable2'
});

var gridEquipStateTable1 = Ext.create('Ext.grid.Panel', {
	cls : 'rfx-panel',
	title: makeGridTitle('<span style="color:#003471">프로젝트별</span> 투입현황'),
	border: true,
	resizable: true,
	store: storeEquipStateTable1,
	scroll: true,
    minWidth: 500,
    width: "50%",
    region: 'center',
...
//	,bbar: getPageToolbar(storeEquipStateTable1, true, null, function () {
//                        	Ext.Msg.alert('안내', '준비중인 기능입니다.', function() {});
//                        })
});

var gridEquipStateTable2 = Ext.create('Ext.grid.Panel', {
	cls : 'rfx-panel',
	title: makeGridTitle('<span style="color:#003471">개인별</span> 투입현황'),
	border: true,
	resizable: true,
	store: storeEquipStateTable2,
	scroll: false,
    flex: 1,
    region: 'east',
    forceFit: true,
...
//			,bbar: getPageToolbar(storeEquipStateTable2, true, null, function () {
//                        	Ext.Msg.alert('안내', '준비중인 기능입니다.', function() {});
//                        })
});


function redrawEquipStateTable() {
	
	var searchEquipState = Ext.getCmp('projectEquipState-SearchEquipState').getValue();
	
	if( searchEquipState==null || searchEquipState==''	) {
		Ext.Msg.alert('안내', '먼저 검색할 팀을 지정하세요.', function() {});
	} else {
		redrawEquipStateTable1();
		redrawEquipStateTable2();
	}
}

function redrawEquipStateTable2(/*pj_code*/) {
	
	gridEquipStateTable2.setLoading(true);
	storeEquipStateTable2.removeAll(true);
	var searchEquipState = TEAM_PARAMS['projectEquipState-SearchEquipState'];
	if(searchEquipState==null || searchEquipState=='' || searchEquipState==undefined) {
			
			storeEquipStateTable2.add({
				position: '',
				name: '검색할 팀을 지정하세요.',
		        v1: '',
		        v2: '',
			...
			gridEquipStateTable2.setLoading(false);	
			return;
	}
	
	TEAM_PARAMS['cubeCode'] = 'PJ_TEAM';
	TEAM_PARAMS['projectChartType'] = 'PJ_TEAM_TABLE2';
	//TEAM_PARAMS['projectEquipState-SearchPjcode'] = pj_code;
...
function redrawEquipStateTable1() {
	
	gridEquipStateTable1.setLoading(true);
	...
	TEAM_PARAMS['projectChartType'] = 'PJ_TEAM_TABLE1';
	 	...
	 	Ext.Ajax.request({
				...
				success : function(response, request) {
					...
					storeEquipStateTable1.removeAll(true);
					for(var i=0; i<records.length; i++) {
					...
					gridEquipStateTable1.setLoading(false);
				},// endof success for ajax
				failure:function(result, request) {
					Ext.MessageBox.show({
			            title: '연결 종료',
 ...
 gridEquipStateTable1.getSelectionModel().on({
    selectionchange: function(sm, selections) {
    	...
    	if (selections.length) {
    		...
    		redrawEquipStateTable2(pj_code);
    	}
    	*/
    }
...
Ext.define('FeedViewer.EquipState', {
...
//			       emptyText: '조회구분',
//	               xtype:          'combo',
//	               id: 'projectEquipState-SearchType',
//	               mode:           'local',
//	               editable:       false,
//	               allowBlank: false,
//	               queryMode: 'remote',
//	               displayField:   'codeName',
//	               value:          TEAM_PARAMS['projectEquipState-SearchType'],
//	               triggerAction:  'all',
...
//                emptyText: '조직구분',
//                xtype: 'combo',
//                id: 'projectEquipState-SearchOrg',
//                mode: 'local',
//                editable: false,
//                allowBlank: false,
//                queryMode: 'remote',
...
//                        searcEquipStateStore.getProxy().setExtraParam('parentCode', systemCode);
//                        searcEquipStateStore.load();
//                        
//                        Ext.getCmp('projectEquipState-SearchEquipState').setValue('');
//
//                    },
//                    change: function(sender, newValue, oldValue, opts) {
//                        this.inputEl.setStyle('font-family', "Malgun Gothic, Tahoma");
...
//                emptyText: '팀',
//                xtype: 'combo',
//                id: 'projectEquipState-SearchEquipState',
//                mode: 'local',
//                editable: false,
//                allowBlank: false,
//                queryMode: 'remote',
...
//                emptyText: '',
//                xtype: 'combo',
//                id: 'projectEquipState-Month',
//                mode: 'local',
//                editable: false,
//                allowBlank: false,
//                queryMode: 'remote',
//                displayField: 'codeName',
//                value: TEAM_PARAMS['projectEquipState-Month'],
//                triggerAction: 'all',
...
//	        items.push({
//	        	xtype: 'component',
//	            //html: '<div class="inputBT"><button type="button" onClick="redrawEquipStateTable1();"><span class="search">검색</span></button></div>'
//	        	html:'<div class="searchcon"><span class="searchBT"><button type="button" onClick="redrawEquipStateTable();"></button></span></div>'
//	        });
	        items.push('->');
    ...
    createWest: function(){
        ...
        var dataView =   Ext.create('Ext.Panel', {
            ...
            store: Ext.create('Ext.data.Store', {
	                model: 'ImageModel',
	                data: [
	                    { id: 1, name: '고객사 관리', link: '' },
	                    { id: 2, name: '수주 관리',  link: '' },
	                    {id: 3, name:'생산계획', link: ''}
	                ]
	            }),
...
//                    }
        ...
        //this.east =  gridEquipStateTable2;
        this.west = dataView;
        //redrawEquipStateTable1();
        
//        Ext.create('widget.gridEquipState2', {
//           layout:'border',
//            region: 'west',
//            minWidth: 400,
//			collapsible: false,
...
//        });
    ...
    createCenter: function(){
    	this.center = gridEquipStateTable1;
    	/*
		this.center = Ext.create('widget.gridEquipState1', {
           layout:'border',
           region: 'center',
           minWidth: 700,
		   collapsible: false,
