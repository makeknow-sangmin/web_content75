...
var historyCustomerStore= Ext.create('Rfx.store.CmmCodeStore', {parentCode:'652', hasNull:true});
var historyCartypeStore= Ext.create('Rfx.store.CmmCodeStore', {parentCode:null, hasNull:true});//parent가 영구값이 아니고 초기값일 때 사용.
...
var projectStore=Ext.create('Rfx.store.ProjectStore', {hasNull:true});
...
function treatTechCombo() {
        	 ...
        	 var historyTechgTreeStore = Ext.create('Rfx.store.CmmTreeStore', {
		        root: {
			        text: '기술',
			        id: '1',
			        expanded: true
...
function treatProductCombo() {
        	 ...
        	 var historyProductTreeStore = Ext.create('Rfx.store.CmmTreeStore', {
		        root: {
			        text: '제품',
			        id: '3',
			        expanded: true
...
function treatTaskCombo() {
        	 ...
        	 var historyTaskTreeStore = Ext.create('Rfx.store.CmmTreeStore', {
		        root: {
			        text: '태스크',
			        id: '2',
			        expanded: true
...
function treatOrgCombo() {
        	 var historyOrgTreeStore = Ext.create('Rfx.store.CmmTreeStore', {
		        root: {
			        text: '조직구분',
			        id: '531',
			        expanded: true
...
//	},
	...
	createToolbar1: function(){
        ...
        if (!this.inTab) {
	               ...
	               value:     '',
	               triggerAction:  'all',
	               store: Ext.create('Rfx.store.CmmCodeStore', {parentCode:'3095'}),
	               width: 120,
	               cls : 'newCSS',
	               listConfig:{
  			...
  			items.push({
					  ...
					  fieldStyle: {
						  'background-color'  : '#164989',
						   ...
						   'fontFamily'   : '"맑은 고딕",Malgun Gothic'
					  },
      		          cls : 'newCSS'
  		        	  ,listeners : {
                            'render' : function(cmp) {
...
//	        items.push('-');
	        ...
	        items.push({
	        	xtype: 'component',
	        	html: '<div class="searchcon" onClick="openNewWindow();" title="새로운 탭화면 열기"><span class="newwinBT"><button type="button"></button></span></div>'
...
//	               value:     '',
//	               triggerAction:  'all',
//	               store: Ext.create('Rfx.store.CmmCodeStore', {parentCode:'3088'}),
//	               width: 120,
//	               cls : 'newCSS',
//	               listConfig:{
//	               	getInnerTpl: function(){
...
//		            '<tpl for=".">',
//		                '<div class="x-boundlist-item" style="font-family: Malgun Gothic, Tahoma">{name}</div>',
//		            '</tpl>'
//		        ),
//		        listeners: {
//		            change: function(sender, newValue, oldValue, opts) {
