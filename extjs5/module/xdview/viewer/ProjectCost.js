var searcCartypeStore= Ext.create('Rfx.store.CmmCodeStore', {parentCode:null});//parent가 영구값이 아니고 초기값일 때 사용.
	...
	createToolbar: function(){
        ...
        if (!this.inTab) {
			...
			items.push({
	               ...
	               value:          '',
	               triggerAction:  'all',
	               store: Ext.create('Rfx.store.CmmCodeStore', {parentCode:'1015'}),
	               width: 120,
	               cls : 'newCSS',
	               listConfig:{
	               	getInnerTpl: function(){
			...
			items.push({
	               ...
	               value:          '',
	               triggerAction:  'all',
	               store: Ext.create('Rfx.store.CmmCodeStore', {parentCode:'1594'}),
	               width: 120,
	               cls : 'newCSS',
	               listConfig:{
	               	getInnerTpl: function(){
