// //잡자재 재고 관리
Ext.define('Hanaro.view.equipState.EquipSpMgmtHanaroView', {
    extend: 'Hanaro.base.HanaroBaseView',
    xtype: 'sp-mgmt-hannaro',
    ...
    initComponent: function () {
        ...
        this.setDefComboValue('standard_flag', 'valueField', 'S');
        ...
        this.createStore('Rfx2.model.company.hanaro.StockLineHanaroSp', [{
                property: 'unique_id',
                direction: 'DESC'
            }],
        ...
        this.addTabCartLineGridPanel(CMD_VIEW_DTL, 'PMS1_SUB', {
                pageSize: 100,
...
//         buttonToolbar.insert(4, this.outqtyAction);
...
//                 break;
//         }
        buttonToolbar.insert(3, this.printBarcodeAction);
