//출하 현황
Ext.define('Hanaro.view.salesDelivery.DeliveryHanaroView', {
...
//                        }
        ...
        // this.store.getProxy().setExtraParam('orderBy', "create_date");
      ...
      //PDF 파일 출력기능
        this.printPDFAction = Ext.create('Ext.Action',{
            ...
            handler: function(widget, event) {
            	...
            	console_logs('rec2222', rec);
                
                var selection = gm.me().grid.getSelectionModel().getSelection();
                var claast_varchar1 = selection[0].get('claast_varchar1');
...
//                    break;
//                    default:
//                        if(claast_varchar1 == null || claast_varchar1 == '') {
//                            Ext.Msg.alert('안내', '상세보기에서 배송차량을 등록해주세요.', function() {});
//                            return null;
//                        }
//                    break;
