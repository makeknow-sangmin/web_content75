//자재 관리
Ext.define('Hanaro.view.produceMgmt.MaterialMgmtHanaroView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.hanaro.IFMtrlMasterHanaro', [{
...
//		            		}
                ...
                if (my_child.length > 0) {
                    Ext.Ajax.request({
                        url: CONTEXT_PATH + '/purchase/request.do?method=addPoCart', //addMyCart',
                        params: {
                            childs: my_child,
