...
Ext.define('Hanaro.view.designPlan.DesignBomHanaroViewUlvc', {
...
//         });
        ...
        this.cloudprojectStore = Ext.create('Mplm.store.cloudProjectStoreUlvc', { hasNull:true});
        gm.pageSize = 100;
        this.createStore('Hanaro.model.PartLineHanaro', [{
            property: 'pl_no',
            direction: 'ASC'
            }],
        ...
        switch(vCompanyReserved4) {
            case 'HSGC01KR' :
                Ext.apply(this, {
                    layout: 'border',
                    items: [this.createCenter(), this.createEast(), this.crudTab]
                });
                break;
            case 'KWLM01KR' :
                ...
                Ext.apply(this, {
                    layout: 'border',
                    items: [this.createCenter(), this.createEast(), this.fileCrudGrid()]
                });
                break;
            default:
                Ext.apply(this, {
        ...
        Ext.Ajax.request({
            ...
            success: function(response, request) {
                ...
                if(count>0) {
                    ...
                    var o = Ext.create('Hanaro.model.TreeModelHanaro', assyline);
    ...
    createEast: function() {
        ...
        // myCartColumn.splice(2,0, {
        //     align : "center",
        //     dataIndex  : "statusHangul",
        //     dataType : "string",
        //     sortable :   true,
        ...
        //     // editable: true,
        //     // editor :    {},
        //     fieldStyle: 'text-align:center;background-color: #D6E8F6; background-image: none;',
        //     // renderer : function(value, meta) {
        //     //         meta.css = 'custom-column';
        //     //         return value;
        //     // } 
        // });
            myCartColumn.splice(1,0, {
                align : "center",
...
//
    ...
    createCenter: function() {
        ...
        this.cloudProjectTreeStore = Ext.create('Hanaro.store.HanaroProjectTreeStoreUlvc', {});
                    ...
                    items: [
                        {
                            ...
                            listConfig:
                            {
                                getInnerTpl: function() {
                                    return '<div data-qtip="{unique_id}"><small><font color=blue>{pj_code}</font></small></div>';
                                }
                            }	,
                            triggerAction: 'all',
                            listeners: {
...
//        console_logs("srchSingleHandler b", b);
    ...
    addNewAction: function(val) {
        ...
        var partLine = Ext.create('Hanaro.model.PartLineHanaro');
