...
Ext.define('Hanaro.view.designPlan.DesignBomHanaroView', {
        ...
        switch(vCompanyReserved4) {
            case 'APM01KR':
                this.createStoreSimple({
                    modelClass: 'Hanaro.model.PartLineHanaro',
...
//
      ...
      //Define Remove Action
        ...
        this.center = Ext.widget('tabpanel', {
            ...
            width: '50%',
            tabPosition: 'top',
            items: [this.grid /*bomTab*//*, this.mycartTab*/]
        });
    ...
    createWest: function() {
        ...
        this.cloudProjectTreeStore = Ext.create('Hanaro.store.HanaroProjectTreeStore', {});
        ...
        this.assyGrid = Ext.create('Ext.tree.Panel', {
            ...
            dockedItems: [{
                ...
                items: [
                    ...
                    '->',
                    this.sendPurchase, this.sendWork
                ]
            }, {
                    dock: 'top',
                    xtype: 'toolbar',
            ...
            columns: [
                ...
                width: 39, //vCompanyReserved4 != 'KWLM01KR' ? 50 : 0,
                style: 'text-align:center',
                align: 'center',
                renderer: function(val, metaData, rec) {
...
//                var result = result.responseText;
    ...
    sendPurchase: Ext.create('Ext.Action', {
        ...
        handler: function(widget, event) {
            ...
            // var reserved_varchar1 = rec.get('reserved_varchar1');
            // console_logs('sendPurchase selectedAssyUid', selectedAssyUid);
            // console_logs('sendPurchase reserved_varchar1', reserved_varchar1);
