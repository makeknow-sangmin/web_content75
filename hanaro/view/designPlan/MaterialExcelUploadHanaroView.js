Ext.define('Hanaro.view.designPlan.MaterialExcelUploadHanaroView', {
    ...
    initComponent: function(){
		...
		var excel_sample = Ext.create('Ext.Action', {
			...
			handler : function(widget, event) {
				...
				switch (lang) {
				case 'ko':
					path = CONTENT_FULL_PATH + '/cab/hanaro_item_upload_file.xlsx'; // 상대경로 사용
					break;
				case 'zh':
					path = CONTENT_FULL_PATH + '/cab/hanaro_item_upload_file.xlsx';
					break;
				case 'en':
					path = CONTENT_FULL_PATH + '/cab/hanaro_item_upload_file.xlsx';
					break;
