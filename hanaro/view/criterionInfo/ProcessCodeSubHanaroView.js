Ext.define('Hanaro.view.criterionInfo.ProcessCodeSubHanaroView', {
...
//    			var pcs_level = rec.get('pcs_level')+1;
            ...
            // gm.me().store.getProxy().setExtraParam('parent_code', gMain.selPanel.vSELECTED_PARENT_CODE);
        	// gm.me().store.getProxy().setExtraParam('pcs_level', gMain.selPanel.vSELECTED_PCS_LEVEL);
        	// gm.me().store.load();
        });
        
        this.createStore('Rfx.model.ProcessCodeSub2', [{
	            property: 'unique_id',
	            direction: 'DESC'
	        }],
