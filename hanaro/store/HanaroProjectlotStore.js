/**
 * ProjectLotStore Store
 */
var approve = '';

Ext.define('Hanaro.store.HanaroProjectlotStore', {
	...
	fields:[     
	     ...
	     proxy: {
	         type: 'ajax',
	         url: CONTEXT_PATH + '/production/schdule.do?method=readAssyTopWithStock', /*1recoed, search by cond, search */
	         reader: {
	         	type:'json',
	             root: 'datas',
	             totalProperty: 'count',
