var searcTeamStore = Ext.create('Xdview.store.CmmCodeStore', {parentCode: null});//parent가 영구값이 아니고 초기값일 때 사용.
	...
	createToolbar: function(){
        ...
        if (!this.inTab) {
        		...
        		items.push({
	               ...
	               triggerAction:  'all',
	               store: Ext.create('Xdview.store.CmmCodeStore', {parentCode:'588', hasNull:false}),
	               width: 120,
	               cls : 'newCSS',
	               listConfig:{
