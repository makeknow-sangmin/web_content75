var techSearchTypeStore= Ext.create('Xdview.store.CmmCodeStore', {parentCode:'588', hasNull:false});
                ...
                plotOptions: {
                    ...
                    column: {
                        ...
                        dataLabels: {
                            ...
                            color: 'white',
                            style: {
                                textShadow: '0 0 3px black' /*, fontFamily: '"현대하모니 L", Malgun Gothic' , lineHeight: '18px', fontSize: '17px' */
                            },
                            format: format
                        }
                    }
