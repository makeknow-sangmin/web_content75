...
var research3 = {
						...
						if ( this.research.once =='Y' &&  !(this.research.strCreated >= this.jobStartDate && this.research.strCreated <= this.jobEndDate) ){
							...
							*/
							...
							if(this.approvalStatus=="P" || this.approvalStatus=="C") {	// 진행 or 완료
								...
								html += "	<td class='txt-center'>";
								html += "  <select class='time' id='"+this.id+"_sel' name='selWorkDay' start='"+this.jobStartDate+"' end='"+this.jobEndDate+"' onchange='javascript:research3.changeDay(this, \""+period+"\");'>";
								...
								html += "	 <input type='text' id='"+this.id+"_inp' name='inpRatio' start='"+this.jobStartDate+"' end='"+this.jobEndDate+"' value='"+this.ratio+"' onkeyup='javascript:research3.changeRatio(this);' style='width:25px;'/>%";
								html += "	</td>";
							}
	...
	changeRatio: function(obj) {
		...
		// 자동 비율계산
		research3.autoRatio(thisStartDate, thisEndDate);
	},
