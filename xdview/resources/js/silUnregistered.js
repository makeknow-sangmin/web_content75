 ...
 * FileName    : silUnregistered.js
 * 
 * @Title		: 등록조회 - 미상신자조회(실담당)
 * @Description : 미상신자조회(실담당) js
 * @Version     : 
 * @Author      : YounghoLee
 * @Date        : 2015.11.19
**************************************************************************************/				
...
var silUnregistered = {
		...
		com_team: function(comboNum) {
			...
			switch(comboNum) {
			case 1:
				url =  "/basicquery/unregistered/orgBonbuCombo.do"; 
				data =  {};
				break;
			case 2:
				url =  "/basicquery/unregistered/orgCenterCombo.do"; 
				data =  {"bonbuOrgId":highOrgId};
				break;
			case 3:
				
				url =  "/basicquery/unregistered/orgSilCombo.do"; 
				data =  {bonbuOrgId: $("#com_org_lv1 option:selected").val(),
						CenterOrgId:highOrgId
						};
				
				break;
			case 4:
				url =  "/basicquery/unregistered/orgTeamCombo.do"; 
				data =  {bonbuOrgId: $("#com_org_lv1 option:selected").val(),
						CenterOrgId: $("#com_org_lv2 option:selected").val(),
						"SilOrgId":highOrgId};
				break;
			}
			if(comboNum==0) {
