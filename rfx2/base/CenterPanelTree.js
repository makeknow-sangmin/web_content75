						...
						children: [
							{
								...
								children: [
									...
									value:"function(view, record, htmlItem, index, eventObject, opts) {<br>\t//console_logs('boardview itemdblclick record', record);<br>\tRfx.model.Board.load(record.get('unique_id'), {<br>success: function(board) {<br>console_logs('board', board);<br>var form = gm.me().createViewForm(board);<br>var win = Ext.create('ModalWindow', {<br>title: gm.me().getMC('CMD_VIEW_DTL','상세보기'),<br>width: 700,<br>height: 530,<br>minWidth: 250,<br>minHeight: 180,<br>layout: 'absolute',<br>plain: true,<br>items: form,<br>buttons: [{<br>text: CMD_OK,<br>handler: function() {<br>if (win) {<br>win.close();<br>}<br>}<br>}]<br>});<br>win.show();<br>}<br>});<br>}",
									leaf: true },
