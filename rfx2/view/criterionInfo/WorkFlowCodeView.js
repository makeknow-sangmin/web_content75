Ext.define('Rfx2.view.criterionInfo.WorkFlowCodeView', {
    ...
    initComponent: function(){
        ...
        this.addSearchField('unique_id_long');
        ...
        // 메인 스토어 생성
        this.createStore('Rfx.model.MenuWigt', [
            {
        ...
        // 서브그리드 스토어 생성
        this.GeneralCodeInMenuStore = Ext.create('Mplm.store.GeneralCodeInMenuStore', {});
        ...
        this.addChildCodeBtn = Ext.create('Ext.Action', {
            ...
            handler: function () {
                ...
                if (selections.get('state') !== 'A') {
                    ...
                    var parent_system_code = selections.get('menu_key');
                        ...
                        if(btn=='yes') {
                            ...
                            Ext.Ajax.request({
                                ...
                                success : function(result, request) {
                                    ...
                                    gm.me().store.load();
                                    gm.me().GeneralCodeInMenuStore.load();
                                },
        ...
        store: this.GeneralCodeInMenuStore,
        viewConfig: {
            markDirty: false
        },
        collapsible: false,
        ...
        flex: 0.5,
        frame: true,
        bbar: getPageToolbar(this.GeneralCodeInMenuStore),
        border: true,
        layout: 'fit',
        forceFit: false,
        ...
        this.setGridOnCallback(function(selections){
            if (selections.length) {
                ...
                this.GeneralCodeInMenuStore.getProxy().setExtraParams(
                        {
                        selected_uid: rec.get('unique_id_long'),
                        //parent_system_code: rec.get('system_code'),
                        parent_system_code: rec.get('menu_key'),
                        uid: rec.get('unique_id_long'),
                        }
                    );
                // 오른쪽 단 스토어 로드
                this.GeneralCodeInMenuStore.load();
