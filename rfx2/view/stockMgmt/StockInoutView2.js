...
//자재 관리
Ext.define('Rfx2.view.stockMgmt.StockInoutView2', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.InnOutV2', [{
            property: 'item_code',
            direction: 'ASC'
        }],
        ...
        if (vCompanyReserved4 == 'KYNL01KR' || vCompanyReserved4 == 'CHMR01KR') {
                ...
                viewConfig: {
                    ...
                    getRowClass: function (record, index) {
                        if(vCompanyReserved4 == 'KYNL01KR'){
                            ...
                            var recv_flag = record.get('category');
                            switch (recv_flag) {
                                case 'IN':
                                    return 'white-row';
                                     break;
