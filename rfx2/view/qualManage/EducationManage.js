 ...
 */
Ext.define('Rfx.view.qualManage.EducationManage', {
    extend: 'Rfx.base.BaseView',
    xtype: 'education-manage-view',
    initComponent: function(){
		...
		this.store.getProxy().setExtraParam('gubun', 'ED');
	...
	createWest: function() {
		...
		this.grid.getSelectionModel().on({
			selectionchange: function(sm, selections) {
				...
				gm.me().docuStore.getProxy().setExtraParam('menu_code', 'EDMG_CLD');
