 ...
 */
Ext.define('Rfx.view.qualManage.IsoManage14', {
    extend: 'Rfx.base.BaseView',
    xtype: 'iso-manage14-view',
    initComponent: function(){
		...
		this.store.getProxy().setExtraParam('gubun', 'I1	');
	...
	createWest: function() {
		...
		this.grid.getSelectionModel().on({
			selectionchange: function(sm, selections) {
				...
				gm.me().docuStore.getProxy().setExtraParam('menu_code', 'ISO1_14');
