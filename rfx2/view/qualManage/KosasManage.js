 ...
 */
Ext.define('Rfx.view.qualManage.KosasManage', {
    extend: 'Rfx.base.BaseView',
    xtype: 'koasas-manage-view',
    initComponent: function(){
		...
		this.store.getProxy().setExtraParam('gubun', 'IS');
	...
	createWest: function() {
		...
		this.grid.getSelectionModel().on({
			selectionchange: function(sm, selections) {
				...
				gm.me().docuStore.getProxy().setExtraParam('menu_code', 'KOAS');
