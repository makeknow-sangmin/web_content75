Ext.define('Rfx2.view.lab.InspectCategoryDefView', {
    ...
    initComponent: function () {
        ...
        this.storeViewProp = Ext.create('Mplm.store.ViewPropStore', {});
        ...
        gridDimension.getSelectionModel().on({
            selectionchange : function(sm, selections) {
                if(selections.length == 1) {
                    gm.me().storeViewProp.getProxy().setExtraParam('dim_uid', selections[0].get('dim_uid'));
