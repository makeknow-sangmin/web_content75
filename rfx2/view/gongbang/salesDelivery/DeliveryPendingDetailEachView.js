 ...
 * 
 */
Ext.define('Rfx2.view.gongbang.salesDelivery.DeliveryPendingDetailEachView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'delivery-confirm-view',
    detailStore: null,
...
//        this.addSearchField('wa_name');
        ...
        this.addDeliveryConfirm = Ext.create('Ext.Action', {
            ...
            handler: function() {
               ...
               var check_wa_name = selections[0].get('combst_wa_name');
               ...
               for(var i=0; i<selections.length; i++) {
                   ...
                   var wa_name = sel.get('combst_wa_name');
                   ...
                   var rtgast_uid = sel.get('do_uid');
                   var order_com_unique = sel.get('combst_uid');
               ...
               msg = msg + '<hr>';
               msg = msg + '<font color=#163F69><b>고객사(수주일):</b></font> ' + selections[0].get('combst_wa_name') + ' 外 ' + (selections.length - 1) + ' 건' +'<br>';
               msg = msg + '<font color=#163F69><b>제품:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font> ' + rec.get('srcahd_item_code') + ' | ' + rec.get('srcahd_specification') +'<br>';
