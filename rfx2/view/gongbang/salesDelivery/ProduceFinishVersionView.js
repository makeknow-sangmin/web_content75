 ...
 * 표준 출하예정 등록
 */
Ext.define('Rfx2.view.gongbang.salesDelivery.ProduceFinishVersionView', {
    ...
    initComponent: function () {
        ...
        if (vCompanyReserved4 === 'CHMR01KR') {
            this.gridContractCompany = Ext.create('Ext.grid.Panel', {
                ...
                dockedItems: [
                    ...
                    //                 gm.me().poPrdDetailStore.getProxy().setExtraParam('pj_name', '%' + gu.getCmp('pj_name').getValue() + '%');
                    ...
                    //     xtype: 'triggerfield',
                    //     emptyText: '납품요구번호',
                    //     id: gu.id('project_varchar9'),
                    //     fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                    //     name: 'project_varchar9',
                    //     listeners: {
                    //         specialkey: function (field, e) {
                    //             if (e.getKey() == Ext.EventObject.ENTER) {
                    //                 gm.me().poPrdDetailStore.getProxy().setExtraParam('project_varchar9', '%' + gu.getCmp('project_varchar9').getValue() + '%');
                    //                 gm.me().poPrdDetailStore.load(function () { });
                    //             }
                    //         }
                    //     },
                    //     trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                    //     'onTrigger1Click': function () {
                    //         gu.getCmp('project_varchar9').setValue('');
                    //         gm.me().poPrdDetailStore.getProxy().setExtraParam('project_varchar9', gu.getCmp('project_varchar9').getValue());
                    //         gm.me().poPrdDetailStore.load(function () { });
                    //     }
                    // },
        ...
        } else if (vCompanyReserved4 === 'WOWT01KR') {
            this.gridContractCompany = Ext.create('Ext.grid.Panel', {
                cls: 'rfx-panel',
                id: gu.id('gridContractCompany'),
                store: this.poPrdDetailStore,
                ...
                columns: [
                    {text: '변경된수주번호', width: 110, style: 'text-align:center', dataIndex: 'reserved_varcharh'},
                    {
                        text: '수주번호',
                        width: 100,
                        style: 'text-align:center',
                    ...
                    //{ text: this.getMC('msg_order_grid_prd_desc', '규격'), width: 100, style: 'text-align:center', dataIndex: 'specification'/*, sortable: false*/ },
                    {
                        text: '수주수량', width: 75, style: 'text-align:center', dataIndex: 'po_qty', align: 'right',
                        editor: 'numberfield',
                        renderer: function (value, context, tmeta) {
                            return Ext.util.Format.number(value, '0,00/i');
                        },
                    ...
                    // {
                    //     text: '기요청', width: 60, style: 'text-align:center', dataIndex: 'ap_quan', align: 'right',
                    //     editor: 'numberfield',
                    //     renderer: function (value, context, tmeta) {
                    //         return Ext.util.Format.number(value, '0,00/i');
                    //     },
                    // },
                    {
                        text: '요청수량', width: 75, style: 'text-align:center', dataIndex: 'ap_Wquan', align: 'right',
                        editor: 'numberfield',
                        renderer: function (value, context, tmeta) {
                            return Ext.util.Format.number(value, '0,00/i');
                        },
                    },
                    {text: 'No', width: 75, style: 'text-align:center', dataIndex: 'po_no'},
                    {text: '월', width: 45, style: 'text-align:center', dataIndex: 'reserved_varchari'},
                    {text: '주', width: 45, style: 'text-align:center', dataIndex: 'reserved_varcharj'},
                    {text: 'Order', width: 75, style: 'text-align:center', dataIndex: 'reserved18'},
                    {
                        text: this.getMC('msg_order_grid_prd_unitprice', '단가'),
        ...
        } else if (vCompanyReserved4 === "MSTP01KR") {
            this.gridContractCompany = Ext.create('Ext.grid.Panel', {
                cls: 'rfx-panel',
                id: gu.id('gridContractCompany'),
                store: this.poPrdDetailStore,
                ...
                columns: [
                    ...
                    {
                        text: this.getMC('msg_order_grid_prd_po_qty', '수주수량'),
                        width: 95,
                        style: 'text-align:center',
                        dataIndex: 'po_qty'/*, sortable: false*/
                    },
                    {
                        text: this.getMC('msg_order_grid_prd_quan', '요청수량'),
                        width: 75,
                        style: 'text-align:center',
                        dataIndex: 'ap_Wquan'/*, sortable: false*/
                    },
                    {
                        text: this.getMC('msg_order_grid_prd_name', '제품명'),
                        width: 100,
                    ...
                    },
                    {
                        ...
                        width: 100,
                        style: 'text-align:center',
                        dataIndex: 'specification'/*, sortable: false*/
                    },
                    {
                        text: this.getMC('msg_order_grid_prd_unitprice', '단가'),
            ...
            this.gridContractCompany = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    // {
                    //     text: '납기일자', width: 100, style: 'text-align:center', dataIndex: 'gr_date'/*, sortable: false*/,
                    //     renderer: function (value, context, tmeta) {
                    //         if (value !== null && value.length > 0) {
                    //             return value.substring(0, 10);
                    //         }
                    ...
                    {
                        text: this.getMC('msg_order_grid_prd_desc', '제품설명'),
                        width: 100,
                        style: 'text-align:center',
