...
Ext.define('Rfx2.view.gongbang.groupWare.PurchasePaymentListView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'purchasepayment-list-view',
    initComponent: function () {
        ...
        this.paymentAdd = Ext.create('Ext.Action', {
            itemId: 'paymentAdd',
            iconCls: 'af-plus',
            disabled: false,
            text: '지급추가',
            handler: function (widget, event) {
                ...
                var paymentaddformItems = Ext.create('Ext.form.Panel', {
                    id: gu.id('paymentaddformItems'),
                    xtype: 'form',
                    frame: false,
                    border: false,
                    width: '100%',
                ...
                var form = Ext.create('Ext.form.Panel', {
                    ...
                    items: paymentaddformItems
                })
                var paymentadditems = [form];
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    var payment_memo = val['payment_memo'];
                                    var selections = gm.me().grid.getSelectionModel().getSelection();
                                    ...
                                    Ext.Ajax.request({
                                        ...
                                        url: CONTEXT_PATH + '/purchase/request.do?method=PayMentAdd',
                                        params: {
                                        ...
                                        success: function (result, request) {
                                            ...
                                            Ext.Msg.alert('안내', '지급추가 작성을 완료하셨습니다.', function () {
                                            });
                                            prWin.close();
                                        },// endofsuccess
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    var ac_way = gu.getCmp('ac_way').getValue();
        ...
        buttonToolbar.insert(2, this.paymentAdd);
