Ext.define('Rfx2.view.gongbang.groupWare.SalesBookView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx.model.SalWthdRaw', [{
                ...
                handler: function (btn) {
                    if (btn == 'no') {
                        ...
                        if (form.isValid()) {
                            ...
                            Ext.Ajax.request({
                                url: CONTEXT_PATH + '/account/arap.do?method=insertWdHistory&division=out',
                                params: {
