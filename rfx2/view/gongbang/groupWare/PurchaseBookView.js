Ext.define('Rfx2.view.gongbang.groupWare.PurchaseBookView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx.model.PurWthdRaw', [{
                ...
                handler: function (btn) {
                    if (btn == 'no') {
                        ...
                        if (form.isValid()) {
                            ...
                            Ext.Ajax.request({
                                url: CONTEXT_PATH + '/account/arap.do?method=insertWdHistory&division=in',
                                params: {
