Ext.define('Rfx2.view.gongbang.produceMgmt.ProduceMgmtByOrderView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'produce-mgmt-byorder-view',
                            ...
                            if (form.isValid()) {
                                ...
                                if (jsonData1 != null && jsonData2 != null) {
                                    form.submit({
                                        ...
                                        url: CONTEXT_PATH + '/index/process.do?method=addPrdPlanBIOT',
