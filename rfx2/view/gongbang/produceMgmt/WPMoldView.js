Ext.define('Rfx2.view.gongbang.produceMgmt.WPMoldView', {
    ...
    initComponent: function () {
        ...
        this.addPoAction = Ext.create('Ext.Action', {
            ...
            disable: true,
            handler: function () {
                var record = gm.me().grid.getSelectionModel().getSelected().items[0];
                            ...
                            items: [
                                {
                                    ...
                                    items: [

                                        {
                                            ...
                                            width: '99%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '금형번호',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'add_mtrl',
                                        ...
                                        },
                                        {
                                            ...
                                            width: '99%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '금형명',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'maker',
                                        ...
                                        // },
                                        {
                                            ...
                                            width: '99%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + 'Rack명',
                                        },
                                        {
                                            xtype: 'numberfield',
                                            id: 'core',
                                        ...
                                        },
                                        {
                                            ...
                                            allowBlank: false,
                                            minValue: 0,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '금형금액',
                                        },
                                        {
                                            xtype: 'datefield',
                                            id: 'fix_date',
                            ...
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    form.submit({
                                        ...
                                        url: CONTEXT_PATH + '/index/process.do?method=addMoldInfoWithMap',
        ...
        this.editPoAction = Ext.create('Ext.Action', {
            ...
            handler: function () {
                ...
                var select = grid.getSelectionModel().getSelected().items[0];
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('mold_used_mtrl'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '사용재료',
                                        },
                                        {
                                            xtype: 'textfield',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('mold_specification'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '규격',
                                        },
                                        {
                                            xtype: 'textfield',
                                        ...
                                        },
                                        {
                                            ...
                                            allowBlank: false,
                                            format: 'Y-m-d',
                                            value: select.get('mold_make_date_str'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '제작연도',
                                        },
                                        {
                                            xtype: 'numberfield',
                                        ...
                                        },
                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('mold_division'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '구분'
                                        },
                                        // {
                                        //     id: gu.id('rack_uid'),
                                        ...
                                        // },
                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('mold_rack_name'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + 'Rack명',
                                        },
                                        {
                                            xtype: 'numberfield',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('mold_limit_press'),
                                            minValue: 0,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '한계타발수',
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('mold_punc_cnt'),
                                            minValue: 0,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '타발횟수',
                                        },
                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('mold_item_price'),
                                            minValue: 0,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '금형금액'
                                        },
                                        {
                                            ...
                                            allowBlank: false,
                                            format: 'Y-m-d',
                                            value: select.get('mold_fix_date_str'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '수리일자'
                                        },
                                        {
                                            xtype: 'textfield',
                                            ...
                                            width: '45%',
                                            allowBlank: true,
                                            value: select.get('mold_description'),
                                            fieldLabel: '비고',
                                        }
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    var val = form.getValues(false);
                                    form.submit({
                                        url: CONTEXT_PATH + '/index/process.do?method=editMoldInfoWithMap',
                                        params: {
                                            unique_id: select.get('mold_uid')
                                        },
                                        success: function (val, action) {
                                            gm.me().store.load();
        ...
        this.excelUploadAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
            text: '파일업로드',
            tooltip: this.getMC('금형등록시 필요문서를 일괄 업로드 합니다.'),
            handler: function () {
        ...
        this.deletePrdAction = Ext.create('Ext.Action', {
            ...
            handler: function () {
                Ext.MessageBox.show({
                    title: gm.me().getMC('msg_btn_prd_delete_title', '금형삭제'),
                    msg: gm.me().getMC('msg_btn_prd_delete_msg', '선택한 금형을 삭제하시겠습니까?'),
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    text: this.getMC('msg_order_grid_prd_name', '금형번호'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_code',
                    sortable: false
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '금형명'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_name',
                    sortable: false
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', 'Rack명'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_rack_name',
                    sortable: false
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '구분'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_division',
                    sortable: false
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '사용재료'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_used_mtrl',
                    sortable: false
                },
                {
                    ...
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_specification',
                    sortable: false
                },

                {
                    text: this.getMC('msg_order_grid_prd_name', 'cavity'),
                    width: 80, style: 'text-align:center',
                    dataIndex: 'mold_cavity',
                    sortable: false,
                    align: 'right',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'mold_cavity') {
                            context.record.set('mold_cavity', Ext.util.Format.number(value, '0,00/i'));
                        }
                        return Ext.util.Format.number(value, '0,00/i');
                    },
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '벌수'),
                    width: 80, style: 'text-align:center',
                    dataIndex: 'mold_quan',
                    sortable: false,
                    align: 'right',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'mold_quan') {
                            context.record.set('mold_quan', Ext.util.Format.number(value, '0,00/i'));
                        }
                        return Ext.util.Format.number(value, '0,00/i');
                    },
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '코어'),
                    width: 80, style: 'text-align:center',
                    dataIndex: 'mold_core',
                    sortable: false,
                    align: 'right',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'mold_core') {
                            context.record.set('mold_core', Ext.util.Format.number(value, '0,00/i'));
                        }
                        return Ext.util.Format.number(value, '0,00/i');
                    },
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '타발횟수'),
                    width: 80, style: 'text-align:center',
                    dataIndex: 'mold_punc_cnt',
                    sortable: false,
                    align: 'right',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'mold_punc_cnt') {
                            context.record.set('mold_punc_cnt', Ext.util.Format.number(value, '0,00/i'));
                        }
                        return Ext.util.Format.number(value, '0,00/i');
                    },
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '한계타발수'),
                    width: 100, style: 'text-align:center',
                    dataIndex: 'mold_limit_press',
                    sortable: false,
                    align: 'right',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'mold_limit_press') {
                            context.record.set('mold_limit_press', Ext.util.Format.number(value, '0,00/i'));
                        }
                        return Ext.util.Format.number(value, '0,00/i');
                    },
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '수리금액'),
                    width: 80, style: 'text-align:center',
                    dataIndex: 'mold_item_price',
                    sortable: false,
                    align: 'right',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'mold_item_price') {
                            context.record.set('mold_item_price', Ext.util.Format.number(value, '0,00/i'));
                        }
                        return Ext.util.Format.number(value, '0,00/i');
                    },
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '수리일자'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'mold_fix_date',
                    sortable: false,
                    renderer: Ext.util.Format.dateRenderer('Y-m-d')
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '제작년도'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'mold_make_date',
                    sortable: false,
                    renderer: Ext.util.Format.dateRenderer('Y-m-d')
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '제작처'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_maker',
                    sortable: false
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '비고'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'mold_description',
                    sortable: false
                },
            ],
            title: this.getMC('mes_reg_prd_info_msg', '해당 제품의 금형'),
            name: 'po',
            autoScroll: true,
            listeners: {
                edit: function (editor, e, eOpts) {
        ...
        this.setGridOnCallback(function (selections) {
            ...
            if (selections.length) {
                ...
                this.poPrdDetailStore.getProxy().setExtraParam('srcahd_uid', rec.get('unique_id_long'));
