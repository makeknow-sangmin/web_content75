Ext.define('Rfx2.view.gongbang.produceMgmt.ProduceMgmtAssyDetailView', {
    ...
    initComponent: function () {
        ...
        this.gridContractMaterial = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    text: this.getMC('msg_product_add_search_field1', '요청여부'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'assyProduct_request',
                    sortable: true
                },
                {
        ...
        this.twoGrid.getSelectionModel().on({
            selectionchange: function (sm, selections) {
                ...
                if (selections.length) {
                    ...
                    var assymap_child_top = rec.get('assymap_uid');
                    gm.me().salesPriceByCompanyListStore.getProxy().setExtraParam('ac_uid', ac_uid);
                    gm.me().salesPriceByCompanyListStore.getProxy().setExtraParam('assymap_child_top', assymap_child_top);
