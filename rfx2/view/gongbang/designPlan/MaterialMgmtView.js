//자재 관리
Ext.define('Rfx2.view.gongbang.designPlan.MaterialMgmtView', {
    ...
    initComponent: function () {
        ...
        //검색툴바 추가
        // if (this.useSgCodeCombo()) {ProductVerMgmtView
        //     this.addSearchField(
        //     {
        //         xtype: 'combo'
        //         , anchor: '100%'
        ...
        this.addCallback('CHECK_CODENUMBER', function (o) {
            ...
            if (code.length < 1) {
                ...
                Ext.Ajax.request({
                    url: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahdWithBom&standard_flag=R',
                    params: {
                        item_code: code
                    },
                    success: function (result, request) {
        ...
        if (this.useCartonBarcodeAction()) {
    ...
    useCartonBarcodeAction: function () {
        switch (vCompanyReserved4) {
            case 'WOWT01KR':
            case 'KMCA01KR':
                return false;
