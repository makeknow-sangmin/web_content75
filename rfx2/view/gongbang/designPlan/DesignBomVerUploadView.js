Ext.define('Rfx2.view.gongbang.designPlan.DesignBomVerUploadView', {
                                    ...
                                    handler: function () {
                                        ...
                                        for (var i = 0; i < l_store.data.items.length; i++) {
                                            if (!(l_store.getData().getAt(i).data.status === "완료")) {
                                                ...
                                                gm.me().postDocument(CONTEXT_PATH + '/design/bom.do?method=uploadBomVerWOWT&file_itemcode=' + gUtil.RandomString(10),
                                                    l_store, i, tabname);
                                            }
                                        }
