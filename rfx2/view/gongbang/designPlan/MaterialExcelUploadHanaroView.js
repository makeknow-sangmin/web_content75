Ext.define('Rfx2.view.gongbang.designPlan.MaterialExcelUploadHanaroView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'material-excel-upload',
    initComponent: function () {
        ...
        this.saveAction = Ext.create('Ext.Action', {
            ...
            handler: function () {
                Ext.Ajax.request({
                    url: CONTEXT_PATH + '/sales/excelRecvPo.do?method=createConfirmMaterialBuffer',
                    params: {
                    ...
                    success: function (result, request) {
                        Ext.Msg.alert(CMD_SAVE, '엑셀업로드 처리중입니다.\n 데이터양이 많은경우 수십초 정도 소요 될 수 있습니다. \n 업로드 내용은 부품생성에서 확인하세요.', function () {
                        });
        ...
        // 		switch (lang) {
        // 		case 'ko':
        // 			path = vContent_full_path + '/cab/hanaro_item_upload_file.xlsx'; // 상대경로 사용
        // 			break;
        // 		case 'zh':
        // 			path = vContent_full_path + '/cab/hanaro_item_upload_file.xlsx';
        // 			break;
        // 		case 'en':
        // 			path = vContent_full_path + '/cab/hanaro_item_upload_file.xlsx';
        // 			break;
        ...
        // buttonToolbar.insert(6,excel_sample);
