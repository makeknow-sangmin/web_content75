//자재 관리
Ext.define('Rfx2.view.gongbang.stockMgmt.StocktakingView', {
        ...
        */
        ...
        this.gridStochkList = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                //{ text: 'LOT_NO', width: 100, align: 'left', style: 'text-align:center', dataIndex: 'lot_no' },
        ...
        this.gridDetstoList = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    text: '수량', width: 100, align: 'right', style: 'text-align:center', dataIndex: 'dtl_qty',
