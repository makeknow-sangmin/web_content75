Ext.define('Rfx2.view.gongbang.equipState.WPDwgStatusView', {
    ...
    initComponent: function () {
        ...
        this.purListSrch = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                try {
                    ...
                    if (Ext.getCmp('srccst_varchar5').getValue().length > 0) {
                        srccst_varchar5 = Ext.getCmp('srccst_varchar5').getValue();
                    }

                    if (Ext.getCmp('srccst_varchar1').getValue().length > 0) {
                        srccst_varchar1 = Ext.getCmp('srccst_varchar1').getValue();
                    }

                    // if(Ext.getCmp('mold_item_name').getValue().length > 0){
                    //     mold_item_name = Ext.getCmp('mold_item_name').getValue();
                    // }
                } catch (e) {
                ...
                if (srccst_varchar5.length > 0) {
                    gm.me().attachedFileStore.getProxy().setExtraParam('srccst_varchar5', '%' + srccst_varchar5 + '%');
                }
                if (srccst_varchar1.length > 0) {
                    gm.me().attachedFileStore.getProxy().setExtraParam('srccst_varchar1', '%' + srccst_varchar1 + '%');
                }
                // if(mold_item_name.length > 0) {
                //     gm.me().attachedFileStore.getProxy().setExtraParam('mold_item_name', '%'+mold_item_name+'%');
                // }
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            flex: 1,
            frame: true,
            bbar: getPageToolbar(this.attachedFileStore),
            border: true,
            layout: 'fit',
            forceFit: false,
            // plugins: {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        // },
                        {
                            xtype: 'triggerfield',
                            emptyText: '고객사',
                            id: gu.id('srccst_varchar5'),
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            name: 'query_sup',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().attachedFileStore.getProxy().setExtraParam('srccst_varchar5', '%' + gu.getCmp('srccst_varchar5').getValue() + '%');
                                        gm.me().attachedFileStore.load(function () {
                                        });
                                    }
                                }
                            },
                            ...
                            'onTrigger1Click': function () {
                                gu.getCmp('srccst_varchar5').setValue('');
                                gm.me().attachedFileStore.getProxy().setExtraParam('srccst_varchar5', gu.getCmp('srccst_varchar5').getValue());
                                gm.me().attachedFileStore.load(function () {
                                });
                            }
                            ...
                            xtype: 'triggerfield',
                            emptyText: '제품명',
                            id: gu.id('srccst_varchar1'),
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            name: 'query_sup',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().attachedFileStore.getProxy().setExtraParam('srccst_varchar1', '%' + gu.getCmp('srccst_varchar1').getValue() + '%');
                                        gm.me().attachedFileStore.load(function () {
                                        });
                                    }
                                }
                            ...
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('srccst_varchar1').setValue('');
                                gm.me().attachedFileStore.getProxy().setExtraParam('srccst_varchar1', gu.getCmp('srccst_varchar1').getValue());
                                gm.me().attachedFileStore.load(function () {
                                });
                            }
                        ...
                        //     xtype: 'triggerfield',
                        //     emptyText: '목형',
                        //     id: gu.id('mold_item_name'),
                        //     fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                        //     name: 'query_sup',
                        //     listeners: {
                        //         specialkey: function (field, e) {
                        //             if (e.getKey() == Ext.EventObject.ENTER) {
                        //                 gm.me().attachedFileStore.getProxy().setExtraParam('mold_item_name', '%' + gu.getCmp('project_varchar3').getValue() + '%');
                        //                 gm.me().attachedFileStore.load(function () { });
                        //             }
                        //         }
                        //     },
                        //     trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                        //     'onTrigger1Click': function () {
                        //         gu.getCmp('mold_item_name').setValue('');
                        //         gm.me().attachedFileStore.getProxy().setExtraParam('mold_item_name', gu.getCmp('mold_item_name').getValue());
                        //         gm.me().attachedFileStore.load(function () { });
                        //     }
                        // }
                    ]
            ...
            columns: [
                {
                    text: this.getMC('msg_order_grid_prd_fam', '파일 UID'),
                    width: 100,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '파일명'),
                    width: 200,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '확장자'),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'file_ext',
                    sortable: false
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '고객사'),
                    width: 100,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '도면용도'),
                    width: 100,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '목형'),
                    width: 200,
                    style: 'text-align:center',
                    dataIndex: 'mold_item_name',
                    sortable: false
                },
            ],
            // title: this.getMC('mes_reg_prd_info_msg', '첨부된 도면 리스트'),
            name: 'po',
            autoScroll: true,
            listeners: {
                edit: function (editor, e, eOpts) {
        ...
        this.setGridOnCallback(function (selections) {
            ...
            if (selections.length) {
                ...
                this.attachedFileStore.getProxy().setExtraParam('group_code', rec.get('unique_id_long'));
                this.attachedFileStore.load();
    ...
    attachedFileStore: Ext.create('Mplm.store.AttachFileWoodenStore', {group_code: null}),
    stores: [],
    ingredientList: [],
    storecount: 0,
    // gridContent2: null,
