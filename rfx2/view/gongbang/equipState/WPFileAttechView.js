Ext.define('Rfx2.view.gongbang.equipState.WPFileAttechView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField('srccst_varchar1');
        this.addSearchField('srccst_varchar5');
        this.addSearchField('mold_item_name');
        ...
        this.fileattachAction = Ext.create('Ext.Action', {
            ...
            disabled: false,
            text: this.getMC('mes_order_file_btn', '파일업로드'),
        ...
        this.createStore('Rfx2.model.company.mjcm.WoodenFile', [{
                property: 'unique_id',
                direction: 'DESC'
            }],
            gm.pageSize
    ...
    attachFile: function () {
        ...
        this.attachedFileStore.getProxy().setExtraParam('group_code', null);
                ...
                items: [
                    {
                        ...
                        listeners: {
                            select: function (combo, record) {
                                console_logs('>>>>> wooden_select', gu.getCmp('wooden_select').getValue());
                                gm.me().attachedFileStore.getProxy().setExtraParam('group_code', gu.getCmp('wooden_select').getValue());
                    ...
                    '->',
                    {
                        ...
                        scope: this.fileGrid,
                        handler: function () {
                            console_logs('>>>> ', gu.getCmp('wooden_select').getValue());
                            var url_value = gu.getCmp('wooden_select').getValue();
                            if (url_value === null) {
                                url_value = -1;
                            }
                            var url = CONTEXT_PATH + '/uploader.do?method=multi&group_code=' + url_value;
        ...
        var win = Ext.create('ModalWindow', {
            ...
            buttons: [{
                ...
                handler: function (btn) {
                    ...
                    gm.me().attachedFileStore.getProxy().setExtraParam('group_code', null);
                    gm.me().attachedFileStore.load();
                    win.close();
                }
            }],
