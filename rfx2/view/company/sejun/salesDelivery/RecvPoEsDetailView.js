Ext.define('Rfx2.view.company.sejun.salesDelivery.RecvPoEsDetailView', {
    ...
    initComponent: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: gm.getMC('CMD_Product', '제품군'), width: 100, style: 'text-align:center', dataIndex: 'class_code', sortable: false },
                { text: '제품명', width: 100, style: 'text-align:center', dataIndex: 'item_model', sortable: false },
                { text: '기준모델', width: 100, style: 'text-align:center', dataIndex: 'srcahd_description', sortable: false },
                ...
                { text: '단가', width: 80, style: 'text-align:center', decimalPrecision: 5, dataIndex: 'item_unit_price', sortable: false, align: 'right' },
                { text: '통화', width: 80, style: 'text-align:center', dataIndex: 'item_munit', sortable: false },
                {
                    text: '납기일', xtype: 'datecolumn', width: 90, style: 'text-align:center', dataIndex: 'delivery_date', sortable: false,
                    format: 'Y-m-d', editor: { xtype: 'datefield', format: 'Y-m-d' },
                },
                { text: 'Remark', width: 150, style: 'text-align:center', dataIndex: 'item_remark', editor: { xtype: 'textfield' }, sortable: false },
            ],
            title: '상세정보',
            name: 'po',
            autoScroll: true,
                ...
                * */
                ...
                var searchItemGrid = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        ...
                        { text: "기준모델", flex: 1.0, style: 'text-align:center', dataIndex: 'srcahd_description', sortable: true },
        ...
        var action = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                var searchItemGrid = Ext.create('Ext.grid.Panel', {
                    ...
                    plugins: [gm.me().cellEditing],
                    columns: [
                        { text: "사업부", flex: 0.8, style: 'text-align:center', dataIndex: 'supplier_code', sortable: true },
