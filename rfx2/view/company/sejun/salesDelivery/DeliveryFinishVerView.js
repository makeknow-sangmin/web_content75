//생산완료 현황
Ext.define('Rfx2.view.company.sejun.salesDelivery.DeliveryFinishVerView', {
    ...
    initComponent: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                { text: this.getMC('msg_order_grid_prd_fam', '납품여부'), width: 100, style: 'text-align:center', dataIndex: 'delivery_process_yn', sortable: false },
                { text: this.getMC('msg_order_grid_prd_fam', 'Pallet No'), width: 100, style: 'text-align:center', dataIndex: 'po_no', sortable: false },
                ...
                { text: this.getMC('msg_order_grid_prd_name', 'LOT NO'), width: 100, style: 'text-align:center', dataIndex: 'lot_no', sortable: true },
                {
