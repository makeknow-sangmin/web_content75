Ext.define('Rfx2.view.company.sejun.salesDelivery.BuyerListView', {
    ...
    initComponent: function () {
        ...
        this.addPoAction = Ext.create('Ext.Action', {
            ...
            text: this.getMC('mes_order_recv_btn', '거래처등록'),
            tooltip: this.getMC('mes_order_recv_btn_msg', '거래처등록'),
            disable: true,
            handler: function () {
                    ...
                    items: [
                        {
                            xtype: 'fieldset',
                            collapsible: false,
                            title: gm.me().getMC('msg_order_dia_header_title', '기본 거래처 정보'),
                            width: '100%',
                            style: 'padding:10px',
                            defaults: {
                                ...
                                
                                {
                                    ...
                                    items: [

                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '거래처 명',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'biz_condition',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '품목',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'president_name',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '대표자 명',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'biz_no',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '사업자 번호',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'address_1',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '주소',
                                        },
                                        {
                                            xtype: 'textfield',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '담당자 명',
                                        },
                                        {
                                            xtype: 'textfield',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '담당자 번호',
                                        },
                                        {
                                            xtype: 'textfield',
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '회사  번호',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'comment_etc',
                ...
                var win = Ext.create('Ext.Window', {
                    modal: true,
                    title: gm.me().getMC('mes_order_recv_btn', '거래처등록'),
                    width: 650,
                    height: 300,
                    plain: true,
                    items: form,
                            ...
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    form.submit({
                                        ...
                                        url: CONTEXT_PATH + '/sales/buyer.do?method=addBuyerInfo',
        ...
        this.editPoAction = Ext.create('Ext.Action', {
            iconCls: 'af-edit',
            text: this.getMC('mes_order_edit_btn', '거래처수정'),
            tooltip: this.getMC('mes_order_edit_btn_msg', '거래처수정'),
            disabled: true,
            handler: function () {
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        // },
                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: false,
                                            value: select.get('wa_name'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '거래처명',
                                        },
                                        {
                                            xtype: 'textfield',
                                            id: 'biz_condition',
                                            ...
                                            padding: '0 0 5px 30px',
                                            width: '45%',
                                            value: select.get('biz_condition'),
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '품목',
                                        },
                                        {
                                            ...
                                            padding: '0 0 5px 30px',
                                            width: '45%',
                                            value: select.get('president_name'),
                                            allowBlank: false,
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '대표자 명',
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            width: '45%',
                                            allowBlank: true,
                                            value: select.get('site_manager_name'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '담당자 명',
                                        },
                                        {
                                            xtype: 'textfield',
                                            ...
                                            allowBlank: false,
                                            format: 'Y-m-d',
                                            value: select.get('site_manager_mobile_no'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '담당자 번호',
                                        },
                                        {
                                            xtype: 'textfield',
                                            ...
                                            width: '45%',
                                            allowBlank: true,
                                            value: select.get('site_manager_tel_no'),
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '회사 번호',
                                        },
                                        {
                                            xtype: 'combo',
                                            ...
                                            store: Ext.create('Mplm.store.YesnoStore'),
                                            value: 'Y',
                                            listConfig: {
                                                getInnerTpl: function() {
                                            ...
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '거래구분',
                                        },
                                        // {
                                        //     xtype: 'numberfield',
                                        //     id: 'quan',
                ...
                var win = Ext.create('Ext.Window', {
                    modal: true,
                    title: gm.me().getMC('mes_order_edit_btn', '거래처수정'),
                    width: 650,
                    height: 350,
                    plain: true,
                    items: form,
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    var val = form.getValues(false);
                                    form.submit({
                                        url: CONTEXT_PATH + '/sales/buyer.do?method=editBuyerInfo',
                                        params: {
                                    ...
                                    Ext.MessageBox.alert('알림', '거래처 수정 원인을 확인해주세요.');
                                }
                            }
                        }
                    }, {
        ...
        this.excelUploadAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
            text: '파일업로드',
            tooltip: this.getMC('거래처등록시 필요문서를 일괄 업로드 합니다.'),
            handler: function () {
        ...
        this.poPrdDetailStore = Ext.create('Rfx2.store.company.sejun.DsCenterStore', {});
                    ...
                    items: [
                        {
                            xtype: 'fieldset',
                            frame: true,
                            title: gm.me().getMC('msg_btn_prd_extra_add', '물류센터등록'),
                            width: '100%',
                            height: '100%',
                            layout: 'fit',
                            defaults: {
                            ...
                            items: [
...

                                {
                                    ...
                                    allowBlank: false,
                                    //  value: select.get('wa_name'),
                                    fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '센터명',
                                },
                                {
                                    xtype: 'textfield',
                                    id: 'address',
                                ...
                                },
                                {
                                    ...
                                    // value: select.get('president_name'),
                                    allowBlank: false,
                                    fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '전화번호',
                                },
                                {
                                    xtype: 'textfield',
                                    id: 'remark',
                                ...
                                },
                                {
                                    ...
                                    name: 'combst_uid',
                                    padding: '0 0 5px 30px',
                                    value: selections.get('unique_id_long')
                                },
                            ]
                        },
                    ]
                    ...
                    buttons: [{
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                var form = Ext.getCmp('addDsForm').getForm();
                                if (form.isValid()) {
                                    win.setLoading(true);
                                    var val = form.getValues(false);
                                    form.submit({
                                        submitEmptyText: false,
                                        url: CONTEXT_PATH + '/sales/buyer.do?method=addDscenterInfo',
                                        success: function (val, action) {
                                            console_logs('val >>>>', val);
                                            win.setLoading(false);
                                            gm.me().poPrdDetailStore.load();
                                ...
                                //     url: CONTEXT_PATH + '/sales/buyer.do?method=addDscenterInfo',
                                //     params: {
                                //         combst_uid: selections.get('unique_id_long'),
        ...
        this.deletePrdAction = Ext.create('Ext.Action', {
            ...
            handler: function () {
                Ext.MessageBox.show({
                    title: gm.me().getMC('msg_btn_prd_delete_title', '물류센터삭제'),
                    msg: gm.me().getMC('msg_btn_prd_delete_msg', '선택한 물류센터를 삭제하시겠습니까?'),
                    ...
                    fn: function (btn) {
                        if (btn == 'yes') {
                            ...
                            Ext.Ajax.request({
                                url: CONTEXT_PATH + '/sales/buyer.do?method=deleteDscenter',
                                params: {
                                    unique_id: uids,
                                },
                                success: function (result, request) {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    text: this.getMC('msg_order_grid_prd_fam', '물류센터명'),
                    width: 100, style: 'text-align:center',
                    dataIndex: 'dscenter_name',
                    editor: 'textfield',
                    css: 'edit-cell',
                    sortable: false,
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '주소'),
                    width: 150, style: 'text-align:center',
                    css: 'edit-cell',
                    editor: 'textfield',
                    dataIndex: 'address', sortable: false
                },
                {
                    text: this.getMC('msg_order_grid_prd_name', '전화번호'),
                    width: 150, style: 'text-align:center',
                    css: 'edit-cell',
                    editor: 'textfield',
                    dataIndex: 'tel_no',
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', '비고란'),
                    width: 150, style: 'text-align:center',
                    css: 'edit-cell',
                    editor: 'textfield',
                    dataIndex: 'remark',
            ...
            title: this.getMC('mes_reg_prd_info_msg', '해당 거래처의 물류센터'),
            name: 'po',
            autoScroll: true,
            listeners: {
                edit: function (editor, e, eOpts) {
                    var columnName = e.field;
                    var tableName = 'dscenter';
                    console_logs('e.record >>>>>>> ', e.record);
                    var unique_id = e.record.get('unique_id_long');
                    // var unique_id = e.record.getId();
                    var value = e.value;

                    gm.editAjax(tableName, columnName, value, 'unique_id_long', unique_id, { type: '' });
                    gm.me().poPrdDetailStore.load();
        ...
        this.setGridOnCallback(function (selections) {
            ...
            if (selections.length) {
                ...
                gu.getCmp('selectedMtrl').setHtml('[' + wa_code + '] ' + wa_name);
        ...
        var action = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                var winProduct = Ext.create('ModalWindow', {
                    title: gm.me().getMC('msg_btn_prd_add', '물류센터추가'),
                    width: 1100,
                    height: 600,
                    minWidth: 600,
                    minHeight: 300,
    ...
    getPrdAdd: function () {
        var action = Ext.create('Ext.Action', {
            ...
            itemId: 'addItemAction',
            disabled: false,
            text: gm.me().getMC('msg_btn_prd_add', '등록'),
            handler: function (widget, event) {
                ...
                * */
                ...
                var searchItemGrid = Ext.create('Ext.grid.Panel', {
                    ...
                    layout: 'fit',
                    title: gm.me().getMC('msg_product_add_dia_header_title1', '검색'),
                    plugins: {
                        ptype: 'cellediting',
                        clicksToEdit: 2,
                    },
                    columns: [
                        // { text: gm.me().getMC('msg_product_add_dia_div', '사업부'), flex: 0.5, style: 'text-align:center', dataIndex: 'division_code', sortable: true },
                        { text: gm.me().getMC('msg_product_add_dia_model', '모델명'), flex: 1.5, style: 'text-align:center', dataIndex: 'item_name', sortable: true },
                        // { text: gm.me().getMC('msg_order_grid_prd_desc', '기준모델'), flex: 1.0, style: 'text-align:center', dataIndex: 'description', sortable: true },
                        { text: gm.me().getMC('msg_product_add_search_field3', '규격'), flex: 1.8, style: 'text-align:center', dataIndex: 'specification', sortable: true },
                        // { text: gm.me().getMC('msg_product_add_dia_price', '판매단가'), flex: 1, align: 'right', style: 'text-align:center', dataIndex: 'sales_price', sortable: true },
                        // { text: gm.me().getMC('msg_order_grid_prd_currency', '통화'), flex: 0.5, style: 'text-align:center', dataIndex: 'currency', sortable: true },
                ...
                var saveForm = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        { text: gm.me().getMC('msg_product_add_dia_model', '모델명'), flex: 1, style: 'text-align:center', dataIndex: 'item_name', sortable: true },
                        { text: gm.me().getMC('msg_order_grid_prd_desc', '기준모델'), flex: 1, dataIndex: 'description', style: 'text-align:center', sortable: true },
                        { text: gm.me().getMC('msg_product_add_search_field3', '규격'), flex: 2, dataIndex: 'specification', style: 'text-align:center', sortable: true },
                        {
                            text: gm.me().getMC('msg_order_grid_quan_desc', '수량'),
                            flex: 1,
                            dataIndex: 'sales_amount',
    ...
    confirmPjGoDesign: function (result) {
        if (result == 'yes') {
            ...
            if (select == null || select == undefined || select.length < 1) {
                Ext.MessageBox.alert('알림', '금형를 지정해주세요.');
                return null;
            }
