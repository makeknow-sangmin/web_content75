Ext.define('Rfx2.view.company.sejun.salesDelivery.RecvPoDetailView', {
                ...
                * */
                ...
                var saveForm = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        ...
                        { text: gm.me().getMC('msg_product_add_search_field3', '댄위'), flex: 1, dataIndex: 'unit_code', style: 'text-align:center', sortable: true },
