//출하 관리
Ext.define('Rfx2.view.company.sejun.salesDelivery.ProductStockVerView', {
    ...
    initComponent: function () {
        ...
        //this.addSearchField('product_type');
        ...
        // this.setWanMatView = Ext.create('Ext.Action', {
        //     xtype: 'button',
        //     text: '완제품',
        //     tooltip: '완제품',
        //     toggleGroup: 'matType',
        ...
        //         this.matType = 'RAW';
        //         gm.me().store.getProxy().setExtraParams({});
        //         gm.me().store.getProxy().setExtraParam('sp_code', 'G');
        //         gm.me().store.load(function () {
        //         });
        //     }
        // });
        // this.setBanMatView = Ext.create('Ext.Action', {
        //     xtype: 'button',
        //     text: '반제품',
        //     tooltip: '반제품',
        //     toggleGroup: 'matType',
        ...
        //         this.matType = 'SUB';
        //         gm.me().store.getProxy().setExtraParams({});
        //         gm.me().store.getProxy().setExtraParam('sp_code', 'H');
        //         gm.me().store.load(function () {
        //         });
        //     }
        // });
        // this.setJeaMatView = Ext.create('Ext.Action', {
        //     xtype: 'button',
        //     text: '재공품',
        //     tooltip: '재공품',
        //     toggleGroup: 'matType',
        ...
        buttonToolbar.insert(5, this.setJeaMatView);
        buttonToolbar.insert(5, this.setBanMatView);
        buttonToolbar.insert(5, this.setWanMatView);
        ...
        this.createStore('Rfx2.model.company.sejun.ProductStock',
            [{
                property: 'unique_id',
                direction: 'DESC'
            }],
