//생산완료 현황
Ext.define('Rfx2.view.company.sejun.salesDelivery.DeliveryMgmtDetailView', {
    ...
    initComponent: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                { text: this.getMC('msg_order_grid_prd_fam', '품명'), width: 100, style: 'text-align:center', dataIndex: 'item_code', sortable: false },
                { text: this.getMC('msg_order_grid_prd_fam', '품번'), width: 100, style: 'text-align:center', dataIndex: 'item_name', sortable: false },
                { text: this.getMC('msg_order_grid_prd_fam', '규격'), width: 200, style: 'text-align:center', dataIndex: 'specification', sortable: false },
                { text: this.getMC('msg_order_grid_prd_fam', '기준모델'), width: 200, style: 'text-align:center', dataIndex: 'description', sortable: false },
                {
