Ext.define('Rfx2.view.company.sejun.qualityMgmt.LotTrackingView', {
    ...
    initComponent: function () {
        ...
        this.orderInfoGrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: gm.getMC('CMD_Product', '제품군'), width: 150, align: 'left', style: 'text-align:center', dataIndex: 'class_code' },
