Ext.define('Rfx2.view.company.sejun.qualityMgmt.MachineDataChartView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'machine-datachart-view',
    requires: [
    ...
    //     //그리드 생성
       ...
       var test = Ext.create('Ext.Panel', {
        ...
        //그리드 생성
        this.createGrid(searchToolbar,option);
