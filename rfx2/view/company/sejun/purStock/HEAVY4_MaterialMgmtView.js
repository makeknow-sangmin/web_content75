//자재 관리
Ext.define('Rfx2.view.company.sejun.purStock.HEAVY4_MaterialMgmtView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.HEAVY4_MaterialMgmt', [{
                property: 'item_code',
                direction: 'DESC'
            }],
            gm.pageSize
        ...
        //     , anchor: '100%'
        //     , width: 175
        //     , field_id: 'system_code'
        //     , store: this.MaterialTypeStore
        //     , displayField: 'code_name_kr'
        //     , valueField: 'system_code'
        //     , emptyText: '자재구분'
        //     , innerTpl: '<div data-qtip="{code_name_kr}">[{system_code}]{code_name_kr}</div>'
        //     , minChars: 1
        //     , typeAhead: true
        //     , queryMode: 'remote'
        ...
        //             gm.me().store.getProxy().setExtraParam('sg_code', selected);
        //         }
        //     }
        // })
        ...
        this.setRowClass(function (record, index) {
            ...
            if (stock_qty_safe > 0) {
                if (stock_qty <= stock_qty_safe * rate) {
                    return 'red-row';
                } else {
                    return 'yellow-row';
                }
        ...
        this.store.getProxy().setExtraParam('existPrimarySupplier', 'Y');
    ...
    //MaterialTypeStore: Ext.create('Mplm.store.MaterialTypeStore', {}),
});
