//구매요청
Ext.define('Rfx2.view.company.sejun.purStock.PurchaseRequestDetailView', {
    ...
    initComponent: function () {
        ...
        this.printPDFAction = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                var rtgast_uid = gm.me().vSELECTED_RTGUNIQUE_ID;
        ...
        this.setGridOnCallback(function (selections) {
            if (selections.length) {
                ...
                gm.me().vSELECTED_RTGUNIQUE_ID = rec.get('pr_uid');
                gm.me().vSELECTED_UNIQUE_ID = rec.get('unique_uid'); //rtgast_uid
            ...
            // this.grid.getStore().getProxy().setExtraParam('rtgastuid', this.rtgast_uids);
