//자재 관리
Ext.define('Rfx2.view.company.sejun.purStock.HEAVY5_MyCart', {
            ...
            handler: function () {
                ...
                if (isExistAssy && !isExistOthers && selections.length > 1) {
                    ...
                    if (selections.length) {
                        ...
                        var requestText = '날짜를 기입하고 확인 버튼을 누르시기 바랍니다.';
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        var reserved_timestamp3 = (gu.getCmp('reserved_timestamp3') == undefined || gu.getCmp('reserved_timestamp3') == null)
                                            ? null : gu.getCmp('reserved_timestamp3').getValue();
                                        ...
                                        if (pr_quans > 0) {
                                            ...
                                            Ext.Ajax.request({
                                                url: CONTEXT_PATH + '/purchase/request.do?method=createBuyingRequestAttr',
                                                params: {
                                                    ...
                                                    src_currencies: q2,
                                                    item_name: q1,
                                                    req_date: Ext.Date.format(request_date, 'Y-m-d H:i:s'),
    ...
    updateDesinComment: function (rec) {
        ...
        Ext.Ajax.request({
            url: CONTEXT_PATH + '/purchase/request.do?method=updateMyCart',
            params: {
