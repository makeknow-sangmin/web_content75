...
Ext.define('Rfx2.view.company.sejun.purStock.HEAVY4_WearingWaitView', {
        ...
        this.grid.on('edit', function (editor, e) {
            ...
            switch (field) {
                ...
                case 'sales_price_local':
                    ...
                    selection[0].set('total_price_local', Math.floor(rec.get('curGr_qty') * selection[0].get('sales_price_local')));
                    break;
                default:
                    break;
            }
            ...
            // var buying_price = rec.get('buying_price_local');
                        ...
                        Ext.MessageBox.show({
                            ...
                            fn: function (btn) {
                                if (btn == 'yes') {
                                    ...
                                    var selections = gm.me().cancelCloseGrGrid.getSelectionModel().getSelection();
                    ...
                    items: [
                        {
                            ...
                            '총 수량: ' + Ext.util.Format.number(0, '0,00/i')
                        }
            ...
            buttons: [{
                ...
                handler: function (btn) {
                    ...
                    for (var i = 0; i < totalIndex; i++) {
                        ...
                        var input_lot = gm.me().grid.getSelectionModel().getSelection()[0].get('po_no');
                        var exp_date = vo.get('exp_date');
                    ...
                    if (isEmptyLot == true) {
                        ...
                        if (btn == 'no') {
                            ...
                            Ext.Ajax.request({
                                url: CONTEXT_PATH + '/quality/wgrast.do?method=createGrIndividualAutoLots',
                                timeout: 120000,
                                params: {
    ...
    setQuanBoxValue: function () {
        ...
        totalQuanSum.setHtml('총 입고수량: ' + Ext.util.Format.number(sumQuan, '0,00/i') + ' / ' +
            '총 수량: ' + Ext.util.Format.number(sumBox, '0,00/i'));
