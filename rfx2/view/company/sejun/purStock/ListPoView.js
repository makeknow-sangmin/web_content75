Ext.define('Rfx2.view.company.sejun.purStock.ListPoView', {
...
//     },
    ...
    cancelPoHandler: function () {
        ...
        var selections = gm.me().lGrid.getSelectionModel().getSelection();
        var uids = [];
        var blocking = [];
...
//             columns: columns
//         });
//         gm.me().listPoviewGrid.getSelectionModel().on({
//             selectionchange: function (sm, selections) {
//                 fc(selections);
//             }
//         });
