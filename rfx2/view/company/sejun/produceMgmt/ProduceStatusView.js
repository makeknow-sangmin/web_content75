//수주관리 메뉴
Ext.define('Rfx2.view.company.sejun.produceMgmt.ProduceStatusView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.ProduceStateMgmt', [{
        ...
        this.store.getProxy().setExtraParam('orderBy', 'rtgast_op.reserved_timestamp1 desc');
