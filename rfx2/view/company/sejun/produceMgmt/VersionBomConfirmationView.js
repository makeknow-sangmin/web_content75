Ext.define('Rfx2.view.company.sejun.produceMgmt.VersionBomConfirmationView', {
    ...
    initComponent: function () {
        ...
        this.gridPoList = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: '수주번호', width: 100, align: 'left', style: 'text-align:center', dataIndex: 'order_number', sortable: false },
                {
                    text: '수주일자',
                    width: 100,
                    style: 'text-align:center',
