//설비현황
Ext.define('Rfx2.view.company.sejun.equipState.MachineSettingMgmtView', {
    ...
    initComponent: function () {
        ...
        this.gridTemplateBuffer = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: '값', width: 150,  style: 'text-align:center', editor: 'textfield', dataIndex: 'column_value', sortable: true}
            ],
        ...
        this.purListSrch = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                // gm.me().clMachineSettingStore.getProxy().setExtraParam('supplier_name', '%' + wa_name + '%');
                gm.me().clMachineSettingStore.load();
            }
        });

        this.clMachineSettingStore = Ext.create('Mplm.store.ClaastStore', {pageSize: 100, identification_code: 'MACHINE_SETTING'});
        this.clMachineSettingColumnStore = Ext.create('Mplm.store.ClaastStore', {pageSize: 100, identification_code: 'MACHINE_SETTING'});
        ...
        this.gridTemplateColumnList = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: '순서', width: 50,  style: 'text-align:center', align: 'center', dataIndex: 'display_order', sortable: true},
                {text: '항목', width: 180,  style: 'text-align:center', editor: 'textfield', dataIndex: 'class_name', sortable: true}
            ],
            title: '항목',
            name: 'column',
            autoScroll: true,
