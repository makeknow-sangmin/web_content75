Ext.define('Rfx2.view.company.sejun.stockMgmt.StockInoutView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField(
        {
            ...
            , params: {level1: '1', identification_code: 'PRODUCT_MATERIAL'}
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    select: function (combo, record) {
                                        var rec = gm.me().grid.getSelectionModel().getSelection()[0];
                                        var gubun = gu.getCmp('innout_gubun').getValue();
