//생산완료 현황
Ext.define('Rfx2.view.company.sejun.stockMgmt.StockExpirationDateView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.sejun.NstoCkMgmt', [{
                property: 'item_code',
                direction: 'ASC'
            }],
            gm.pageSize
        ...
        this.detailStockGrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    text: '수량', width: 70, align: 'right', style: 'text-align:center', dataIndex: 'dtl_box_qty', sortable: false,
