//생산완료 현황
Ext.define('Rfx2.view.company.sejun.stockMgmt.StockMgmtDetailProductView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'stock-mgmt-detail-product-view',
    inputBuyer: null,
    preValue: 0,
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            , params: {level1: 1, identification_code: "PRD_CLS_CODE"}
        ...
        this.addSearchField({
            ...
            , displayField: 'class_name'
            , valueField: 'class_code'
            , params: {level1: 2, identification_code: "PRD_CLS_CODE"}
            , innerTpl: '<div data-qtip="{system_code}">[{class_code}] {class_name}</div>'
        });
        ...
        this.addSearchField({
            ...
            , displayField: 'class_name'
            , valueField: 'class_code'
            , params: {level1: 3, identification_code: "PRD_CLS_CODE"}
            , innerTpl: '<div data-qtip="{system_code}">[{class_code}] {class_name}</div>'
        });
        ...
        this.createStore('Rfx2.model.company.sejun.StockMgmtDetailProduct', [{
                property: 'unique_id',
                direction: 'DESC'
            }], gm.pageSize
            , {},
