...
Ext.define('Rfx2.view.company.sejun.stockMgmt.YearPurchaseView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'year-purchase-view',
    requires: [
    ...
    yearPurchaseStore: Ext.create('Rfx2.store.company.sejun.YearPurchaseStore', { }),
    ...
    initComponent: function () {
        ...
        this.yearPurchaseStore.on('load', function (me, records, c, d) {
            ...
            gm.me().westGrid.bodyWrap.component.config.columns[0].text = selectYear +'년' + ' 원부자재매입현황';
