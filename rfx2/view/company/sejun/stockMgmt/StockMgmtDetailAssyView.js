//생산완료 현황
Ext.define('Rfx2.view.company.sejun.stockMgmt.StockMgmtDetailAssyView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'stock-mgmt-detail-assy-view',
    inputBuyer: null,
    preValue: 0,
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.sejun.StockMgmtDetailAssy', [{
                property: 'unique_id',
                direction: 'DESC'
            }], gm.pageSize
            , {},
