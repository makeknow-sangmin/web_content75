//생산완료 현황
Ext.define('Rfx2.view.company.sejun.stockMgmt.StockMgmtDetailView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            , params: { parentCode: 'PRD_CLS_CODE', hasNull: true }
            , innerTpl: '<div data-qtip="{system_code}">[{systemCode}] {codeName}</div>'
        });
        ...
        this.createStore('Rfx2.model.company.sejun.StockMgmtDetail', [{
            property: 'unique_id',
            direction: 'DESC'
        }], gm.pageSize
            , {},
