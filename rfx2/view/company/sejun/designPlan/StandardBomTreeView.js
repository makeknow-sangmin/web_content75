Ext.define('Rfx2.view.company.sejun.designPlan.StandardBomTreeView', {
    ...
    initComponent: function () {
        ...
        this.verAddAction = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                if(src_selection.length == 0){return;}
    ...
    productStore: Ext.create('Mplm.store.ProductStore', {limit:10000}),
