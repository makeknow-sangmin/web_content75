Ext.define('Rfx2.view.company.sejun.designPlan.DesignBomUploadView', {
            ...
            items: [
                {
                    ...
                    items: [{
                        ...
                        fieldLabel: '구분',
                        items: [
                            {boxLabel: 'BOM_EXCEL', name: 'radio1', inputValue: 'BOM_EXCEL', checked: true}
                        ],
                        listeners: {
                                    ...
                                    handler: function () {
                                        ...
                                        for (var i = 0; i < l_store.data.items.length; i++) {
                                            if (!(l_store.getData().getAt(i).data.status === "완료")) {
                                                ...
                                                gm.me().postDocument(CONTEXT_PATH + '/design/bom.do?method=uploadBomVer&file_itemcode=' + gUtil.RandomString(10)/*+'&callback=alert'*/,
                                                    l_store, i, tabname);
                                            }
                                        }
