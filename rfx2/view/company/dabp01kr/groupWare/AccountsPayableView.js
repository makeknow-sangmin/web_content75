...
Ext.define('Rfx2.view.company.dabp01kr.groupWare.AccountsPayableView', {
...
//		this.createGrid(arr, {width: '60%'});
        ...
        buttonToolbar.insert(0, this.execApAction);
	...
	//		                        myProxy.setExtraParam('MENU_DETAIL', '555555');
		...
		this.supplierGrid.getSelectionModel().on({
        	selectionchange: function(sm, selections) {  
                ...
                var elpasedTime = end_date - start_date;
