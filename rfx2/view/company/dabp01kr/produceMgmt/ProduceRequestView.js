//구매요청
Ext.define('Rfx2.view.company.dabp01kr.produceMgmt.ProduceRequestView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'produce-request-view',
    initComponent: function(){
        ...
        this.createStore('Rfx.model.ProduceRequest', [{
...
//       
    ...
    buttonToolbar.insert(3, '-');
        ...
        this.setGridOnCallback(function(selections) {
        	...
        	console_logs("11111111111111111");
