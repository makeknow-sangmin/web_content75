Ext.define('Rfx2.view.company.dabp01kr.produceMgmt.HEAVY4_WorkOrderDoosView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'workorder-doos-view',
    ...
    initComponent: function(){
        ...
        this.setGridOnCallback(function(selections) {
            ...
            if (selections.length) {
                ...
                switch(vCompanyReserved4){
                    case 'DOOS01KR':
                        this.workOrderGrid.getStore().getProxy().setExtraParam('orderBy', 'srcahd.unique_id');
                        break;
                    case "DDNG01KR" :
