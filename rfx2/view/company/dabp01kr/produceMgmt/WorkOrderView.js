Ext.define('Rfx2.view.company.dabp01kr.produceMgmt.WorkOrderView', {
...
//        }	);
		...
		// this.grid.viewConfig.preserveScrollOnRefresh = true;
		// this.grid.getView().holdPosition = true;
        console_logs('>>>>>> ssss', this.grid);
        //작업지시 Action 생성
