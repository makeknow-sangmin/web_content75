Ext.define('Rfx2.view.company.dabp01kr.produceMgmt.HEAVY4_ProducePlanViewHaeWon', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'produceplan-view-hae',
...
//	    } 
        ...
        this.addLotAction = Ext.create('Ext.Action', {
			 ...
			 handler: function() {
				 ...
				 case 'DOOS01KR':
					 ...
					 break;
				 default:
					 gMain.selPanel.reserved_varchar3 = big_pcs_code;
					 break;
				 }
				 switch(vCompanyReserved4){
				 case "DDNG01KR": 
      ...
      //Lot 해체 Action 생성
       ...
       /* if(vCompanyReserved4 =='DDNG01KR'){
        ...
        console_logs("process2222 : ", processes);
...
//        });
        ...
        case 'DOOS01KR':
        	if(viewName == 'EPC5_T') {
        		this.grid.getStore().getProxy().setExtraParam('reserved_varchar3', 'TPRD');
        	} else {
