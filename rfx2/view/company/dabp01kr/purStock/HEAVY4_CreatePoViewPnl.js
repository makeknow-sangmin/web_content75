...
Ext.define('Rfx2.view.company.dabp01kr.purStock.HEAVY4_CreatePoViewPnl', {
...
//       });
       ...
       buttonToolbar.insert(4, this.createPoAction);
        	...
        	handler: function(btn){
        		...
        		Ext.MessageBox.show({
                    ...
                    fn: function(btn) {
 	        		   ...
 	        		   var reccode = val.get('supplier_information');
	        		   console_logs('reccode+++++++++++++++', reccode);
                    	...
                    	form.submit({
                			...
                			success: function(val, action){
                            	...
                            	for(var i=0; i< selections.length; i++) {
                            		var rec = selections[i];
                            		try {
                                		gm.me().getStore().remove(rec);                            			
                            		} catch(e) {
                            			console_logs('gm.me().getStore().remove(rec)', e);
                            		}
