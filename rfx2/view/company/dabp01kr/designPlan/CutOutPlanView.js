Ext.define('Rfx2.view.company.dabp01kr.designPlan.CutOutPlanView', {
    ...
    createWest: function () {
        ...
        var wonjiColumn = [
            {text: '재고위치', width: 70, dataIndex: 'alter_reason', style: 'text-align:center', sortable: false},
            {
                ...
                renderer: function(value, metaData, record, rowIndex, colIndex, store) {
                    var maker_code = record.get('maker_code');
                    ...
                    return maker_code + ', ' + item_name + ', ' + description + ', ' + comment + ', ' + remark;
                }
            },
            {text: '품명', width: 180, dataIndex: 'item_code', style: 'text-align:center', sortable: false},
        ...
        var wonjiStockStore = Ext.create('Rfx.model.StockLine', {
            fields: wonjiColumn
        });

        var wondanStockStore = Ext.create('Rfx.model.StockLine', {
            fields: wondanColumn
        });

        var bujajaeStockStore = Ext.create('Rfx.model.StockLine', {
            fields: bujajaeColumn
        });

        this.storeStockWonji = new Ext.data.Store({
            pageSize: 100,
            model: wonjiStockStore,
            sorters: [{
        ...
        this.stockWonjiSrch = Ext.create('Ext.Action', {
            itemId: 'stockWonjiSrch',
            iconCls: 'af-search',
            text: CMD_SEARCH,
            disabled: false,
            handler: function (widget, event) {

                var maker_code = gu.getCmp('maker_code_wonji').getValue();
                var item_name = gu.getCmp('item_name_wonji').getValue();
                var description = gu.getCmp('description_wonji').getValue();
                var comment = gu.getCmp('comment_wonji').getValue();
                var remark = gu.getCmp('remark_wonji').getValue();

                gm.me().storeStockWonji.getProxy().setExtraParam('maker_code', '%' + maker_code + '%');
                gm.me().storeStockWonji.getProxy().setExtraParam('item_name', '%' + item_name + '%');
                gm.me().storeStockWonji.getProxy().setExtraParam('description', '%' + description + '%');
                gm.me().storeStockWonji.getProxy().setExtraParam('comment', '%' + comment + '%');
                gm.me().storeStockWonji.getProxy().setExtraParam('remark', '%' + remark + '%');
                gm.me().storeStockWonji.load();
            }
        });
                    ...
                    items: [
                        {
                            xtype: 'triggerfield',
                            emptyText: '제지사',
                            id: gu.id('maker_code_wonji'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWonji.getProxy().setExtraParam('maker_code', '%'
                                            + gu.getCmp('maker_code_wonji').getValue() + '%');
                                        gm.me().storeStockWonji.load();
                                    }
                                }
                            },
                            ...
                            'onTrigger1Click': function () {
                                gu.getCmp('maker_code_wonji').setValue('');
                                gm.me().storeStockWonji.getProxy().setExtraParam('maker_code',
                                    gu.getCmp('maker_code_wonji').getValue());
                                gm.me().storeStockWonji.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '지종',
                            id: gu.id('item_name_wonji'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWonji.getProxy().setExtraParam('item_name', '%'
                                            + gu.getCmp('item_name_wonji').getValue() + '%');
                                        gm.me().storeStockWonji.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('item_name_wonji').setValue('');
                                gm.me().storeStockWonji.getProxy().setExtraParam('item_name',
                                    gu.getCmp('item_name_wonji').getValue());
                                gm.me().storeStockWonji.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '평량',
                            id: gu.id('description_wonji'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWonji.getProxy().setExtraParam('description', '%'
                                            + gu.getCmp('description_wonji').getValue() + '%');
                                        gm.me().storeStockWonji.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('description_wonji').setValue('');
                                gm.me().storeStockWonji.getProxy().setExtraParam('description',
                                    gu.getCmp('description_wonji').getValue());
                                gm.me().storeStockWonji.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '폭',
                            id: gu.id('comment_wonji'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWonji.getProxy().setExtraParam('comment', '%'
                                            + gu.getCmp('comment_wonji').getValue() + '%');
                                        gm.me().storeStockWonji.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('comment_wonji').setValue('');
                                gm.me().storeStockWonji.getProxy().setExtraParam('comment',
                                    gu.getCmp('comment_wonji').getValue());
                                gm.me().storeStockWonji.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '장',
                            id: gu.id('remark_wonji'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWonji.getProxy().setExtraParam('remark', '%'
                                            + gu.getCmp('remark_wonji').getValue() + '%');
                                        gm.me().storeStockWonji.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('remark_wonji').setValue('');
                                gm.me().storeStockWonji.getProxy().setExtraParam('remark',
                                    gu.getCmp('remark_wonji').getValue());
                                gm.me().storeStockWonji.load();
                            }
        ...
        this.stockWondanSrch = Ext.create('Ext.Action', {
            itemId: 'stockWondanSrch',
            iconCls: 'af-search',
            text: CMD_SEARCH,
            disabled: false,
            handler: function (widget, event) {

                var maker_code = gu.getCmp('maker_code_wondan').getValue();
                var item_name = gu.getCmp('item_name_wondan').getValue();
                var description = gu.getCmp('description_wondan').getValue();
                var comment = gu.getCmp('comment_wondan').getValue();
                var remark = gu.getCmp('remark_wondan').getValue();
                    ...
                    items: [
                        {
                            xtype: 'triggerfield',
                            emptyText: '제지사',
                            id: gu.id('maker_code_wondan'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWondan.getProxy().setExtraParam('maker_code', '%'
                                            + gu.getCmp('maker_code_wondan').getValue() + '%');
                                        gm.me().storeStockWondan.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('maker_code_wondan').setValue('');
                                gm.me().storeStockWondan.getProxy().setExtraParam('maker_code',
                                    gu.getCmp('maker_code_wondan').getValue());
                                gm.me().storeStockWondan.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '지종',
                            id: gu.id('item_name_wondan'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWondan.getProxy().setExtraParam('item_name', '%'
                                            + gu.getCmp('item_name_wondan').getValue() + '%');
                                        gm.me().storeStockWondan.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('item_name_wondan').setValue('');
                                gm.me().storeStockWondan.getProxy().setExtraParam('item_name',
                                    gu.getCmp('item_name_wondan').getValue());
                                gm.me().storeStockWondan.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '평량',
                            id: gu.id('description_wondan'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWondan.getProxy().setExtraParam('description', '%'
                                            + gu.getCmp('description_wondan').getValue() + '%');
                                        gm.me().storeStockWondan.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('description_wondan').setValue('');
                                gm.me().storeStockWondan.getProxy().setExtraParam('description',
                                    gu.getCmp('description_wondan').getValue());
                                gm.me().storeStockWondan.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '폭',
                            id: gu.id('comment_wondan'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWondan.getProxy().setExtraParam('comment', '%'
                                            + gu.getCmp('comment_wondan').getValue() + '%');
                                        gm.me().storeStockWondan.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('comment_wondan').setValue('');
                                gm.me().storeStockWondan.getProxy().setExtraParam('comment',
                                    gu.getCmp('comment_wondan').getValue());
                                gm.me().storeStockWondan.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '장',
                            id: gu.id('remark_wondan'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockWondan.getProxy().setExtraParam('remark', '%'
                                            + gu.getCmp('remark_wondan').getValue() + '%');
                                        gm.me().storeStockWondan.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('remark_wondan').setValue('');
                                gm.me().storeStockWonji.getProxy().setExtraParam('remark',
                                    gu.getCmp('remark_wondan').getValue());
                                gm.me().storeStockWonji.load();
                            }
        ...
        this.stockSubpartSrch = Ext.create('Ext.Action', {
            itemId: 'stockSubpartSrch',
            iconCls: 'af-search',
            text: CMD_SEARCH,
            disabled: false,
            handler: function (widget, event) {

                var maker_code = gu.getCmp('maker_code_bujajae').getValue();
                var item_name = gu.getCmp('item_name_bujajae').getValue();
                var description = gu.getCmp('description_bujajae').getValue();
                var comment = gu.getCmp('comment_bujajae').getValue();
                var remark = gu.getCmp('remark_bujajae').getValue();
                    ...
                    items: [
                        {
                            xtype: 'triggerfield',
                            emptyText: '제지사',
                            id: gu.id('maker_code_bujajae'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockSubpart.getProxy().setExtraParam('maker_code', '%'
                                            + gu.getCmp('maker_code_bujajae').getValue() + '%');
                                        gm.me().storeStockSubpart.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('maker_code_bujajae').setValue('');
                                gm.me().storeStockSubpart.getProxy().setExtraParam('maker_code',
                                    gu.getCmp('maker_code_bujajae').getValue());
                                gm.me().storeStockSubpart.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '지종',
                            id: gu.id('item_name_bujajae'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockSubpart.getProxy().setExtraParam('item_name', '%'
                                            + gu.getCmp('item_name_bujajae').getValue() + '%');
                                        gm.me().storeStockSubpart.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('item_name_bujajae').setValue('');
                                gm.me().storeStockSubpart.getProxy().setExtraParam('item_name',
                                    gu.getCmp('item_name_bujajae').getValue());
                                gm.me().storeStockSubpart.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '평량',
                            id: gu.id('description_bujajae'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockSubpart.getProxy().setExtraParam('description', '%'
                                            + gu.getCmp('description_bujajae').getValue() + '%');
                                        gm.me().storeStockSubpart.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('description_bujajae').setValue('');
                                gm.me().storeStockSubpart.getProxy().setExtraParam('description',
                                    gu.getCmp('description_bujajae').getValue());
                                gm.me().storeStockSubpart.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '폭',
                            id: gu.id('comment_bujajae'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockSubpart.getProxy().setExtraParam('comment', '%'
                                            + gu.getCmp('comment_bujajae').getValue() + '%');
                                        gm.me().storeStockSubpart.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('comment_bujajae').setValue('');
                                gm.me().storeStockSubpart.getProxy().setExtraParam('comment',
                                    gu.getCmp('comment_bujajae').getValue());
                                gm.me().storeStockSubpart.load();
                            }
                        },
                        {
                            xtype: 'triggerfield',
                            emptyText: '장',
                            id: gu.id('remark_bujajae'),
                            width: 90,
                            fieldStyle: 'background-color: #d6e8f6; background-image: none;',
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().storeStockSubpart.getProxy().setExtraParam('remark', '%'
                                            + gu.getCmp('remark_bujajae').getValue() + '%');
                                        gm.me().storeStockSubpart.load();
                                    }
                                }
                            },
                            trigger1Cls: Ext.baseCSSPrefix + 'form-clear-trigger',
                            'onTrigger1Click': function () {
                                gu.getCmp('remark_bujajae').setValue('');
                                gm.me().storeStockWonji.getProxy().setExtraParam('remark',
                                    gu.getCmp('remark_bujajae').getValue());
                                gm.me().storeStockWonji.load();
                            }
