...
//자재 관리
Ext.define('Rfx2.view.company.dabp01kr.designPlan.Stock_K_InoutView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'stock-inoutk-view',
...
// 		this.addReadonlyField('create_date');
         ...
         this.createStore('Rfx.model.InnOutMonthDayK', [{
	            property: 'item_code',
	            direction: 'ASC'
	        }],
...
//           		arr.push(multiToolbar[i]);
       ...
       this.grid = Ext.create('Rfx.base.BaseGrid', {
            ...
            //layout: 'fit',
            //forceFit: true,
            dockedItems: [buttonToolbar, searchToolbar, paging],
            viewConfig: {
          	   	markDirty:false,
                stripeRows: true,
