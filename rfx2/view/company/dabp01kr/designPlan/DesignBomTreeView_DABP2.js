...
Ext.define('Rfx2.view.company.dabp01kr.designPlan.DesignBomTreeView_DABP2', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'design-bom-tree-view-dabp',
    initComponent: function() {
    	
        this.stateCodeStore.load();
        var start_date_pj_combo;
...
//        
        ...
        // this.cloudCompleteprojectStore.getProxy().setExtraParam('start_date_isnull', 'true');
        this.cloudCompleteprojectStore.getProxy().setExtraParam('is_closed', 'Y');
        
        this.cloudCompleteprojectStore.load(function(records){
...
//                gm.me().cloudCompleteprojectStore.load(function(records) {
//                    if (records != null && records.length > 0) {
//                    	// console_logs('gm.me().cloudCompleteprojectStore.load records', records);
//                        for (var i = 0; i < records.length; i++) {
//                            var rec = records[i];
    	         ...
    	         style:'color:white;',
                    items: [
     	                ...
     	                },
                        {
                            ...
                            store: this.cloudCompleteprojectStore,
                            listConfig: {
...
//       });
    ...
    cloudCompleteprojectStore: Ext.create('Mplm.store.cloudProjectStore', {}),
    /*
    cloudCompleteprojectStore: Ext.create('Ext.data.ArrayStore', {
    	data : [
...
//),
    ...
    selectAssy: function(record) {
        ...
        var start_select_assay_time = new Date();
        console.log('>>> start_select_assay_time', start_select_assay_time);
        ...
        var end_select_assay_time = new Date();
        console.log('>>> end_select_assay_time', end_select_assay_time);

        var elapsed_tme_select_assay_time = end_select_assay_time - start_select_assay_time;
        console.log('>>> elapsed_tme_select_assay_time' , elapsed_tme_select_assay_time);
...
//    }),
        ...
        try {
            ...
            this.cloudProjectTreeStore.load({
                ...
                callback: function(records, operation, success) {
                    ...
                    var end_date_pj_combo = new Date();
                    console.log('>>> end_date_pj_combo', end_date_pj_combo);
                    var elapsed_time = end_date_pj_combo - start_date_pj_combo;
    ...
    selectProjectCombo: function(record) {
        ...
        start_date_pj_combo = new Date();
        console.log('>>> start_date_pj_combo', start_date_pj_combo);
