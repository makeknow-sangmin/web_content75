//자재 관리
Ext.define('Rfx2.view.company.dabp01kr.designPlan.MaterialMgmtView1', {
...
//				target_item_code.setValue(item_code_pre);
		...
		var not_sp_code_list = [];
		not_sp_code_list.push('M');
		not_sp_code_list.push('T');
		this.store.getProxy().setExtraParam('not_sp_code_list', not_sp_code_list);
		this.store.getProxy().setExtraParam('not_class_code', 'B');
			    ...
			    if (selections) {
	        		...
	        		Ext.Ajax.request({
	            		...
	            		success : function(result, request){
	            			...
	            			Ext.Msg.alert('안내', '주문요청 완료.', function() {});
