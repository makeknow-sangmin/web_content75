//자재 관리
Ext.define('Rfx2.view.company.dabp01kr.designPlan.MaterialMgmtView4', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'material-mgmt-view4',
    	...
    	/*this.addSearchField (
    	 ...
    	 switch(vCompanyReserved4){
    	 	case 'DABP01KR':
				...
				this.addSearchField('process_name');
	 			break;
...
//		       buttonToolbar.insert(7, this.setAllSubMatView);
      ...
      //grid를 선택했을 때 Callback
        ...
        switch(vCompanyReserved4){
        	...
        	break;
        	case 'DABP01KR':
				this.store.getProxy().setExtraParam('standard_flag', 'E');
				this.store.getProxy().setExtraParam('class_code', 'POP');
				this.store.getProxy().setExtraParam('POP', 'POP');
       		break;
