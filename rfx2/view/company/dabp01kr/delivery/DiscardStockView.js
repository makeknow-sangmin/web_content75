//출하 관리
Ext.define('Rfx2.view.company.dabp01kr.delivery.DiscardStockView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'discard-stock-view',
    is_loaded: false,
    initComponent: function(){
        ...
        if(vSYSTEM_TYPE_SUB == 'HEAVY4'){
            ...
            this.createStoreSimple({
                modelClass: 'Rfx.model.DiscardStock',
            ...
            //모델 정의
            this.createStore('Rfx.model.DiscardStock', [{
        ...
        if(vCompanyReserved4=='KYNL01KR') {
            ...
            var tab = this.createTabGrid('Rfx.model.DiscardStock', items, 'big_pcs_code', arr, function(curTab, prevtab) {
