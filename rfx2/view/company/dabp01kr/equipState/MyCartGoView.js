...
//자재 관리
Ext.define('Rfx2.view.company.dabp01kr.equipState.MyCartGoView', {
...
//    					gm.me().store.getProxy().setExtraParam('stock_qty', gMain.selPanel.vSELECTED_AFTER_QTY);
        ...
        updateDesinComment: function(rec) {
            ...
            var stock_qty_value = rec.get('stock_qty');
           
            if(reserved1 == 'Y'){
            	stock_qty = stock_qty_value + old_value;
            }else{
