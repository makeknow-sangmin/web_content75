...
Ext.define('Rfx2.view.company.dabp01kr.accountMgmt.WorkUpload', {
...
//
        ...
        this.gridMycart = Ext.create('Ext.grid.Panel', {
             ...
             stateId: 'gridMycart' +  vCUR_MENU_CODE,
        ...
        this.gridMycart2 = Ext.create('Ext.grid.Panel', {
            title: 'My Cart',
            store: this.myCartStore,
            // /COOKIE//stateful: true,
            //collapsible: true,
        ...
        this.testContainer = new Ext.container.Container({
            title: 'Testo',
            region: 'center',
            layout: {
                type: 'hbox',
            ...
            items: [this.gridMycart, this.grid]
        });
        ...
        this.center = Ext.widget('tabpanel', {
            ...
            width: '70%',
            tabPosition: 'top',
            items: [this.testContainer, this.gridMycart2]
        });
