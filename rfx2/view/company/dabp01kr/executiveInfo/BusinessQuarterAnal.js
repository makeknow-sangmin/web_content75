 ...
 */
Ext.define('Rfx2.view.company.dabp01kr.executiveInfo.BusinessQuarterAnal', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'businessQuarter-plan-view',
...
//		this.setDefValue('board_count', 0); //Hidden Value임.
		...
		this.addSearchField('qm_flag');

        this.createStore('Rfx.model.BusinessQuarterAnal', [{
            property: 'mng_code',
            direction: 'DESC'
        }],
        ...
        this.printPDFAction = Ext.create('Ext.Action',{
            ...
            handler: function(widget, event) {
            	...
            	var qm_code = gm.me().vSelected_qmCode;
            	Ext.Ajax.request({
        ...
        this.setGridOnCallback(function(selections) {
            ...
            if (selections.length) {
                ...
                gm.me().vSelected_qmCode = rec.get('qm_flag');
