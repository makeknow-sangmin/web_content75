 ...
 */
Ext.define('Rfx2.view.company.mke.operationRatio.OpCuAnOperation', {
    extend: 'Rfx2.base.BaseView',
       xtype: 'op-cuan-operation',
   initComponent: function() {

       var component = new Ext.Component({
           id: 'OpCuAnOperation-component',
           autoEl: {
               tag: 'iframe',
               style: 'height: 100%; width: 100%; border: none',
               src: 'http://211.240.57.17/cuanoperation.asp'
           },
           height: 600,
           width: 600
       });
