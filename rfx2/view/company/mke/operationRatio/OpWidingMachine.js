 ...
 */
Ext.define('Rfx2.view.company.mke.operationRatio.OpWidingMachine', {
	 extend: 'Rfx2.base.BaseView',
	    xtype: 'op-widing-machine',
    initComponent: function() {

        var component = new Ext.Component({
            id: 'OpWidingMachine-component',
            autoEl: {
                tag: 'iframe',
                style: 'height: 100%; width: 100%; border: none',
                src: 'http://211.240.57.17/operation1.asp'
            },
            height: 600,
            width: 600
        });
