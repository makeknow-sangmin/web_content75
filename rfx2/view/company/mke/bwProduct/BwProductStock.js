 ...
 */
Ext.define('Rfx2.view.company.mke.bwProduct.BwProductStock', {
    extend: 'Rfx2.base.BaseView',
       xtype: 'bw-product-stock',
   initComponent: function() {

       var component = new Ext.Component({
           id: 'BwProductStock-component',
           autoEl: {
               tag: 'iframe',
               style: 'height: 100%; width: 100%; border: none',
               src: 'http://211.240.57.17//bwproduct/productStock.asp'
           },
           height: 600,
           width: 600
       });
