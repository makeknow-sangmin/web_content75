Ext.define('Rfx2.view.company.hanjung.designPlan.DesignBomASTreeView', {
    ...
    initComponent: function () {
        ...
        this.setGridOnCallback(function (selections) {
            if (selections.length) {
                rec = selections[0];
                console_logs('request_comment', rec);
    ...
    createCenter: function () {
        ...
        this.bomAll =
            Ext.create('Rfx2.view.company.hanjung.grid.BomGridHeavyAssy', {
        ...
        this.assyGrid = Ext.create('Ext.tree.Panel', {
            ...
            },*/
            {
                ...
                items: [
                    {
                        ...
                        listeners: {
                            change: function (fieldObj, e) {
                                gu.getCmp('productcombo-DBM7_TREE').store.getProxy().setExtraParam('item_code', '%' + e + '%');
                            },
                            render: function (c) {
                    ...
                    },
                    {
                        ...
                        listeners: {
                            change: function (fieldObj, e) {
                                gu.getCmp('productcombo-DBM7_TREE').store.getProxy().setExtraParam('item_name', '%' + e + '%');
                            },
                            render: function (c) {
                                Ext.create('Ext.tip.ToolTip', {
                                    target: c.getEl(),
                    ...
                    },
                    {
                        ...
                        listeners: {
                            change: function (fieldObj, e) {
                                gu.getCmp('productcombo-DBM7_TREE').store.getProxy().setExtraParam('specification', '%' + e + '%');
                            },
                            render: function (c) {
                                Ext.create('Ext.tip.ToolTip', {
                                    target: c.getEl(),
                ...
                items: [
                {
                    ...
                    store: Ext.create('Rfx2.store.company.hanjung.ProductStore', {}),
                        ...
                        items: [{
                            ...
                            listeners: {
                                select: function (combo, record) {
                                    ...
                                    var claastlevel2 = Ext.getCmp('DBM7_AST-PRDLV2-ADD');
                                    var claastlevel3 = Ext.getCmp('DBM7_AST-PRDLV3-ADD');
                                    var claastlevel4 = Ext.getCmp('DBM7_AST-PRDLV4-ADD');
                                    ...
                                    var productcombo = Ext.getCmp('DBM7_AST_srcahd_uid');
                    ...
                    inputItem.push({
                        ...
                        listeners: {
                            keydown: function (t, e) {
                                if (e.keyCode == 13) {
                                    var srcahd = Ext.getCmp('DBM7_AST_srcahd_uid');
                            ...
                            select: function (combo, record) {
                                var item_code = Ext.getCmp('DBM7_AST_item_code');
                                var item_code2 = record.get('item_code');
                                item_code.setValue(item_code2);

                                var item_name = Ext.getCmp('DBM7_AST_assy_name');
                                ...
                                if (gm.me().assyTopParent != null && gm.me().assyTopParent == srcahd_uid) {
                                    Ext.MessageBox.alert('Error', '동일한 Assembly를 선택할 수 없습니다.', function callBack(id) {
                                        ...
                                        Ext.getCmp('DBM7_AST_srcahd_uid').setValue(null);
                                    });
                                }
                            }
                        },
    ...
    selectProjectCombo: function (record) {
        ...
        gu.getCmp('target-projectcode-DBM7_AST').update(pj_code);
    ...
    selectAssymapCombo: function (record) {
        ...
        var targetPjCode = '<div>' + item_code + '&nbsp&nbsp&nbsp<font color=yellow>' + item_name + ' / ' + specification + '</font></div>';
            ...
            this.store.load(function (records) {
                ...
                if (pl_no == '---') {
                    ...
                    BomGrid.store.load(function (records) {
                        ...
                        gu.getCmp('target_totalPrice').setHtml('<font size=10><font color=yellow>총 금액 : ' + gu.renderNumber(total_sales_price) + ' 원</font> ');
                    });
    ...
    reSelect: function () {
        this.srchTreeHandler(this.assyGrid, this.cloudProjectTreeStore, 'productcombo-DBM7_AST', 'child', true);
                                            ...
                                            specialkey: function (f, e) {
                                                if (e.getKey() == e.ENTER) {
                                                    ...
                                                    if(gu.getCmp('search_item_code_part').getValue() != '') {
                                                        ...
                                                        gm.me().searchStore.getProxy().setExtraParam('not_standard_flag', 'A');
                                                        gm.me().searchStore.load();
                                                    } 
                                                }
                                            }
        ...
        handler: function (widget, event) {
            ...
            Ext.Ajax.request({
                ...
                success: function (result, request) {
                    ...
                    var lineGap = 30;
                    var bHeight = 300;
                    productcombo2 = Ext.create('Rfx2.store.company.kbtech.ProductStore', {});
                    var inputItem = [];
                    inputItem.push({
                        xtype: 'textfield',
                        name: 'child',
                    ...
                    inputItem.push({
                        ...
                        items: [{
                            ...
                            displayField: 'class_name',
                            valueField: 'class_code',
                            store: Ext.create('Mplm.store.ClaastStore', {
                                level1: 1,
                            ...
                            listeners: {
                                select: function (combo, record) {
                                    console_log('Selected Value : ' + combo.getValue());
                                    console_logs('record : ', record);
                                    gm.me().class_type = combo.getValue();
                                    gm.me().claastLoad2();
                                }
                            }
                        }, {
                    ...
                    inputItem.push({
                        ...
                        fieldStyle: 'background-color: #FBF8E6; background-image: none;',
                        //                            value: gm.me().selectedPjCode,
                        store: Ext.create('Rfx2.store.ProductStore', {}),
                        anchor: '-5',
                        queryMode: 'remote',
                        listConfig: {
                            getInnerTpl: function () {
                        ...
                        listeners: {
                            keydown: function (t, e) {
                                if (e.keyCode > 1) {
                                    ...
                                    //         	  		      			productcombo2.load();
                                    console_logs('keydown', srcahd.getValue());
                                    srcahd.store.getProxy().setExtraParam('item_code', srcahd.getValue());
                                    srcahd.store.load();
                                }
                            },
                            select: function (combo, record) {
    ...
    selectRec: function (record) {
        ...
        maker_name = Ext.getCmp(gu.id('maker_name'));
        maker_name.setValue(record.get('maker_name'));
    ...
    claastLoad: function () {
        ...
        // var claastlevel1 = Ext.getCmp('DBM7_TREE-PRDLV1').getValue();
        //var claastlevel2 = Ext.getCmp('DBM7_TREE-PRDLV2').getValue();
        //var claastlevel3 = Ext.getCmp('DBM7_TREE-PRDLV3').getValue();
        //var claastlevel4 = Ext.getCmp('DBM7_TREE-PRDLV4').getValue();

        for (var i = 0; i < 40; i++) {
            productcombo.store.getProxy().setExtraParam('srcadt_varchar' + (i + 1), null);
        }
                ...
                items: [
                    {
                        ...
                        displayField: 'item_name',
                        valueField: 'unique_id',
                        store: Ext.create('Rfx2.store.company.hanjung.ChangeAssyStore', {}),
                        sortInfo: { field: 'specification', direction: 'ASC' },
                        minChars: 1,
                        typeAhead: false,
                        hideLabel: false,
                        ...
                        listeners: {
                            beforequery: function (queryEvent) {
                                gu.getCmp('changeAssy').store.getProxy().setExtraParam('item_code',
                                    '%' + gu.getCmp('changeAssy').getValue() + '%');
                            },
                            select: function (combo, record) {
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        for (var i = 0; i < selections.length; i++) {
                            productMtrlArr.push(selections[i].id);
                        }
                        prWin.setLoading(true);
                        form.submit({
                            url: CONTEXT_PATH + '/sales/productStock.do?method=changeProductAssembly',
                            params: {
