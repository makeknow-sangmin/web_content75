Ext.define('Rfx2.view.company.hanjung.stockMgmt.GoodsOutHistoryView', {
    ...
    initComponent: function () {
        ...
        console_logs('this.fields', this.figelds);


        this.createStoreSimple({
            modelClass: 'Rfx.model.GoodsOutHistoryHanjung',
            sorters: [{
                property: 'pr_no',
                direction: 'asc'
            }],
            ...
            groupField: 'project_varcharh_Other'
        });
        ...
        var option = {
            features: {
                ...
                groupHeaderTpl: '<div> <b>{name}</b><font color=#003471><b> - {[values.rows[0].data.pj_name]}</b></font> ({rows.length})</div>'
            }
        };
        ...
        this.store.grouper.initConfig.property = 'pr_no';
...
//		params['reserved_double5'] = gm.me().reserved_double5;
        /*
        ...
        Ext.Ajax.request({
            ...
            success: function (result, request) {
                ...
                if (result != null) {
                    ...
                    /*
                     if(field_name == "주문수량"){
                     gm.me().vSELECTED_QUAN = value;
                     console_logs('gm.me().vSELECTED_QUAN', gm.me().vSELECTED_QUAN);
                     }
                     if(field_name == "단가"){
                     gm.me().vSELECTED_PRICE = value;
                     console_logs('gm.me().vSELECTED_PRICE', gm.me().vSELECTED_PRICE);
                     }
                     console_logs('gm.me().vSELECTED_QUAN>후', gm.me().vSELECTED_QUAN);
                     console_logs('gm.me().vSELECTED_PRICE>후', gm.me().vSELECTED_PRICE);
