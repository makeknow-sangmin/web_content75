 ...
 *
 */
Ext.define('Rfx2.view.company.hanjung.purStock.HEAVY4_CreatePoView', {
    ...
    initComponent: function () {
        ...
        this.createStoreSimple({
            modelClass: 'Rfx2.model.company.hanjung.CreatePo',
            pageSize: 500,
            sorters: [{
        ...
        this.createPoAllAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
            handler: function () {
                var nonOrderForm = Ext.create('Ext.form.Panel', {
                    id: 'nonOrderForm',
                ...
                var win = Ext.create('ModalWindow', {
                    ...
                    buttons: [{
                        ...
                        handler: function () {
                            ...
                            var form = Ext.getCmp('nonOrderForm').getForm();
                            if (form.isValid()) {
                                var val = form.getValues(false);
                                var selections = gm.me().gridPoList.getSelectionModel().getSelection();
                                var reserved_varchar1 = val['reserved_varchar1'];
                                var keys = [];
                                loadPage.show();
                                ...
                                for (var i = 0; i < selections.length; i++) {
                                    ...
                                    if (selections[i].get('coord_key1') > 1) {
                                        contract_uid = selections[i].get('coord_key1');
                                    } else {
                                        contract_uid = selections[i].get('contract_uid');
                                    }
                                ...
                                console_logs('key >>>>>', keys);
                                console_logs('selections >>>>>', selections);

                                gm.me().treatPoAll(0, keys, selections, reserved_varchar1);
                                win.close();
        ...
        this.gridCartList = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                { text: '유형', width: 50, style: 'text-align:center', align: 'left', dataIndex: 'pur_type' },
                // {text: 'LOT NO', dataIndex: 'project_varchar6'},
                { text: '품번', align: 'left', style: 'text-align:center', dataIndex: 'item_code' },
                { text: '품명', width: 120, align: 'left', style: 'text-align:center', dataIndex: 'item_name' },
                ...
                { text: '제조사', align: 'left', style: 'text-align:center', dataIndex: 'maker_name' },
                { text: '공급사', align: 'left', style: 'text-align:center', dataIndex: 'contract_supplier' },
                { text: '요청수량', xtype: "numbercolumn", style: 'text-align:center', format: "0,000", width: 80, dataIndex: 'pr_quan', align: "right" },
                { text: '주문수량', xtype: "numbercolumn", style: 'text-align:center', format: "0,000", align: 'center', dataIndex: 'pr_quan', align: "right" },
                { text: '주문단가', xtype: "numbercolumn", style: 'text-align:center', format: "0,000", align: 'center', dataIndex: 'sales_price', align: "right" },
                { text: '주문금액', xtype: "numbercolumn", style: 'text-align:center', format: "0,000", align: 'center', dataIndex: 'total_price', align: "right" },
                {
                    text: '납기일', align: 'left', style: 'text-align:center', type: 'date', dataIndex: 'req_date', dateFormat: 'Y-m-d',
                ...
                { text: '총재고', width: 80, align: 'center', style: 'text-align:center', dataIndex: 'stock_qty', align: "right" },
                { text: '가용재고', width: 80, align: 'center', style: 'text-align:center', dataIndex: 'stock_qty_useful', align: "right" },
                // {text: '요청자', dataIndex: 'creator'},
        ...
        Ext.each(this.gridCartList.columns, function (columnObj, index) {
            ...
            switch (dataIndex) {
                ...
                case 'contract_supplier':
                    columnObj["renderer"] = function (val, meta, record, rowIndex) {
                        if (record.get('coord_key1') > 1) {
                            return record.get('supplier_name');
                        } else {
                            return record.get('contract_supplier');
                        }
                    }
                    break;
                default:
        ...
        this.gridPoList = Ext.create('Ext.grid.Panel', {
                    ...
                    items: [
                        {
                            ...
                            handler: function (box, value) {
                                gm.me().poCartListStore.getProxy().setExtraParam('excludeCompletePo', value);
            ...
            columns: [
                { text: '유형', width: 50, style: 'text-align:center', align: 'left', dataIndex: 'pur_type' },
                { text: '품번', style: 'text-align:center', dataIndex: 'item_code' },
                { text: '품명', style: 'text-align:center', dataIndex: 'item_name' },
                { text: '규격', style: 'text-align:center', dataIndex: 'specification' },
                { text: '제조사', style: 'text-align:center', dataIndex: 'maker_name' },
                {
                    text: '공급사', style: 'text-align:center', dataIndex: 'contract_supplier', width: 250,
                    editor: {
                        xtype: 'combo',
                        ...
                        listeners: {
                            ...
                            select: function (combo, record) {
                                gm.me().gridPoList.getStore().getAt(gm.me().poCartListStore.indexOf(
                                    gm.me().gridPoList.getSelectionModel().getSelection()[0]
                                )).set({
                                    'contract_uid': combo.getValue()
                                });
                            }
                        }
                    }
                },
                { text: '요청수량', style: 'text-align:center', dataIndex: 'pr_quan', align: 'right' },
                { text: '총재고', style: 'text-align:center', dataIndex: 'stock_qty', align: 'right' },
                { text: '가용재고', style: 'text-align:center', dataIndex: 'stock_qty_useful', align: 'right' },
                { text: '주문수량', style: 'text-align:center', dataIndex: 'quan', editor: 'numberfield', align: 'right' },
                { text: '주문단가', style: 'text-align:center', dataIndex: 'sales_price', editor: 'numberfield', format: "0,000", align: 'right' },
                { text: '주문금액', style: 'text-align:center', xtype: "numbercolumn", format: "0,000", align: 'center', dataIndex: 'total_price', align: "right" },
                {
                    text: '납기일', style: 'text-align:center', dataIndex: 'req_date', dateFormat: 'Y-m-d',
                    editor: {
                        xtype: 'datefield',
                        submitFormat: 'Y-m-d',
                        dateFormat: 'Y-m-d',
                ...
                { text: '등록자', style: 'text-align:center', dataIndex: 'creator' },
            ...
            listeners: {
                ...
                edit: function (editor, e, eOpts) {
                    ...
                    gm.me().poCartListStore.getProxy().setExtraParam('req_flag', 'N');
        ...
        this.gridGoList = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                { text: '유형', width: 50, align: 'center', style: 'text-align:center', dataIndex: 'pur_type' },
                // {text: 'LOT NO', dataIndex: 'project_varchar6'},
                { text: '품번', style: 'text-align:center', dataIndex: 'item_code' },
                { text: '품명', style: 'text-align:center', dataIndex: 'item_name' },
                { text: '규격', style: 'text-align:center', dataIndex: 'specification' },
                { text: '공급사', style: 'text-align:center', dataIndex: 'maker_name' },
                //{text: '소요량', dataIndex: 'column_001'},
                { text: '요청수량', style: 'text-align:center', dataIndex: 'pr_quan', align: 'right' },
                { text: '총재고', style: 'text-align:center', dataIndex: 'stock_qty', align: 'right' },
                { text: '가용재고', style: 'text-align:center', dataIndex: 'stock_qty_useful', editor: 'numberfield', align: 'right' },
                { text: '불출수량', style: 'text-align:center', dataIndex: 'reserved_double1', editor: 'numberfield', align: 'right' },
                { text: '주문단가', style: 'text-align:center', dataIndex: 'static_sales_price', editor: 'numberfield', align: 'right' },
                { text: '주문금액', style: 'text-align:center', dataIndex: 'total_price', align: 'right' },
                {
                    text: '납기일', type: 'date', style: 'text-align:center', dataIndex: 'req_date', dateFormat: 'Y-m-d',
                    editor: {
                        xtype: 'datefield',
                        submitFormat: 'Y-m-d',
                        dateFormat: 'Y-m-d',
    ...
    addPartAction: Ext.create('Ext.Action', {
        ...
        handler: function (widget, event) {
            ...
            gm.me().selectedPjUid = item.get('pj_uid');
    ...
    treatPoAll: function (pos, keys, sel, reserved_varchar1) {
        ...
        Ext.Ajax.request({
            ...
            success: function (result, request) {
                ...
                for (var i = 0; i < sel.length; i++) {
                    if (sel[i].get('coord_key1') > 0) {
                        if (sel[i].get('coord_key1') == con_uid) {
                ...
                if (uniqueId == undefined || uniqueId < 0) {
                    ...
                    Ext.Ajax.request({
                        ...
                        params: {
                            ...
                            coord_key1: selections[0].get('contract_uid') == -1 ? selections[0].get('coord_key1') : selections[0].get('contract_uid'),
                            po_no: po_no,
                            ...
                            maker_name: selections[0].get('maker_name')
                        },
                        success: function (val, action) {
                            if (keys.length - 1 > pos) {
                                ...
                                Ext.MessageBox.alert('알림', '주문작성이 완료되었습니다.');
                                gm.me().poCartListStore.load();
                            }
                        },
                        failure: function (val, action) {
