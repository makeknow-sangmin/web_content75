...
//자재 관리
Ext.define('Rfx2.view.company.hanjung.purStock.HEAVY5_MyCart', {
            ...
            handler: function () {
                ...
                if (isExistAssy && !isExistOthers && selections.length > 1) {
                    ...
                    if (selections.length) {
                        ...
                        var requestText = '구매요청 하시겠습니까?';

                        if(rec.get('sg_code') == 'AASSY') {
                            requestText = '하위 ASSY가 존재하지 않을 경우에만 구매요청이 가능합니다. 구매요청 하시겠습니까?'
                        }
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        if (pr_quans > 0) {
                                            ...
                                            if(rec.get('sg_code') == 'AASSY') {
                                                Ext.Ajax.request({
                                                    url: CONTEXT_PATH + '/purchase/request.do?method=createBuyingRequestAssy',
                                                    params: {
