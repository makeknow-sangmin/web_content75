Ext.define('Rfx2.view.company.hanjung.purStock.HEAVY4_WearingWaitView', {
                    ...
                    o['summaryRenderer'] = function(value, summaryData, dataIndex) {
                        if(gm.me().store.data.items.length > 0) {
                            ...
                            if(summary.length > 0) {
                                ...
                                return Ext.util.Format.number(objSummary[dataIndex], '0,000/i');
                            } else {
                                return 0;
                            }
                        } else {
            ...
            selectionchange: function (sm, selections) {
                ...
                if (selections == null || selections.length < 1) {
                    if (vCompanyReserved4 == 'KWLM01KR') {
                        ...
                        buttonToolbar3.items.items[1].update('총 금액 : ' + gUtil.renderNumber(total_price_sum) + ' / 총 수량 : ' + total_qty);
                    }
    ...
    prwinopen: function (form) {
        prWin = Ext.create('Ext.Window', {
            ...
            title: '입고 확인',
            width: 400,
            height: (vCompanyReserved4 == 'KWLM01KR') ? 220 : 180,
            plain: true,
            items: form,
            buttons: [{
                text: CMD_OK,
