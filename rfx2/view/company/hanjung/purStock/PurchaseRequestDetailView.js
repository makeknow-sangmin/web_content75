...
//구매요청
Ext.define('Rfx2.view.company.hanjung.purStock.PurchaseRequestDetailView', {
    ...
    initComponent: function(){
        ...
        this.createStore('Rfx.model.PurchaseRequestDetailHj', [{
...
//            	gMain.selPanel.reReceiveAction.disable();
            ...
            this.cartLineGrid.getStore().getProxy().setExtraParam('use_tr_uid', 'Y');
