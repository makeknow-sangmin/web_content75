Ext.define('Rfx2.view.company.hanjung.groupWare.IssuePurBillMgmtView', {
    ...
    storeCubeDim: Ext.create('Rfx2.store.company.hanjung.WthOutTypeStore', {}),
    storeViewProp: Ext.create('Rfx2.store.company.hanjung.PurBillIssueListStore', {}),
