Ext.define('Rfx2.view.company.scon.groupWare.AccountReceiveVerView', {
    ...
    initComponent: function () {
        ...
        this.purListSrch = Ext.create('Ext.Action', {
			...
			handler: function (widget, event) {
                var reserved_varchard = gu.getCmp('reserved_varchard_two').getValue();
                var pj_name = gu.getCmp('pj_name_two').getValue();
                var year = gu.getCmp('year').getValue();
                gm.me().curingState.getProxy().setExtraParam('route_code', 'NO');
            ...
            dockedItems: [
				{
					...
					items: [
                        ...
                        },
						{
                            ...
                            id: gu.id('reserved_varchard_two'),
                            ...
                            listeners: {
                                ...
                                specialkey : function(field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        ...
                                        gm.me().curingState.getProxy().setExtraParam('route_code', 'NO');
                                        gm.me().curingState.getProxy().setExtraParam('reserved_varchard', gu.getCmp('reserved_varchard_two').getValue());
                                        gm.me().curingState.load();
                        ...
                        },
                        {
                            ...
                            listeners: {
                                ...
                                specialkey : function(field, e) {
                                    if (e.getKey() == Ext.EventObject.ENTER) {
                                        gm.me().curingState.getProxy().setExtraParam('route_code', 'NO');
                                        gm.me().curingState.getProxy().setExtraParam('pj_name', gu.getCmp('pj_name_two').getValue());
                                        gm.me().curingState.load();
                                        // gm.me().cloudProjectTreeStore.getProxy().setExtraParam('pl_no1', gu.getCmp('pl_no1').getValue());
                                        // gm.me().cloudProjectTreeStore.load(function() {});
                                    }
                ...
                var formItems = [
					...
					},
                    {
						...
						listConfig: {
							...
							emptyText: '일치하는 항목 없음',
							getInnerTpl: function () {
								return '<div data-qtip="{pj_uid}">{pj_name} / 납품요구일자: {delivery_plan}</div>';
							}
						},
						listeners: {
							afterrender: function (combo) {
        ...
        // this.store.getProxy().setExtraParam('route_code', 'NO');
        this.storeLoad();
