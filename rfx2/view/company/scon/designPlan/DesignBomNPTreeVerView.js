Ext.define('Rfx2.view.company.scon.designPlan.DesignBomNPTreeVerView', {
    ...
    createWest: function () {
        ...
        this.cloudAssemblyTreeStore = Ext.create('Mplm.store.cloudAssemblyTreeStore', {/*autoLoad:false*/});
        ...
        this.assyGrid = Ext.create('Ext.tree.Panel', {
            ...
            dockedItems: [{
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                ...
                                expand: function (field) {
                                    // gu.getCmp('prod uctcombo-DBM7_TREE').store.getProxy().setExtraParam('sp_code_list', 'G,F,H,A');
                                ...
                                select: function (combo, record) {
                                    ...
                                    // console.log('상민', record.get('unique_id_long'));
                                    // console.log('상민', record.get('unique_id'));
                                    // gu.getCmp('pcsLotCombo-DBM7_TREE').store.getProxy().setExtraParam('srcahd_uid', record.get('unique_id_long'));
                                    gm.me().cloudAssemblyTreeStore.getProxy().setExtraParam('child', combo.getValue());
                                    gm.me().cloudAssemblyTreeStore.getProxy().setExtraParam('ac_uid', combo.getValue());
                ...
                //     items: [
                //         {
                //             id: gu.id('pcsLotCombo-DBM7_TREE'),
                //             xtype: 'combo',
                //             fieldStyle: 'background-color: #FBF8E6; background-image: none;',
                //             mode: 'local',
                //             editable: true,
                //             width: '100.5%',
                //             queryMode: 'remote',
                //             emptyText: 'LOT NO를 입력하세요.',
                //             displayField: 'pcs_desc',
                //             valueField: 'pcs_desc',
                //             // store: Ext.create('Rfx2.store.company.bioprotech.PcsAstStore', {}),
                //             store: Ext.create('Mplm.store.PcsAstStore', {}),
                ...
                //                 // Custom rendering template for each item
                //                 getInnerTpl: function () {
                //                     return '<div data-qtip="{pcs_desc}">[{pcs_desc}] <small><font color=blue>{create_date}</font></small></div>';
                //                 }
                //             },
                //             pageSize: 25,
                //             triggerAction: 'all',
                //             listeners: {
                //                 keyup: function () {
                //                     var value = gu.getCmp('pcsLotCombo-DBM7_TREE').getValue();
                //                     gm.me().claastReset(0);
                //                 },
                //                 expand: function (field) {
                //                     // gu.getCmp('pcsLotCombo-DBM7_TREE').store.getProxy().setExtraParam('sp_code_list', 'G,F,H,A');
                //                     gu.getCmp('pcsLotCombo-DBM7_TREE').getStore().load();
                //                 },
                //                 select: function (combo, record) {
                //                     // gm.me().assyTopParent = combo.getValue();
                //                     // var srcahd_uid = record.get('unique_id');
                ...
                //                     // gm.me().selectAssymapCombo(record);
                //                     gm.me().srchTreeHandler(gm.me().assyGrid, gm.me().cloudAssemblyTreeStore,
                //                 'pcsLotCombo-DBM7_TREE', 'pcs_desc', true);
                //                     // console.log('상민', combo.getValue());
                //                 },
                //                 pageSize: 10
                //             }
                //         }
