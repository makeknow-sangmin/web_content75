Ext.define('Rfx2.view.company.scon.purStock.DetailPoView', {
    ...
    initComponent            : function () {
        ...
        this.createStoreSimple({
            modelClass : 'Rfx2.model.OrderRequest',
        ...
        this.orderDetailStore = Ext.create('Rfx2.store.company.chmr.ListPoStore', {});
        ...
        this.printPDFPoAction = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                var po_no = select.get('po_no');

                var route_type = 'OR';

                var supplier_code = select.get('supplier_code');
        ...
        this.grid.getSelectionModel().on({
            selectionchange: function (sm, selections) {
                if (selections != null && selections.length > 0) {
                    var rec = selections[0];
                    console_logs('>>>> aaaa', rec);
                    gm.me().attachFileAction.enable();
                    gm.me().readHistoryAction.enable();
                    gm.me().printPDFPoAction.enable();
                    gm.me().orderDetailStore.getProxy().setExtraParam('po_no', rec.get('po_no'));
                    gm.me().orderDetailStore.load();
                } else {
