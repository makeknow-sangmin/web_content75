//생산완료 현황
Ext.define('Rfx2.view.company.scon.stockMgmt.StockMgmtDetailView', {
    ...
    initComponent: function () {
                ...
                if (selections.length > 0) {
                    ...
                    var form = Ext.create('Ext.form.Panel', {
                        ...
                        items: [
                            ...
                            {
                                fieldLabel: gm.me().getColName('uid_srcahd'),
                                xtype: 'textfield',
                                id: gu.id('uid_srcahd'),
                                name: 'uid_srcahd',
                                emptyText: '자재 UID',
        ...
        this.createStore('Rfx2.model.company.chmr.NstoCkMgmt', [{
            property: 'unique_id',
            direction: 'DESC'
        }], gm.pageSize
            , {},
        ...
        buttonToolbar.insert(2, this.releaseAction);
        buttonToolbar.insert(3, this.forcePrevStockAction);
        ...
        this.setGridOnCallback(function (selections) {
            if (selections.length) {
                ...
                gm.me().forcePrevStockAction.enable();
                ...
                gm.me().forcePrevStockAction.disable();
            }
        })
