// 검사항목관리
Ext.define('Rfx2.view.company.scon.qualityMgmt.ProcessView', {
    ...
    initComponent   : function () {
        ...
        this.defectCodeStore = Ext.create('Rfx2.store.company.bioprotech.DefectCodeStore', {parentCode: 'PROCESS_ERROR'});
