Ext.define('Rfx2.view.company.ynju.produceMgmt.ProduceMgmtAssyDetailView', {
...
1
        ...
        this.createStore('Rfx2.model.company.ynju.ProductMgmtAssy', [{
            property: 'unique_id',
            direction: 'DESC'
        }],
            gMain.pageSize
        ...
        this.setRowClass(function (record, index) {
            var c = record.get('shortage_qty');
            console_logs('ccccc', c);
            if(c > 0) {
                return 'red-row';
            }
        });
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        //         emptyText: 'No matching posts found.',
                        //         getInnerTpl: function () {
                        //             return '<div data-qtip="{mold_name}">{item_code} </div>';
                        //         }
                        //     },
                        // },
