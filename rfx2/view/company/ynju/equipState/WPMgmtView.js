Ext.define('Rfx2.view.company.ynju.equipState.WPMgmtView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.ynju.Mold', [{
            property: 'unique_id',
            direction: 'DESC'
        }],
            gm.pageSize
        ...
        this.poPrdDetailStore = Ext.create('Rfx2.store.company.ynju.ProductStoreByMold', {});
