...
Ext.define('Rfx2.view.company.daeji.orderMgmt.RecvPoDetailView', {
    ...
    initComponent: function () {
        ...
        var flag_division = this.flag4 === 'N';
        var not_use_delivery_date = (vCompanyReserved4 === 'DMEC01KR' || vCompanyReserved4 === 'SSCC01KR');
        var useWeightExtraProduct = vCompanyReserved4 !== 'SSCC01KR';
        ...
        Ext.each(this.gridContractCompany.columns, function (columnObj) {
