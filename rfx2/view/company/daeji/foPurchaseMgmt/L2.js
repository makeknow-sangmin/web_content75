/*
    Rfx2.view.gongbang.produceMgmt.ProduceMgmtTabVerView
*/
Ext.define('Rfx2.view.company.daeji.foPurchaseMgmt.L2', {
    ...
    addExtraColumnBypcscode: function (myColumn, myField, big_pcs_code, temp_code, step_field, editable, pos) {
        ...
        if (smallPcs === undefined || smallPcs.length === 0 
            || myColumn === undefined || myColumn.length === 0 
            || myField === undefined || myField.length === 0) {
            return;
        }
        //복사대상
