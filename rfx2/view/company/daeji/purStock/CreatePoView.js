//주문작성
Ext.define('Rfx2.view.company.daeji.purStock.CreatePoView', {
...
//	            	        	   Ext.getCmp('maker_code').setValue(reccode);
    ...
    updateDesinComment: function (rec) {
        ...
        var cartmap_reserved1 = rec.get('cartmap_reserved1');
        var cartmap_reserved2 = rec.get('cartmap_reserved2');
        ...
        for (var i = 0; i < store.getCount(); i++) {
            ...
            var reserved_timestamp3 = rec.get('reserved_timestamp3');
            var objv = {};

            objv['unique_uid'] = unique_uid;
            objv['reserved_timestamp1'] = reserved_timestamp1;
            objv['reserved_timestamp3'] = reserved_timestamp3;
        ...
        Ext.Ajax.request({
            ...
            params: {
                ...
                reserved_timestamp3: reserved_timestamp3,
                cartmap_reserved1: cartmap_reserved1,
                cartmap_reserved2 : cartmap_reserved2
            },
            success: function (result, request) {
                ...
                gm.me().store.load(function (records) {
                    for (var i = 0; i < records.length; i++) {
                        ...
                        for (var j = 0; j < objs.length; j++) {
                            ...
                            if (rec.get('unique_uid') === recSub['unique_uid']) {

                                rec.set('reserved_timestamp1', recSub['reserved_timestamp1']);
                                rec.set('reserved_timestamp3', recSub['reserved_timestamp3']);
                            }
                        }
                    }
                });
                        ...
                        fn: function (btn) {
                            ...
                            if (btn == "no") {
                                ...
                                for (var i = 0; i < selections.length; i++) {
                                    ...
                                    var request_info = rec.get('request_info');
                                    var quan = rec.get('quan');
                                    var incoming1 = rec.get('cartmap_reserved1');
                                    var incoming2 = rec.get('cartmap_reserved2');
                                    quanArr.push(quan);
                                    cartmapArr.push(uid);
                                    srcahdArr.push(srcahd_uid);
                                    curArr.push(currency);
                                    ...
                                    nameArr.push(item_name);
                                    coordArr.push(coord_key3);
                                    incoming1s.push(incoming1);
                                    incoming2s.push(incoming2);
                                }
                                var pj_name = rec.get('pj_name');
                                var static_sales_price = rec.get('static_sales_price'); //cartmap.sales_price
                                ...
                                if (form.isValid()) {
                                    ...
                                    form.submit({
                                        ...
                                        params: {
                                            ...
                                            pj_name: pj_name,
                                            mp_status: 'GR',
                                            incoming1s : incoming1s,
                                            incoming2s : incoming2s
...
/*
//주문작성
Ext.define('Rfx2.view.company.sejun.purStock.HEAVY4_CreatePoView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'create-po-view',
    initComponent: function () {
