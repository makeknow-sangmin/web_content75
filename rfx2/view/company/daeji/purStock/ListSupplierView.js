Ext.define('Rfx2.view.company.daeji.purStock.ListSupplierView', {
...
//
//         this.addCallback('CHECK_CODE', function (o) {
//             let target = gm.me().getInputTarget('area_code');
//
...
//                             Ext.Msg.alert('안내', '사용가능한 코드입니다', function () {
//                             });
//                             gm.me().getInputTarget('area_code').setValue(uppercode);
//                         } else {
//                             Ext.Msg.alert('사용불가', '이미 사용중인 코드입니다', function () {
//                             });
//                             gm.me().getInputTarget('area_code').setValue('');
//                         }
//                     },
//                     failure: extjsUtil.failureMessage
//                 }); //end of ajax
...
//
//         this.addCallback('SUPPLIER_CODE', function (o) {
//             let target = gm.me().getInputTarget('supplier_code');
//
//             let code = target.getValue();
//
//             let uppercode = code.toUpperCase();
...
//                             Ext.Msg.alert('안내', '사용가능한 코드입니다', function () {
//                             });
//                             gm.me().getInputTarget('supplier_code').setValue(uppercode);
//                         } else {
//                             Ext.Msg.alert('사용불가', '이미 사용중인 코드입니다', function () {
//                             });
//                             gm.me().getInputTarget('supplier_code').setValue('');
//                         }
//                     },
//                     failure: extjsUtil.failureMessage
//                 });
