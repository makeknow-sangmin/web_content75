Ext.define('Rfx2.view.company.daeji.produceMgmt.WPMgmtView', {
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    Ext.MessageBox.alert('알림', '입력 정보를 다시 확인해주세요.');
                                }
                            }
                        }
                    }, {
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>'+'수리일',
                                            hidden: true,
                                            value: new Date()
                                        },
                                        {
