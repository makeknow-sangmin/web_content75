//자재 관리
Ext.define('Rfx2.view.company.daeji.developmentMgmt.MaterialMgmtOTView', {
    ...
    initComponent: function () {
        ...
        this.cartoon_barcode = Ext.create('Ext.Action', {
            iconCls: 'barcode',
            text: this.getMC('CMD_CARTONBOX_BARCODE', '카톤박스 바코드'),
            tooltip: '제품의 바코드를 출력합니다.',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('cartoon_barcode'),
            handler: function () {
                gm.me().printBarcode();
            }
        });
