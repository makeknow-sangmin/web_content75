//주문작성
Ext.define('Rfx2.view.company.daeji.executiveInfo.AccountsPayableView', {
    ...
    initComponent: function () {
        ...
        this.writeBillHistory = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                var moneytype = Ext.create('Ext.data.Store',{
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    Ext.Ajax.request({
                                        url: CONTEXT_PATH + '/account/arap.do?method=addDeposit',
                                        params: {
                                            wgrast_uids: selectUids,
                                            txt_content: item_name + ' 외 ' + selections.length + '건',
                                            item_quan : selections.length,
                                            ...
                                            etc_memo: etc_memo,
                                            in_date : val['in_date'],
                                            moneytype : gu.getCmp('moneytype').getValue(),
