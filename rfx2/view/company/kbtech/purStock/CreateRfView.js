 ...
 *
 */
Ext.define('Rfx2.view.company.kbtech.purStock.CreateRfView', {
                                    ...
                                    listConfig: {
                                        ...
                                        getInnerTpl: function () {
                                            return '<div onclick="gm.me().setBomData({id});" ><a class="search-item" href="javascript:gm.me().setBomData({id});">' +
                                                '<font color=black><b><small>[{item_code}]</small></b></font>' +
                                                '<font color=black> {item_name}</font><br/><font color=#999>{specification_query}</font>' +
                                                '<font color=#999><small>{maker_name}</small></font>' +
                                                '</a></div>';
                                        }
                                    },
                                    pageSize: 10
    ...
    searchStore: Ext.create('Mplm.store.MaterialMultiSearchStore', {}),
