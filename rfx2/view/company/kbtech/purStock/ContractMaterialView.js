...
//자재 관리
Ext.define('Rfx2.view.company.kbtech.purStock.ContractMaterialView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.kbtech.ContractMaterial', [{
                property: 'unique_id',
                direction: 'DESC'
            }], 300
            , {},
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: '순위', width: 50, dataIndex: 'sort_order', sortable: false},
                {text: '계약업체', width: 250, dataIndex: 'supplier_name', sortable: false},
                {text: '계약단가', width: 100, dataIndex: 'sales_price', sortable: false},
                {text: '계약시작일', width: 100, dataIndex: 'start_date', sortable: false,
                    renderer : Ext.util.Format.dateRenderer('Y-m-d')
                },
                {text: '계약종료일', width: 100, dataIndex: 'end_date', sortable: false,
                    renderer : Ext.util.Format.dateRenderer('Y-m-d')
                },
            ],
            title: '계약 업체 리스트',
