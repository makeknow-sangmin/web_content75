//자재 관리
Ext.define('Rfx2.view.company.kbtech.designPlan.ProductMgmtView', {
    ...
    initComponent: function(){
        ...
        this.createStore('Rfx2.model.company.kbtech.ProductMgmt', [{
                property: 'unique_id',
                direction: 'DESC'
            }],
        ...
        this.addCallback('SET_ITEM_CODE', function (o) {
            ...
            switch(sp_code) {
                ...
                case 'KL':
                    ...
                    var item_code = srcadt_varchars[0] + srcadt_varchars[1] + srcadt_varchars[2] + '-'
                        + srcadt_varchars[3] + srcadt_varchars[4] + srcadt_varchars[5]
                        + srcadt_varchars[6] + '-' + 'S' + srcadt_varchars[7] + srcadt_varchars[8]
                        + srcadt_varchars[9] + srcadt_varchars[10] + '-'  + srcadt_varchars[11]
                        + srcadt_varchars[12] + srcadt_varchars[13];

                    if(srcadt_varchars[14].length > 0) {
                        item_code += '-' + srcadt_varchars[14];
                    }
