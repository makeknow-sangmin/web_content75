Ext.define('Rfx2.view.company.kbtech.designPlan.DesignBomASTreeView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.kbtech.PartLineAS', [{
                property: 'pl_no',
                direction: 'ASC'
            }],
            gm.pageSize
        ...
        var buttonToolbar1 = Ext.create('widget.toolbar', {
            ...
            items: [
                ...
                '-',
                // this.copyPartAction,     -- 복사/붙여넣기는 추가가 완벽하게 될때까지 막음
...
//                },
        ...
        this.createGrid([buttonToolbar1], {
            width: '65%'
        });
                ...
                items: [
                        ...
                        listeners: {
                            specialkey: function (fieldObj, e) {
                                if (e.getKey() == Ext.EventObject.ENTER) {
                                    gm.me().assemblyStore.load(function(o) {
                                        console_logs('o', o);
                                    });
                                }
                            },
                            change: function (fieldObj, e) {
                                gm.me().assemblyStore.getProxy().setExtraParam('item_code', '%' + e + '%');
                            },
                            render: function (c) {
                        ...
                        items: [
                    {
                        ...
                        listeners: {
                            ...
                            change: function (fieldObj, e) {
                                gm.me().assemblyStore.getProxy().setExtraParam('item_name', '%' + e + '%');
                            },
                            render: function (c) {
                                Ext.create('Ext.tip.ToolTip', {
                                    target: c.getEl(),
                        ...
                        items: [
                    {
                        ...
                        listeners: {
                            ...
                            change: function (fieldObj, e) {
                                gm.me().assemblyStore.getProxy().setExtraParam('specification', '%' + e + '%');
                            },
                            render: function (c) {
                                Ext.create('Ext.tip.ToolTip', {
                                    target: c.getEl(),
    ...
    o1['loadMask'] = true;
    var versionList = Ext.create('Rfx.base.BaseGrid',  o1);
    ...
    createCenter: function () {
        ...
        this.bomAll = Ext.create('Rfx2.view.company.kbtech.grid.BomGridHeavy', {
        ...
        this.parentAssyGrid = Ext.create('Rfx2.view.company.kbtech.grid.ParentAssyGrid', {
                    ...
                    items: [
                        {
                            ...
                            store: Ext.create('Rfx2.store.company.kbtech.AssyStore', {}),
...
//                                                pj_code: val['pj_code']
    ...
    selectAssymapCombo: function (record) {
        ...
        gu.getCmp('target-projectcode-DBM7_AST').update(targetPjCode);

        this.srchTreeHandler(this.assyGrid, this.cloudAsStore, 'productcombo-DBM7_AST', 'child', true);
        this.store.removeAll();
        this.unselectAssy();
//         Default Set
        Ext.Ajax.request({
                    ...
                    this.itemSearchAction = Ext.create('Ext.Action', {
                        ...
                        handler: function () {
                            ...
                            if (Object.keys(extraParams).length == 0) {
                                ...
                                gm.me().searchStore.getProxy().setExtraParam('notify_flag', 'Y');
...
//                	tab.setLoading(true);
            ...
            Ext.Ajax.request({
                ...
                success: function (result, request) {
                    ...
                    inputItem.push({
                            ...
                            listeners: {
                                beforequery: function (queryEvent) {
                                    gu.getCmp('searchCombo-DBM7_AST').store.getProxy().setExtraParam('item_code',
                                        '%' + gu.getCmp('searchCombo-DBM7_AST').getValue() + '%');
                                },
                                select: function (combo, record) {

                                    var srcahd_uid = gu.getCmp('searchCombo-DBM7_AST').getValue();
                    ...
                    inputItem.push({
                        id: gu.id('searchCombo-DBM7_AST2'),
                        xtype: 'combo',
                        ...
                        listeners: {
                            beforequery: function (queryEvent) {
                                gu.getCmp('searchCombo-DBM7_AST2').store.getProxy().setExtraParam('item_name',
                                    '%' + gu.getCmp('searchCombo-DBM7_AST2').getValue() + '%');
                            },
                            select: function (combo, record) {

                                var srcahd_uid = gu.getCmp('searchCombo-DBM7_AST2').getValue();
                                var srcahd_uid2 = gu.getCmp('srcahd_uid');
                                srcahd_uid2.setValue(srcahd_uid);
                    ...
                    inputItem.push({
                        id: gu.id('searchCombo-DBM7_AST3'),
                        xtype: 'combo',
                        ...
                        listeners: {
                            beforequery: function (queryEvent) {
                                gu.getCmp('searchCombo-DBM7_AST3').store.getProxy().setExtraParam('specification',
                                    '%' + gu.getCmp('searchCombo-DBM7_AST3').getValue() + '%');
                            },
                            select: function (combo, record) {

                                var srcahd_uid = gu.getCmp('searchCombo-DBM7_AST3').getValue();
                                var srcahd_uid2 = gu.getCmp('srcahd_uid');
                                srcahd_uid2.setValue(srcahd_uid);
                        ...
                        buttons: [{
                            ...
                            handler: function () {
                                ...
                                if (form.isValid()) {
                                    ...
                                    Ext.Ajax.request({
                                        url: CONTEXT_PATH + '/design/bom.do?method=cloudAssyCreateAndCopyToProduct',
                                        params: {
                                            parent_uid: val['unique_uid'],
                                            parent: val['child'],
                                            ac_uid: -1,
    ...
    assemblyStore: Ext.create('Rfx2.store.company.kbtech.AssyStore', {}),
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function (result, request) {
                            ...
                            if (quan > 0) {
                                ...
                                var parent = gm.me().selected_tree_record.data.parent;
                                var child = gm.me().selected_tree_record.data.child;

                                Ext.Ajax.request({
                                    url: CONTEXT_PATH + '/design/bom.do?method=deleteAssyAndUsedProduct',
    ...
    claastLoad: function () {
        ...
        var productcombo = Ext.getCmp(gu.id('productcombo-DBM7_AST'));
        productcombo.store.getProxy().setExtraParam({});
        var claastlevel1 = Ext.getCmp('DBM7_AST-PRDLV1').getValue();
        var claastlevel2 = Ext.getCmp('DBM7_AST-PRDLV2').getValue();
        var claastlevel3 = Ext.getCmp('DBM7_AST-PRDLV3').getValue();
        var claastlevel4 = Ext.getCmp('DBM7_AST-PRDLV4').getValue();
    ...
    claastLoad2: function () {
        ...
        var productcombo = Ext.getCmp('DBM7_AST_srcahd_uid');
        productcombo.store.getProxy().setExtraParam({});
        var claastlevel1 = Ext.getCmp('DBM7_AST-PRDLV1-ADD').getValue();
        var claastlevel2 = Ext.getCmp('DBM7_AST-PRDLV2-ADD').getValue();
        var claastlevel3 = Ext.getCmp('DBM7_AST-PRDLV3-ADD').getValue();
        var claastlevel4 = Ext.getCmp('DBM7_AST-PRDLV4-ADD').getValue();
    ...
    claastReset2: function (no) {
        var claastcombo1 = Ext.getCmp('DBM7_AST-PRDLV1-ADD').getValue();
        var claastcombo2 = Ext.getCmp('DBM7_AST-PRDLV2-ADD');
        var claastcombo3 = Ext.getCmp('DBM7_AST-PRDLV3-ADD');
        var claastcombo4 = Ext.getCmp('DBM7_AST-PRDLV4-ADD');
                ...
                items: [
                    {
                        ...
                        displayField: 'item_name',
                        valueField: 'unique_id',
                        store: Ext.create('Rfx2.store.company.kbtech.ChangeAssyStore', {}),
                        sortInfo: {field: 'specification', direction: 'ASC'},
                        minChars: 1,
                        typeAhead: false,
                        hideLabel: false,
