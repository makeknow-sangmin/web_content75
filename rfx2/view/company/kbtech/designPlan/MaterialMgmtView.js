//자재 관리
Ext.define('Rfx2.view.company.kbtech.designPlan.MaterialMgmtView', {
    ...
    initComponent: function () {
        ...
        this.addCallback('SPECIAL_SPEC_FLAG', function (combo, record) {

            var specialSpecFlag = gm.me().getInputTarget('special_spec_flag').getValue();
            var unitMass = gm.me().getInputTarget('unit_mass');
            if (specialSpecFlag === 'Y') {
                unitMass.setFieldLabel('<font color=red>*</font>' + unitMass.fieldLabel);
                unitMass.setAllowBlank(false);
            } else {
                unitMass.setFieldLabel(unitMass.fieldLabel.replace('<font color=red>*</font>', ''));
                unitMass.setAllowBlank(true);
            }
        });
        ...
        this.createStore('Rfx2.model.company.kbtech.MaterialMgmt',
            [{
                property: 'unique_id',
                direction: 'DESC'
            }],
