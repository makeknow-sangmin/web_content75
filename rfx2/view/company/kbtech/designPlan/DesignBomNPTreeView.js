Ext.define('Rfx2.view.company.kbtech.designPlan.DesignBomNPTreeView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.kbtech.PartLineNP', [{
                property: 'pl_no',
                direction: 'ASC'
            }],
            gm.pageSize
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                ...
                                expand: function (field) {
                                    gu.getCmp('productcombo-DBM7_TREE').store.getProxy().setExtraParam('sp_code_list', 'KA,KB,KC,KL');
