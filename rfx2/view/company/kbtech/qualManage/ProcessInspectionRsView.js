Ext.define('Rfx2.view.company.kbtech.qualManage.ProcessInspectionRsView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'process-inspection-rs-view',
    initComponent: function() {
        ...
        var component = new Ext.Component({
            ...
            autoEl: {
                ...
                html: '<div style ="text-align: center;"><img src="http://59.16.225.8:17080/images/kbtech/04.jpg" width="100%"/></div>'
            },
            height: 600,
            width: 600
        });
