Ext.define('Rfx2.view.company.kbtech.salesDelivery.CreatePoKbTechView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'create-po-kbtech-view',
                                    ...
                                    handler: function () {
                                        ...
                                        for (var i = 0; i < l_store.data.items.length; i++) {
                                            if (!(l_store.getData().getAt(i).data.status === "완료")) {
                                                ...
                                                gm.me().postDocument(CONTEXT_PATH + '/production/schdule.do?method=uploadPoKbTech&file_itemcode=' + gUtil.RandomString(10),
                                                    l_store, i, tabname);
                                            }
                                        }
