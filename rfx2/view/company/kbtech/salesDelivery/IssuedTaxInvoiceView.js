Ext.define('Rfx2.view.company.kbtech.salesDelivery.IssuedTaxInvoiceView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'issued-tax-invoice-view',
    initComponent: function(){

        //모델을 통한 스토어 생성
        this.createStore('Rfx2.model.company.kbtech.IssuedTaxInvoice', [{
