Ext.define('Rfx2.view.company.kbtech.salesDelivery.AdditionalSalesPropView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'additional-sales-prop-view',
    initComponent: function(){

		//모델을 통한 스토어 생성
        this.createStore('Rfx2.model.company.kbtech.AdditionalSalesProp', [{
