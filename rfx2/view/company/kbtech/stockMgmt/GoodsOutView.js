...
Ext.define('Rfx2.view.company.kbtech.stockMgmt.GoodsOutView', {
    ...
    initComponent: function () {
        ...
        this.createStoreSimple({
            modelClass: 'Rfx.model.GoodsoutCartline',
            ...
            handler: function () {
                ...
                if (selections.length) {
                    for (var i = 0; i < selections.length; i++) {
                        ...
                        var stodtl_uid = rec.get('stodtl_uid');
                            ...
                            items: [
                                {
                                    ...
                                    items:
                                          [{
                                                ...
                                                name : 'move_type',
                                                boxLabel :'재고불일치로 소모',// radio 버튼 옆의 이름
                                                inputValue : 'OUT'// radio 버튼의 값
                                            }*/] //end radio button items
                                          ,
                                          listeners: {
                                            change: function(el, newValue, oldValue) { 
                                                    console.log('new value is ', newValue);
                                                    var move_type = newValue['move_type'];

                                                    gu.getCmp('wh_code').setDisabled(move_type=='OUT');
                                                }
                                            }
                               ...
                               
                                {
                                    ...
                                    listeners: {
                                        select: function (combo, record) {
                                            var b = true;
                                            var selectedCode = record.get('wh_code');
                                            console_logs('record', record);

                                            for(var i=0; i< wh_codeArr.length; i++) {
                                                if(wh_codeArr[i] == selectedCode) {
                                                    
                                                    Ext.MessageBox.alert('경고','현재 창고와 목적지 창고가 동일한 경우가 있습니다.');
                                                }
                                            }

                                           gu.getCmp('myBtn').setDisabled(!b);
                                    ...
                                    Ext.MessageBox.show({
                                        ...
                                        fn: function (btn) {
                                            ...
                                            if(btn=='yes') {
                                                ...
                                                var targetWhouse = val['wh_code'];
                                                if(targetWhouse==null || targetWhouse=='') {
                                                    Ext.Msg.alert('경고', '목적창고를 지정하세요.');
                                                    return;
                                                }
                                                ...
                                                form.submit({
                                                    ...
                                                    params: {
                                                        stoqty_uids: stodtlUidArr,
                                                        cartmap_uids: uids,
                                                        ac_uids: acUids,
                                                        quans: quanArr,
                                                        wh_code : targetWhouse,
                                                        reserved_timestamp1 : val['reserved_timestamp1']
