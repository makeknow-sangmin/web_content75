...
//자재 관리
Ext.define('Rfx2.view.company.kbtech.stockMgmt.StockMgmtView', {
    ...
    initComponent: function () {
        ...
        this.createStoreSimple({
            ...
            //modelClass: 'Rfx.model.StockLine',
            modelClass: 'Rfx2.model.company.kbtech.StoqtyLine',
            sorters: [{
                property: 'item_code',
                direction: 'ASC'
            }],
        ...
        this.printStocktakingTempView = Ext.create('Ext.Action', {
            iconCls: 'af-excel',
            text: '재고조사표 출력',
            disabled: false,
                ...
                Ext.MessageBox.show({
                    ...
                    fn:  function(result) {
                        if(result=='yes') {
                            ...
                            store.getProxy().setExtraParam("menuCode", 'PMS1_EXL');
...
//	            					url: CONTEXT_PATH + '/purchase/prch.do?method=create',
        ...
        buttonToolbar.insert(1, this.printStocktakingTempView);
