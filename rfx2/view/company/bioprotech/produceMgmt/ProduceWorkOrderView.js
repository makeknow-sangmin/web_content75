Ext.define('Rfx2.view.company.bioprotech.produceMgmt.ProduceWorkOrderView', {
    ...
    initComponent: function () {
        ...
        this.denyWorkOrder = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('denyWorkOrder'),
            handler: function () {
                Ext.MessageBox.show({
                    title: '확인',
        ...
        this.addWorkOrder = Ext.create('Ext.Action', {
            ...
            tooltip: '작업지시 확정',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('addWorkOrder'),
            handler: function () {
                    ...
                    Ext.MessageBox.show({
                        ...
                        fn: function (btn) {
                            if (btn == "no") {
                                ...
                                form.submit({
                                    url: CONTEXT_PATH + '/index/process.do?method=addWorkOrderBIOT',
                                    params: {
                                        ...
                                        cartmap_uid: cartmap_uid,
                                        reserved_varchar2: reserved_varchar2 // 특이사항 추가
                                    },
