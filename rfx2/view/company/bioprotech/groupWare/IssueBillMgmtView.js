Ext.define('Rfx2.view.company.bioprotech.groupWare.IssueBillMgmtView', {
            ...
            dockedItems: [
                {
                    ...
                    xtype: 'toolbar',
                    cls: 'my-x-toolbar-default2',
                    items: [addWdInHistory, editWdInHistory, deleteWdInAction,/*checkedIssueBillIn*/]
                }
            ]
        });
            ...
            dockedItems: [
                {
                    ...
                    xtype: 'toolbar',
                    cls: 'my-x-toolbar-default2',
                    items: [addIssueBillHistory, editWdOutHistory, deleteWdOutAction,/*checkedIssueBillOut*/downloadFiles]
                }
            ]
        });
