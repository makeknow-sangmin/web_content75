        ...
        this.writeBillHistory = Ext.create('Ext.Action', {
            ...
            handler : function (widget, event) {
                ...
                if (selections.length > 0) {
                    var close_price = 0;
                    var vat_value = 0;
                    var vat_value_foreign = 0;
                    var before_is_vat = '';
                    var close_price_foreign = 0;
                    for (var i = 0; i < selections.length; i++) {
                        ...
                        close_price_foreign = close_price_foreign + rec.get('gr_price');
                        ...
                        vat_value_foreign = rec.get('is_vat') == 'Y' ? (close_price_foreign * 0.1) : 0.0;
                        currency = rec.get('sales_currency');
                        isVat = rec.get('is_vat');
                    }

                    console_logs('>>> vat_value_foreign', vat_value_foreign);
                        ...
                        columns: [
                            ...
                            },
                            {
                                ...
                                renderer : function (value) {
                                    ...
                                    return Ext.util.Format.number(value, '0,00.0000');
                                },
                            }
                        ],
                                            ...
                                            items     : [
                                                {
                                                    ...
                                                    hideTrigger     : true,
                                                    decimalPrecision: 4,
                                                    fieldStyle      : 'background-color: #ddd; background-image: none; font-weight: bold; text-align: right',
                                                    value           : Ext.util.Format.number(close_price, '0.000')
                                                },
                                                {
                                                    id              : gu.id('close_price_foreign'),
                                                    xtype           : 'textfield',
                                                    anchor          : '50%',
                                                    width           : '50%',
                                                    editable        : false,
                                                    name            : 'close_price_foreign',
                                                    hideTrigger     : true,
                                                    decimalPrecision: 4,
                                                    fieldStyle      : 'background-color: #ddd; background-image: none; font-weight: bold; text-align: right',
                                                    value           : Ext.util.Format.number(close_price_foreign, '0,000.000') +' ' +rec.get('sales_currency')
                                                },
                                            ]
                                        }]
                                    },
                                    {
                                        items: [{
                                            ...
                                            items     : [
                                                ...
                                                {
                                                    id              : gu.id('vat_value_foreign'),
                                                    xtype           : 'textfield',
                                                    anchor          : '50%',
                                                    width           : '50%',
                                                    editable        : false,
                                                    name            : 'vat_value_foreign',
                                                    hideTrigger     : true,
                                                    decimalPrecision: 4,
                                                    fieldStyle      : 'background-color: #ddd; background-image: none; font-weight: bold; text-align: right',
                                                    value           : Ext.util.Format.number(vat_value_foreign, '0.000') + ' ' +rec.get('sales_currency')
                                                },
                                            ]
                                        }]
                                    },
                                    {
                                        items: [{
                                            ...
                                            items     : [
                                                ...
                                                {
                                                    id              : gu.id('total_price_forign'),
                                                    xtype           : 'textfield',
                                                    anchor          : '50%',
                                                    width           : '50%',
                                                    editable        : false,
                                                    name            : 'total_price_forign',
                                                    hideTrigger     : true,
                                                    decimalPrecision: 4,
                                                    style: 'text-align: right',
                                                    fieldStyle      : 'background-color: #ddd; background-image: none; font-weight: bold; text-align: right',
                                                    value           : Ext.util.Format.number(close_price_foreign + vat_value_foreign, '0,000.000')+ ' ' +rec.get('sales_currency')
                                                },
                                            ]
                                        }]
                                    },
