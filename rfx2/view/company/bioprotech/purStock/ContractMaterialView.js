Ext.define('Rfx2.view.company.bioprotech.purStock.ContractMaterialView', {
    ...
    initComponent: function () {
        ...
        /* 임시로 모든 제품/자재로 늘림 */
        this.searchStore.getProxy().setExtraParam('working_area_list', 'BPG,PUR,OUT');
        ...
        // this.store.getProxy().setExtraParam('working_area_list', 'BPG,PUR,OUT');
        this.store.getProxy().setExtraParam('working_area_list', 'BPG,PUR,OUT');
