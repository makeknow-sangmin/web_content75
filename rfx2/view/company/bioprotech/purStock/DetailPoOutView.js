Ext.define('Rfx2.view.company.bioprotech.purStock.DetailPoOutView', {
    ...
    initComponent: function () {
        ...
        this.createPrAction = Ext.create('Ext.Action', {
            ...
            text: '구매 요청',
            tooltip: '구매 요청',
            hidden: gu.setCustomBtnHiddenProp('createPrAction'),
            disabled: true,
            handler: function () {
                gm.me().treatPr();
            } //handler end...
        ...
        this.createInPoAction = Ext.create('Ext.Action', {
            ...
            text: '불출 요청',
            tooltip: '불출 요청',
            hidden: gu.setCustomBtnHiddenProp('createInPoAction'),
            disabled: true,
            handler: function () {
                gm.me().treatInPo();
            } //handler end...
