...
Ext.define('Rfx2.view.company.bioprotech.purStock.ListPoView', {
    ...
    initComponent: function () {
        ...
        searchToolbar.insert(0, {
            ...
            handler: function (field, value) {
                if (value) {
                    gm.me().store.getProxy().setExtraParam('exclude_status_deny', null);
                } else {
                    gm.me().store.getProxy().setExtraParam('exclude_status_deny', 'Y');
                }
                gm.me().store.load();
            }
        });
