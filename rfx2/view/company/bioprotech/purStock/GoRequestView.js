//출고확인
Ext.define('Rfx2.view.company.bioprotech.purStock.GoRequestView', {
    ...
    initComponent: function () {
        ...
        this.setGridOnCallback(function (selections) {
            ...
            if (selections.length) {
                ...
                this.cartLineGrid.getStore().getProxy().setExtraParam('orderBy', 'cartmap.unique_id desc');
    ...
    callBackWorkListCHNG: function (title, records, arg, fc, id) {
        ...
        this.cartLineStore = Ext.create('Rfx2.store.company.bioprotech.GoDtlStore');
