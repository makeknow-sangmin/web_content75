Ext.define('Rfx2.view.company.bioprotech.currentSituation.ProductivityRateView', {
    ...
    initComponent: function () {
        ...
        this.mainPanelState = Ext.create('Rfx2.store.company.bioprotech.ProductivityRateStore');
