Ext.define('Rfx2.view.company.bioprotech.currentSituation.UtillrateStateView', {
    ...
    initComponent: function () {
        ...
        this.mainPanelState = Ext.create('Rfx2.store.company.bioprotech.UtillrateStateStore');
            ...
            dockedItems: [
				{
					...
					items: [
                        {
                            xtype: 'combo',
                            id: gu.id('target_time'),
                            name: 'target_time',
                            displayField: 'code_name_kr',
                            store: this.targetTimeStore,
    ...
    targetTimeStore: Ext.create('Mplm.store.TargetTimeStore', {}),
