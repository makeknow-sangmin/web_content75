//생산완료 현황
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.ProduceFinishVersionView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            type: 'text',
            field_id: 'wa_name',
            emptyText: this.getMC('ULV_CMD_TOTAL_CUSTOMER', '고객명')
        });
        ...
        this.assignShipmentAction = Ext.create('Ext.Action', {
            ...
            tooltip: '출하 요청',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('assignShipmentAction'),
            handler: function () {
                ...
                var comcstStore = Ext.create('Rfx.store.ComCstStore', {});
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    listConfig: {
                                        ...
                                        emptyText: '일치하는 항목 없음',
                                        getInnerTpl: function () {
                                            return '<div data-qtip="{unique_id_long}">{division_code}</div>';
                                        }
                                    }
                                }
                            ]
        ...
        this.cartGoReq = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('cartGoReq'),
            handler: function (widget, event) {
                var mainSelection = gm.me().grid.getSelectionModel().getSelection()[0];
                                        ...
                                        if (btn == "no") {
                                            ...
                                            if (length > 0) {
                                                ...
                                                for (var i = 0; i < storeData.data.items.length; i++) {
                                                    ...
                                                    assyMapArr.push(-1);
                                                    sloastUidArr.push(item.get('assymap_uid'));
        ...
        this.purListSrch = Ext.create('Ext.Action', {
            ...
            text: CMD_SEARCH/*'검색'*/,
            disabled: false,
            hidden: gu.setCustomBtnHiddenProp('purListSrch'),
            handler: function (widget, event) {
                try {
                    var item_name = '';
                    var final_wa_name = '';
