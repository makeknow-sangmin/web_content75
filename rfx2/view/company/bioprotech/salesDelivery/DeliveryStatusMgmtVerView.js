//수주관리 메뉴
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.DeliveryStatusMgmtVerView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            items: [
                {
                    boxLabel: this.getMC('CMD_BL_information_input_target', 'B/L정보 입력대상'),
                    checked: true
                },
            ],
        });
        ...
        this.addSearchField({
            type: 'dateRange',
            field_id: 'search_date_value',
            text: gm.getMC('CMD_SEARCH_DATE', '검색일자'),
        ...
        this.createStore('Rfx2.model.company.bioprotech.DeliveryFinishVerStatus', [{
                property: 'unique_id',
                direction: 'DESC2'
            }],
        ...
        this.fileattachAction = Ext.create('Ext.Action', {
            ...
            text: gm.getMC('CMD_Document_management', '문서관리'),
        ...
        this.addBlInfoAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('addBlInfoAction'),
                                        ...
                                        if (btn == "no" || btn == "cancel") {
                                            ...
                                            Ext.Ajax.request({
                                                ...
                                                params: {
                                                    ...
                                                    unique_id: rec.get('rtgastdo_uid')
                                                },
        ...
        buttonToolbar.insert(3, this.fileattachViewAction);
        ...
        this.store.getProxy().setExtraParam('isExceptBl', 'true');
                ...
                items: [
                    {
                        ...
                        handler: function () {
                            ...
                            var url = CONTEXT_PATH + '/uploader.do?method=multi&group_code=' + record.get('rtgastdo_uid');
