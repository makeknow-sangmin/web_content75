//수주관리 메뉴
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.RecvMgmtKbTechView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            items: [
                {
                    boxLabel: this.getMC('msg_order_completed', '출고완료포함'),
                    checked: false
                },
            ],
        });
        ...
        this.addSearchField({
            ...
            width: 400,
            text: this.getMC('msg_order_order_date', '오더일'),
        ...
        this.rollbackPoOnlyPrdAceeptAction = Ext.create('Ext.Action', {
            iconCls: 'af-reject',
            disabled: true,
            text: this.getMC('msg_unconfirm', '확정취소'),
        ...
        this.cancelPo = Ext.create('Ext.Action', {
            iconCls: 'af-remove',
            disabled: true,
            text: this.getMC('msg_cancel_order', '수주취소'),
        ...
        this.changePo = Ext.create('Ext.Action', {
            iconCls: 'af-edit',
            disabled: true,
            text: this.getMC('msg_order_change', '수주변경'),
