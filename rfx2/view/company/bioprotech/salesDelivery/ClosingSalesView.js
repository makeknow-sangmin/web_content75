Ext.define('Rfx2.view.company.bioprotech.salesDelivery.ClosingSalesView', {
    ...
    initComponent: function () {
        ...
        this.closingSalesAction = Ext.create('Ext.Action', {
            ...
            tooltip: '매출마감',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('closingSalesAction'),
        ...
        this.carryOverAction = Ext.create('Ext.Action', {
            ...
            tooltip: '이월처리',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('carryOverAction'),
            handler: function (widget, event) {
                gm.me().doCarryOver();
            }
        });
