//출하 관리
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.ProductStockView', {
    ...
    initComponent: function () {
        ...
        this.cancelStockAction = Ext.create('Ext.Action', {
            ...
            text: this.getMC('msg_cancel_received_stock', '입고 취소'),
            tooltip: '입고 취소',
            disabled: false,
            handler: function () {
        ...
        this.productDetailGrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    text: this.getMC('msg_lot_no', '생산로트번호'),
                    width: 85,
                    style: 'text-align:center',
                    dataIndex: 'pcs_desc_group'
                },
                {
                    text: this.getMC('msg_received_qtv', '생산로트번호'),
                    width: 100,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_current_qtv', '현재재고'),
                    width: 100,
                    style: 'text-align:center',
            ...
            title: this.getMC('msg_stock_details', '상세 리스트'),
            name: 'po',
            autoScroll: true,
            listeners: {
