//생산완료 현황
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.DeliveryPendingDetailVerView', {
    ...
    initComponent: function () {
        ...
        this.addDlAndSledel = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('addDlAndSledel'),
            handler: function () {
        ...
        this.rejectDeliveryOrder = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('rejectDeliveryOrder'),
            handler: function () {
        ...
        this.printShippingMark = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('printShippingMark'),
            handler: function () {
        ...
        this.setDeliveryPlanAction = Ext.create('Ext.Action', {
            ...
            tooltip: '출하예정일 지정',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('setDeliveryPlanAction'),
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
                var shipmentTypeStore = Ext.create('Mplm.store.CommonCodeStore', { parentCode: 'SHIPMENT_TYPE' });
                var reqDate = rec.get('req_date');
        ...
        this.printDo = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('printDo'),
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
                var rtgastUid = rec.get('unique_id_long');
        ...
        this.setCIPrintCi = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('setCIPrintCi'),
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
                var rtgastUid = rec.get('unique_id_long');
                var dl_uids = rec.get('dl_uids');
        ...
        this.combineDeliveryOrder = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('combineDeliveryOrder'),
            handler: function () {
        ...
        this.palletLoadList = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('palletLoadList'),
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
                ...
                detailStore.getProxy().setExtraParam('not_use_paging', 'Y');
        ...
        this.palletDelete = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('palletDelete'),
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
        ...
        this.adjustRequestQuan = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('adjustRequestQuan'),
            handler: function () {
        ...
        this.createPallet = Ext.create('Ext.Action', {
            ...
            tooltip: '팔레트 생성',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('createPallet'),
            handler: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    text: this.getMC('msg_order_grid_prd_currency', '고객PO번호'),
                    width: 80,
                    style: 'text-align:center',
        ...
        buttonToolbar.insert(6, this.combineDeliveryOrder);
        buttonToolbar.insert(7, this.printDo);
        ...
        this.setGridOnCallback(function (selections) {
            if (selections.length > 0) {
                ...
                this.poPrdDetailStore.getProxy().setExtraParam('coord_key1', rec.get('coord_key1'));
    ...
    makePalletEl: function () {
        ...
        gm.me().workListStore.getProxy().setExtraParam('comcstUid', selectionsOther.get('coord_key1'));
