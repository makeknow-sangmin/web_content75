//생산완료 현황
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.ProduceFinishView', {
    ...
    initComponent: function () {
        ...
        this.assignShipmentAction = Ext.create('Ext.Action', {
            ...
            text: this.getMC('delivery_request', '출하 요청'),
            tooltip: '출하 요청',
            disabled: true,
            handler: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    text: this.getMC('msg_order_no', '수주번호'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'orderNumber'/*, sortable: false*/
                },
                {
                    text: this.getMC('msg_order_dia_order_end_customer', '최종고객사'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'final_wa_name'/*, sortable: false*/
                },
                {
                    text: this.getMC('msg_qtv', '요청수량'),
                    width: 95,
                    style: 'text-align:center',
                    dataIndex: 'ap_Wquan',
                    align: 'right',
                ...
                {
                    text: this.getMC('toolbar_pj_product_type', gm.getMC('CMD_Product', '제품군')),
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'class_name'/*, sortable: false*/
                },
                {
                    text: this.getMC('msg_product_add_dia_model', '제품명'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'item_name'/*, sortable: false*/
                },
                {
                    text: this.getMC('msg_base_model', '기준모델'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'description'/*, sortable: false*/
                },
                {
                    text: this.getMC('msg_order_grid_prd_delivery_date', '고객요청일'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'reserved_timestamp1'/*, sortable: false*/,
                    renderer: function (value, context, tmeta) {
                ...
                {
                    text: this.getMC('msg_released_orderqtv', '요청된수량/오더수량'),
                    width: 150,
                    style: 'text-align:center',
                    dataIndex: 'apBmQuan',
                    align: 'right'
                ...
                {
                    text: this.getMC('msg_customer_po', '고객PO번호'),
                    width: 120,
                    style: 'text-align:center',
                    dataIndex: 'project_varchard'
                },
                {
                    text: this.getMC('msg_remarks', '수주특기사항'),
                    width: 150,
                    style: 'text-align:center',
                    dataIndex: 'reserved1'
                },
                ...
                },
                {
                    ...
                    width: 80,
                    style: 'text-align:center',
                    dataIndex: 'reserved4'/*, sortable: false*/
                },
                {text: '최종고객명', width: 100, style: 'text-align:center', dataIndex: 'final_wa_name'},
                {
                    text: this.getMC('msg_order_order_date', '수주일자'),
                    width: 100,
                    style: 'text-align:center',
