//생산완료 현황
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.DeliveryFinishView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            items: [
                {
                    boxLabel: this.getMC('msg_released', '납품완료포함'),
                    checked: false
                },
            ],
        });
        ...
        this.attcheContainerAction = Ext.create('Ext.Action', {
            ...
            text: this.getMC('msg_container_info', '컨테이너 정보입력'),
            tooltip: this.getMC('msg_container_info', '컨테이너 입력'),
            disabled: false,
            handler: function () {
        ...
        this.barcodePrintAction = Ext.create('Ext.Action', {
            iconCls: 'barcode',
            disabled: true,
            text: this.getMC('msg_print_pallet_barcoder', '팔레트바코드 출력'),
            handler: function () {
                gm.me().printBarcode();
            }
        });
        ...
        this.deliveryFinishAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
            text: this.getMC('msg_release', '납품완료'),
            handler: function () {
        ...
        this.downloadSheetAction = Ext.create('Ext.Action', {
            xtype: 'button',
            iconCls: 'af-download',
            text: this.getMC('msg_pallet_packing', '팔레트 적재리스트'),
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    text: this.getMC('msg_order_grid_prd_name', gm.getMC('CMD_Product', '제품군')),
                    width: 80,
                    style: 'text-align:center',
