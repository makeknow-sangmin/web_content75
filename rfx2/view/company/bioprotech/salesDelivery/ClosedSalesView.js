Ext.define('Rfx2.view.company.bioprotech.salesDelivery.ClosedSalesView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'closed-sales-view',
    initComponent: function () {

        //모델을 통한 스토어 생성
        this.createStore('Rfx2.model.company.kbtech.ClosedSales', [{
        ...
        this.store.getProxy().setExtraParam('hasCloseSales', true);
