//수주관리 메뉴
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.DeliveryStatusMgmtView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.bioprotech.DeliveryFinishStatusSales', [{
                property: 'unique_id',
                direction: 'DESC2'
            }],
        ...
        this.fileattachAction = Ext.create('Ext.Action', {
            ...
            text: this.getMC('msg_bl_download', '파일 다운로드'),
        ...
        this.addBlInfoAction = Ext.create('Ext.Action', {
            ...
            text: this.getMC('msg_bl_info', '선적정보 입력'),
            handler: function (widget, event) {
