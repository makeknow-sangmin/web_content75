//생산완료 현황
Ext.define('Rfx2.view.company.bioprotech.salesDelivery.DeliveryPendingDetailView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            type: 'text',
            field_id: 'po_no',
            emptyText: this.getMC('msg_dono', '요청번호'),
        });

        this.addSearchField({
            type: 'text',
            field_id: 'wa_name',
            emptyText: this.getMC('msg_order_dia_order_customer', '고객명'),
        });
        ...
        this.addDlAndSledel = Ext.create('Ext.Action', {
            xtype: 'button',
            iconCls: 'af-plus',
            text: this.getMC('msg_build', '팔레트 구성'),
            tooltip: this.getMC('msg_build', '팔레트 구성'),
            disabled: true,
            handler: function () {
        ...
        this.rejectDeliveryOrder = Ext.create('Ext.Action', {
            xtype: 'button',
            iconCls: 'af-reject',
            text: this.getMC('msg_order_cancel', '요청취소'),
            tooltip: this.getMC('msg_order_cancel', '요청취소'),
            disabled: true,
            handler: function () {
        ...
        this.printShippingMark = Ext.create('Ext.Action', {
            iconCls: 'af-print',
            text: this.getMC('msg_print', 'Shipping Mark 출력'),
            tooltip: this.getMC('msg_print', 'Shipping Mark 출력'),
            disabled: true,
            handler: function () {
        ...
        this.modifyShipmentAction = Ext.create('Ext.Action', {
            iconCls: 'af-edit',
            text: this.getMC('msg_change_customer', '수정'),
            tooltip: '출하 요청 수정',
            disabled: true,
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
        ...
        this.setDeliveryPlanAction = Ext.create('Ext.Action', {
            iconCls: 'af-calendar',
            text: this.getMC('msg_estimated_date', '출하예정일 지정'),
            tooltip: '출하예정일 지정',
            disabled: true,
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
        ...
        this.setCIPrintCi = Ext.create('Ext.Action', {
            iconCls: 'af-pdf',
            text: this.getMC('msg_print', 'C/I 출력'),
        ...
        this.deleteDoAction = Ext.create('Ext.Action', {
            xtype: 'button',
            iconCls: 'af-remove',
            text: this.getMC('msg_delete', '삭제'),
            tooltip: this.getMC('msg_delete', '삭제'),
            disabled: true,
            handler: function () {
                var rec = gm.me().grid.getSelectionModel().getSelection()[0];
                Ext.MessageBox.show({
        ...
        this.palletLoadList = Ext.create('Ext.Action', {
            text: this.getMC('msg_pallet_list', '팔레트 적재현황'),
        ...
        this.palletDelete = Ext.create('Ext.Action', {
            text: this.getMC('msg_delete_pallet', '팔레트 삭제'),
        ...
        this.adjustRequestQuan = Ext.create('Ext.Action', {
            text: this.getMC('msg_change_qtv', '요청수량 수정'),
        ...
        this.createPallet = Ext.create('Ext.Action', {
            iconCls: 'af-plus',
            text: this.getMC('msg_pallet', 'PALLET 생성'),
            tooltip: '팔레트 생성',
            disabled: true,
            handler: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    text: this.getMC('mes_sro5_pln_column_status', '상태'),
                    width: 80,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('mes_sro5_pln_column_year_qty', '요청수량'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'pr_quan',
                    align: 'right',
                ...
                {
                    text: this.getMC('msg_stock', '실재고수량'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'real_stock_qty',
                    sortable: true,
                    align: 'right',
                    renderer: function (value, context, tmeta) {
