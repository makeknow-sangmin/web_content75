...
Ext.define('Rfx2.view.company.bioprotech.designPlan.DesignBomTreeView', {
                     ...
                     //gm.me().selectProjectCombo(record);
                        ...
                        listeners: {
                            select: function (combo, record) {
                                ...
                                gm.me().conditionStore.getProxy().setExtraParam('sqlName', 'partLineItemDetail');
                                /*cartmap 에서 Assymap으로 변경*/
                                switch (vCompanyReserved4) {
                                    case 'KBTC01KR':
                    ...
                    },
                        {
                            ...
                            store: this.cloudprojectStore,
                            // minChars: 1,
                            listConfig: (vCompanyReserved4 == 'HSGC01KR' || vCompanyReserved4 == 'APM01KR') ?
