Ext.define('Rfx2.view.company.bioprotech.designPlan.TechDocuMgmtView', {
    ...
    createWest: function () {
        ...
        this.grid.getSelectionModel().on({
            selectionchange: function (sm, selections) {
                ...
                gm.me().docuStore.getProxy().setExtraParam('menu_code', 'TECH_DOCU');
