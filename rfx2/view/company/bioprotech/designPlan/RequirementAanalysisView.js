Ext.define('Rfx2.view.company.bioprotech.designPlan.RequirementAanalysisView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            , params: {parentCode: 'PRD_MATERIAL_TYPE'}
        ...
        this.createStoreSimple({
            modelClass: 'Rfx2.model.company.bioprotech.ConsumeRateTotalAssyResult',
            pageSize  : 100,
            sorters   : [{
                property : 'unique_id',
                direction: 'DESC'
        ...
        buttonToolbar.insert(1, this.requestPurchase);
