...
//자재 관리
Ext.define('Rfx2.view.company.dsmaref.purStock.ContractMaterialView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.dsmf.ContractMaterial', [{
                property: 'item_code',
                direction: 'DESC'
            }], gMain.pageSize
            , {},
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: '순위', width: 50, dataIndex: 'sort_order', sortable: false, align: 'center'},
                {text: '계약업체', width: 250, dataIndex: 'supplier_name', sortable: false, style: 'text-align:center', align: 'left'},
                {text: '계약단가', width: 100, dataIndex: 'sales_price', sortable: false, 
                style: 'text-align:center', align: 'right', editor: 'textfield' },
        ...
        this.store.getProxy().setExtraParam('standard_flag_list', 'R,M');
