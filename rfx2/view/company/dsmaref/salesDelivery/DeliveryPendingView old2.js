...
Ext.define('Rfx2.view.company.dsmaref.salesDelivery.DeliveryPendingView', {
    ...
    dlHandler: function() {
        var prd_select = gm.me().prdGrid.getSelectionModel().getSelection();
        var json = '';
        for(var i=0; i<prd_select.length; i++) {
            var select = prd_select[i];
        ...
        var form = Ext.create('Ext.form.Panel', {
            ...
            items:[
                {
                    xtype:'component',
                    html:'납품서 선택 안할시에 신규 생성' + possible_quan,
                    width:'100%',
