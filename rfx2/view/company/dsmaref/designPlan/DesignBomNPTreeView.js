...
Ext.define('Rfx2.view.company.dsmaref.designPlan.DesignBomNPTreeView', {
            ...
            },
                {
                    ...
                    items: [{
                    ...
                    },
                        {
                            ...
                            store: Ext.create('Rfx2.store.company.kbtech.ProductStore', {}),
                            ...
                            listeners: {
                                ...
                                expand: function (field) {
                                    ...
                                    gu.getCmp('productcombo-DBM7_TREE').store.getProxy().setExtraParam('sp_code_list', 'DSC,DSU,DSR');
...
//                }
    ...
    onAssemblyGridSelection: function (selections) {
        console_logs('>>>>> onAssemblyGridSelection selections', selections);
        if (selections != null && selections.length > 0) {
            var rec = selections[0];
                    ...
                    inputItem.push({
                            ...
                            listeners: {
                                ...
                                select: function (combo, record) {
                                    ...
                                    var specification = Ext.getCmp('DBM7_TREE_specification');
