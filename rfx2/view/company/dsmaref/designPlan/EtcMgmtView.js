//자재 관리
Ext.define('Rfx2.view.company.dsmaref.designPlan.EtcMgmtView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'etc-mgmt-view1',
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.dsmf.EctMgmt',
            [{
                property: 'unique_id',
                direction: 'DESC'
            }],
...
//				gm.me().stockviewType = 'ALL';
    ...
    enableCode:false,
    claastStoreEtc: Ext.create('Mplm.store.ClaastStore', {}),
    claastStoreEtcDetail: Ext.create('Mplm.store.ClaastStore', {}),
    claastStoreEtcSubDetail: Ext.create('Mplm.store.ClaastStore', {}),
    ...
    manageFn: function(type) {
        ...
        gm.me().claastStoreEtc.getProxy().setExtraParam('identification', 'ETC');
        gm.me().claastStoreEtcDetail.getProxy().setExtraParam('identification', 'ETC');
        gm.me().claastStoreEtcSubDetail.getProxy().setExtraParam('identification', 'ETC');
        gm.me().claastStoreEtc.getProxy().setExtraParam('level1', 1);
        gm.me().claastStoreEtc.load();
        gm.me().IncomSpecStore.load();
        gm.me().ynCodeStore.load();
        
        if(type == 'edit' || type == 'copy') {
            gm.me().claastStoreEtcDetail.load();
            gm.me().claastStoreEtcSubDetail.load();
        }
                            ...
                            items:[
                                {
                                    ...
                                    listeners: {
                                        select: function (combo, record) {
                                            ...
                                            gm.me().claastStoreEtcDetail.getProxy().setExtraParam('level1', 2);
                                            gm.me().claastStoreEtcDetail.getProxy().setExtraParam('parent_class_code', value);
                                            gm.me().claastStoreEtcDetail.load();
                                        }
                                    },
                                    fieldStyle: type=='edit' ? 'background-color: #ddd; background-image: none;' : '',
                                    ...
                                    allowBlank:true,
                                    fieldStyle: 'background-image: none;',
                                    store: gm.me().claastStoreEtcDetail,
                                    emptyText: '선택해주세요.',
                                    displayField:   'class_name',
                                    valueField:   'class_code',
                                    // sortInfo: { field: 'codeName', direction: 'ASC' },
                                    ...
                                    listeners: {
                                        select: function (combo, record) {
                                            Ext.getCmp('class_code').setValue(null);
                                            var value = combo.value;
                                            gm.me().claastStoreEtcSubDetail.getProxy().setExtraParam('level1', 2);
                                            gm.me().claastStoreEtcSubDetail.getProxy().setExtraParam('parent_class_code', value);
                                            gm.me().claastStoreEtcSubDetail.load();
                                        },
                                    ...
                                    allowBlank:true,
                                    fieldStyle: 'background-image: none;',
                                    store: gm.me().claastStoreEtcSubDetail,
                                    emptyText: '선택해주세요.',
                                    displayField:   'class_name',
                                    valueField:   'class_code',
                                    // sortInfo: { field: 'codeName', direction: 'ASC' },
