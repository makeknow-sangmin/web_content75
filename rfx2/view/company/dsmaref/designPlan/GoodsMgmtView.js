//자재 관리
Ext.define('Rfx2.view.company.dsmaref.designPlan.GoodsMgmtView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'goods-mgmt-view1',
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.dsmf.GoodsMgmt',
            [{
                property: 'unique_id',
                direction: 'DESC'
            }],
...
//				gm.me().stockviewType = 'ALL';
    ...
    enableCode:false,
    claastStoreGoods: Ext.create('Mplm.store.ClaastStore', {}),
    claastStoreGoodsDetail: Ext.create('Mplm.store.ClaastStore', {}),
    claastStoreGoodsSubDetail: Ext.create('Mplm.store.ClaastStore', {}),
    ...
    manageFn: function(type) {
        ...
        gm.me().claastStoreGoods.getProxy().setExtraParam('identification', 'MD');
        gm.me().claastStoreGoodsDetail.getProxy().setExtraParam('identification', 'MD');
        gm.me().claastStoreGoodsSubDetail.getProxy().setExtraParam('identification', 'MD');
        gm.me().claastStoreGoods.getProxy().setExtraParam('level1', 1);
        gm.me().claastStoreGoods.load();
        
        gm.me().claastStoreGoodsDetail.load();
        gm.me().claastStoreGoodsSubDetail.load();
                            ...
                            items:[
                                {
                                    ...
                                    listeners: {
                                        select: function (combo, record) {
                                            ...
                                            gm.me().claastStoreGoodsDetail.getProxy().setExtraParam('level1', 2);
                                            gm.me().claastStoreGoodsDetail.getProxy().setExtraParam('parent_class_code', value);
                                            gm.me().claastStoreGoodsDetail.load();
                                        }
                                    },
                                    fieldStyle: type=='edit' ? 'background-color: #ddd; background-image: none;' : '',
                                    ...
                                    allowBlank:true,
                                    fieldStyle: 'background-image: none;',
                                    store: gm.me().claastStoreGoodsDetail,
                                    emptyText: '선택해주세요.',
                                    displayField:   'class_name',
                                    valueField:   'class_code',
                                    // sortInfo: { field: 'codeName', direction: 'ASC' },
                                    ...
                                    listeners: {
                                        select: function (combo, record) {
                                            Ext.getCmp('class_code').setValue(null);
                                            var value = combo.value;
                                            gm.me().claastStoreGoodsSubDetail.getProxy().setExtraParam('level1', 3);
                                            gm.me().claastStoreGoodsSubDetail.getProxy().setExtraParam('parent_class_code', value);
                                            gm.me().claastStoreGoodsSubDetail.load();
                                        },
                                    ...
                                    allowBlank:true,
                                    fieldStyle: 'background-image: none;',
                                    store: gm.me().claastStoreGoodsSubDetail,
                                    emptyText: '선택해주세요.',
                                    displayField:   'class_name',
                                    valueField:   'class_code',
                                    // sortInfo: { field: 'codeName', direction: 'ASC' },
                                    ...
                                    listeners: {
                                        ...
                                        // afterrender: function(a,b) {
                                        //     var sp_code = Ext.getCmp('class_code').getValue();
                                        //     if(sp_code != null && sp_code != undefined) {
                                        //         gm.me().claastStoreMtDetail.getProxy().setExtraParam('level1', 2);
                                        //         gm.me().claastStoreMtDetail.getProxy().setExtraParam('parent_class_code', sp_code);
                                        //     }
