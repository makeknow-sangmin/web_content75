Ext.define('Rfx2.view.company.kmechatro.salesDelivery.RecvPoDetailVerView', {
    ...
    initComponent: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    text: this.getMC('msg_order_grid_quan_desc', '수량'), width: 60, style: 'text-align:center', dataIndex: 'sales_amount', sortable: false, align: 'right',
                    editor: 'numberfield',
                    renderer: function (value, context, tmeta) {
    ...
    getPrdAdd: function () {
        var action = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                //2020.12.2 KNH. 판매단가관리에서 지정된 제품들만 뜨도록
