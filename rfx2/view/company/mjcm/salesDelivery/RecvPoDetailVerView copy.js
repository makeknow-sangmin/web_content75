    ...
    initComponent: function () {
        ...
        this.addPoAction = Ext.create('Ext.Action', {
            ...
            handler: function () {
                ...
                var productGrid = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        {
                            text: gm.me().getMC('msg_order_grid_prd_fam', '제품군'),
                            width: '10%',
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: this.getMC('msg_order_grid_prd_fam', '제품군'), width: 100, style: 'text-align:center', dataIndex: 'class_code', sortable: false },
                ...
                {
                    text: this.getMC('msg_order_grid_quan_desc', '수량'), width: 95, style: 'text-align:center', dataIndex: 'sales_amount', sortable: false, align: 'right',
                    editor: 'numberfield',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'sales_amount') {
                            context.record.set('sales_amount', Ext.util.Format.number(value, '0,00/i'));
            ...
            title: this.getMC('mes_reg_prd_info_msg', '등록 제품정보'),
            name: 'po',
            autoScroll: true,
            listeners: {
                edit: function (editor, e, eOpts) {
