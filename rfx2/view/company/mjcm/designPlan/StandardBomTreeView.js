Ext.define('Rfx2.view.company.mjcm.designPlan.StandardBomTreeView', {
    extend: 'Rfx2.view.designPlan.StandardBomTreeView',
    xtype: 'standard-bom-tree-view-mjcm',
...
//                         if(work_state != 'R' && is_refer == 'Y') {return '참조';}
//                         else if(work_state == 'R') {return '수정불가';}
//                     }
//                 }
//             ]
...
//                     if(!!selections[0].get('depth') && selections[0].get('depth') > 1){
...
//                     // if(rec.get('work_state') == 'R' || rec.get('is_refer') == 'Y'){
//                     //     gm.me().addAssyAction.disable();
//                     //     gm.me().addPartAction.disable();
//                     //     gm.me().addReferBomverAction.disable();
//                     //     gm.me().removeAssyAction.disable();
