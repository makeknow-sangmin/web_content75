//설비현황
Ext.define('Rfx2.view.company.bioprotech.equipState.EquipSpMgmtView', {
    ...
    initComponent: function () {
        ...
        this.addGoodsMoveAction = Ext.create('Ext.Action', {
            ...
            text: gm.getMC('CMD_Move', '창고이동'),
            tooltip: '자재의 창고를 이동시킵니다',
            disabled: true,
    ...
    addStockMove: function (val) {
        Ext.MessageBox.show({
            ...
            fn: function (btn) {
                if (btn == 'yes') {
                    Ext.Ajax.request({
                        url: CONTEXT_PATH + '/inventory/prchStock.do?method=moveQty',
                        params: {
                            unique_id: val['unique_id'],
                            barcode: val['unique_id'],
                            stock_pos: '', /*NULL을 넣어야 V2에서 유효재고*/
