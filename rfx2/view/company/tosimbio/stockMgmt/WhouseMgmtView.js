                                ...
                                Ext.Ajax.request({
                                    ...
                                    params:{ 
                                        // barcodes: uniqueIdArr
                                         barcodeUidArr : udiArr,
                                         print_type : 'LOCATION',
                                         print_qty : 1,
                                         itemNameArr : classNameArr,
                                         spcStr : spcStr
                                     },
                                    success: function (result, request) {
        ...
        */
        ...
        this.setGridOnCallback(function (selections) {
            if (selections.length) {
                ...
                this.locationGrid.getStore().load(function (record) {
                });
        ...
        this.locationGrid.getSelectionModel().on({
            selectionchange: function (sm, selections) {
                if (selections) {
                    ...
                    gm.me().locationGrid.getStore().load(function (record) {
                    });
                } else {
