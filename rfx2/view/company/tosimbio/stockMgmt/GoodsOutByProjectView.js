Ext.define('Rfx2.view.company.bioprotech.stockMgmt.GoodsOutByProjectView', {
                ...
                Ext.MessageBox.show({
                    ...
                    fn: function (result) {
                        if (result == 'yes') {
                            ...
                            Ext.Ajax.request({
                                url: CONTEXT_PATH + '/purchase/request.do?method=cancelGoDirect',
                                params: {
                        ...
                        if (result == 'yes') {
                            ...
                            if (!isExceedQuan) {
                                ...
                                Ext.MessageBox.show({
                                    ...
                                    msg: '재고를 초과하는 소모 요청량이 있습니다.<br><br><font color=red><b>초과자재&nbsp' + excceedItemNameArr.length + '건</b><br>' + name,
