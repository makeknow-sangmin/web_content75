Ext.define('Rfx2.view.company.bioprotech.qualityStandards.UDIMgmtView', {
    ...
    initComponent: function () {
        ...
        this.editUdiBtn = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('editUdiBtn'),
            handler: function () {
                Ext.MessageBox.show({
                    title: '저장',
                    msg: '저장하시겠습니까?',
        ...
        this.delinspection = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('delinepection'),
            handler: function () {
                Ext.MessageBox.show({
                    title: '삭제',
