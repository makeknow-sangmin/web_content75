Ext.define('Rfx2.view.company.tosimbio.designPlan.StandardBomTreeView', {
    // extend: 'Rfx2.view.company.tosimbio.designPlan.StandardBomTreeView_new',
    extend: 'Rfx2.base.BaseView',
    xtype: 'standard-bom-tree-view-tosimbio',
    initComponent: function () {
        ...
        //모델 정의
        this.createStore('Rfx2.model.company.tosimbio.Bomdtl', [{
    ...
    createWest: function () {
        this.productStore = Ext.create('Ext.data.Store', {
            model: Ext.create('Rfx2.model.company.tosimbio.ProductVerMgmt', {}),
            autoLoad: true,
            pageSize: 50
        });
