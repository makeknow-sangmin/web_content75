//수주등록된 전체 제품 메뉴
Ext.define('Rfx2.view.company.tosimbio.produceMgmt.ProduceMgmtTabView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            text: "작업지시일",
            labelWidth: 60,
            sdate: Ext.Date.add(new Date(), Ext.Date.MONTH, -24),
            edate: new Date()
        });
        ...
        this.createStoreSimple({
            modelClass: 'Rfx2.model.company.tosimbio.ProduceWorkFP',
            pageSize: 100,
            sorters: [{
                        ...
                        buttons: [
                            {
                                ...
                                handler: function () {
                                    ...
                                    if (vCompanyReserved4 == 'HSST01KR' || vCompanyReserved4 == 'WOWT01KR' || vCompanyReserved4 == 'YNJU01KR' || vCompanyReserved4 == 'TSBI01KR') {
                                        Ext.MessageBox.show({
                                            title: '확인',
                                            msg: msg,
