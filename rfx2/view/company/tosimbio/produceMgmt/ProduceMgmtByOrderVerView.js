Ext.define('Rfx2.view.company.bioprotech.produceMgmt.ProduceMgmtByOrderVerView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            type: 'checkbox',
            field_id: 'isExceptDel',
            items: [
                {
                    boxLabel: this.getMC('CMD_Exclude_Delivered', '출하완료 제외'),
                    checked: true
                },
            ],
        });
        ...
        this.rePackEstablishAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('rePackEstablishAction'),
            handler: function () {
        ...
        // this.store.getProxy.setExtraParam('isExceptDel','true');
