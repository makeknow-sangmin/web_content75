Ext.define('Rfx2.view.company.tosimbio.produceMgmt.ProduceWorkOrderView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.tosimbio.ProduceWorkOrderFP', [{
        ...
        this.printPDFAction = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                for (var i = 0; i < selections.length; i++) {
                    ...
                    var rtgastUid = sel.get('unique_id_long');
                    rtgastUids.push(rtgastUid);
                }
                if (rtgastUids.length > 0) {
                    gm.me().pdfDownload(rtgastUids.length, -1, rtgastUids, 0);
                }
        ...
        this.grid.getStore().getProxy().setExtraParam('state', 'I');
        this.storeLoad();
    },
                        ...
                        fn: function (btn) {
                            if (btn == "no") {
                                ...
                                for (var i = 0; i < selections.length; i++) {
                                    ...
                                    if (vCompanyReserved4 === 'WOWT01KR' || vCompanyReserved4 === 'MSTP01KR' || vCompanyReserved4 === 'KMCA01KR'
                                        || vCompanyReserved4 === 'DMEC01KR' || vCompanyReserved4 === 'SSCC1KR') {
                                    ...
                                    reserved_varchara = rec.get('reserved_varchara');
                                }

                                prWin.setLoading(true);
                                form.submit({
                                    url: CONTEXT_PATH + '/index/process.do?method=addWorkOrderGeneralFP',
                                    params: {
    ...
    pdfDownload: function (size, ac_uid, reportSelection, pos) {
        if (size > pos) {
            ...
            for (var i = 0; i < selections.length; i++) {
                ...
                unique_idArr += i == 0 ? unique_id : ',' + unique_id;
            }
            ...
            Ext.Ajax.request({
                ...
                params: {
                    rtgast_uid: 2,
                    rtgast_uids: unique_idArr,
                    po_no: '',
                    pcs_code: '',
                    ac_uid: ac_uid,
                    is_heavy: 'N',	 //중공업:Y  기타:N
