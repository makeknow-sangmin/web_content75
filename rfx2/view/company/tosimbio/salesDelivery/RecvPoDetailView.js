Ext.define('Rfx2.view.company.tosimbio.salesDelivery.RecvPoDetailView', {
    ...
    initComponent: function () {
                            ...
                            items: [
                                {
                                    ...
                                    items: [
...

                                        {
                                            ...
                                            listeners: {
                                                select: function (combo, record) {
                                                    gm.me().poDeCenterStore.getProxy().setExtraParam('combst_uid',gu.getCmp('order_com_unique').getValue());
                                                    gm.me().poDeCenterStore.load();
                                                }// endofselect
                                            }
                                        },

                                        // {
                                        //     id: gu.id('decenter_unique'),
                                        //     name: 'decenter_unique',
                                        //     fieldLabel: gm.me().getMC('msg_order_dia_order_customer', '물류센터'),
                                        //     allowBlank: false,
                                        //     xtype: 'combo',
                                        //     width: '45%',
                                        //     padding: '0 0 5px 30px',
                                        //     fieldStyle: 'background-image: none;',
                                        //     store: gm.me().poDeCenterStore,
                                        //     emptyText: gm.me().getMC('msg_order_dia_prd_empty_msg', '선택해주세요'),
                                        //     displayField: 'dscenter_name',
                                        //     valueField: 'unique_id',
                                        //     sortInfo: { field: 'wa_name', direction: 'ASC' },
                                        //     typeAhead: false,
                                        //     minChars: 1,
                                        //     listConfig: {
                                        //         loadingText: '검색중',
                                        //         emptyText: '일치되는 항목을 찾을수 없습니다..',
                                        //         getInnerTpl: function () {
                                        //             return '<div data-qtip="{dscenter_name}">{dscenter_name}</div>';
                                        //         }
                                        //     },
                                        //     listeners: {
                                        //         select: function (combo, record) {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                { text: 'No', width: 30, style: 'text-align:center', dataIndex: 'pl_no', sortable: false },
                ...
                { text: this.getMC('msg_order_grid_prd_desc', '제품코드'), width: 100, style: 'text-align:center', dataIndex: 'item_code', sortable: false },
                { text: '물류센터', width: 100, style: 'text-align:center', dataIndex: 'dscenter_name', sortable: false },
                ...
                //     }
                // },
                { text: '특이사항', width: 150, style: 'text-align:center', dataIndex: 'reserved1', editor: { xtype: 'textfield' }, sortable: false },
            ],
            ...
            handler: function (widget, event) {
                ...
                * */
                ...
                var saveForm = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        { text: gm.me().getMC('msg_product_add_dia_model', '모델명'), flex: 2, style: 'text-align:center', dataIndex: 'item_name', sortable: true },
                        ...
                        { text: gm.me().getMC('msg_product_add_search_field3', '단위'), flex: 2, dataIndex: 'unit_code', style: 'text-align:center', sortable: true },
                    ],
                        ...
                        handler: function (btn) {
                            ...
                            if (btn == "no") {
                                ...
                                for (var i = 0; i < items.length; i++) {
                                    var item = items[i];
                                    // var id = item.get('srcahd_uid');//판매단가관리안씀 -> store 다른거탐 -> uniqueid로 가져옴
    ...
    getPrdAdd: function () {
        var action = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                //2020.10.28 KNH. 제품등록시 입력해야하는 값들의 조건문 지움.
                ...
                * */
                ...
                var searchItemGrid = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        // { text: gm.me().getMC('msg_product_add_dia_div', '사업부'), flex: 0.5, style: 'text-align:center', dataIndex: 'division_code', sortable: true },
                        { text: gm.me().getMC('abc', '센터명'), flex: 0.5, style: 'text-align:center', dataIndex: 'buyer_name', sortable: true },
                        { text: gm.me().getMC('msg_product_add_dia_model', '품목명'), flex: 1.5, style: 'text-align:center', dataIndex: 'item_name', sortable: true },
                        // { text: gm.me().getMC('msg_order_grid_prd_desc', '기준모델'), flex: 1.0, style: 'text-align:center', dataIndex: 'description', sortable: true },
                        //{ text: gm.me().getMC('msg_product_add_search_field3', '규격'), flex: 1.8, style: 'text-align:center', dataIndex: 'specification', sortable: true },
                        {
                        ...
                        { text: gm.me().getMC('msg_order_grid_prd_currency', '단위'), flex: 0.5, style: 'text-align:center', dataIndex: 'unit_code', sortable: true },
                    ],
                    multiSelect: true,
                    pageSize: 100,
                    width: 700,
                ...
                var saveForm = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        ...
                        { text: gm.me().getMC('msg_product_add_search_field3', '단위'), flex: 1, dataIndex: 'unit_code', style: 'text-align:center', sortable: true },
    ...
    poDeCenterStore : Ext.create('Rfx2.store.company.sejun.DsCenterStore', {}),
