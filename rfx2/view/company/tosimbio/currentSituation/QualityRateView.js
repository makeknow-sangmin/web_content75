Ext.define('Rfx2.view.company.bioprotech.currentSituation.QualityRateView', {
    ...
    initComponent: function () {
        ...
        this.mainPanelState = Ext.create('Rfx2.store.company.bioprotech.QualityRateStore');
        ...
        this.mainPanel = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { 
                    ...
                    width: 100, 
                    style: 'text-align:center', 
                    dataIndex: 'previous_month_defect_ratio',
                    align : 'right',
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            align: 'right',
                            style: 'text-align:center;',
                            dataIndex: 'monthly_defect_ratio',
                            renderer: function (value, meta) {
                                // if (value >= 85) {
                                //     if (value == 100) {
                                //         meta.style = "background-color:white;color:black;text-align:right;text-format:0,000";
