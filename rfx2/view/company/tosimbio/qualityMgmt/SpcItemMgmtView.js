// 검사항목관리
Ext.define('Rfx2.view.company.bioprotech.qualityMgmt.SpcItemMgmtView', {
    ...
    initComponent: function () {
        ...
        this.addSpcChartButton = Ext.create('Ext.Action', {
            ...
            text: '신규등록',
            tooltip: '신규등록',
            hidden: gu.setCustomBtnHiddenProp('addSpcChartButton'),
            disabled: false,
            handler: function () {
        ...
        this.modifySpcItemButton = Ext.create('Ext.Action', {
            ...
            tooltip: '수정',
            hidden: gu.setCustomBtnHiddenProp('modifySpcItemButton'),
            disabled: true,
            handler: function () {
        ...
        this.deleteSpcItemButton = Ext.create('Ext.Action', {
            ...
            tooltip: '삭제',
            hidden: gu.setCustomBtnHiddenProp('deleteSpcItemButton'),
            disabled: true,
            handler: function () {
        ...
        this.subGridStore.getProxy().setExtraParam('orderBy', 'order_number');
            ...
            dockedItems: [
                {
                    ...
                    xtype: 'toolbar',
                    items: [
                        this.addSpcChartButton,
                        this.modifySpcItemButton, 
                        this.deleteSpcItemButton,
                    ]
                }
            ],
            columns: [
                {text: '검사종류', width: 80, style: 'text-align:center', dataIndex: 'process_type_kr2', sortable: false},
                {text: '항목', width: 200, style: 'text-align:center', dataIndex: 'legend_code_kr', sortable: false},
                {
                    text: '측정방식',
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'measuring_type_kr2',
                    sortable: false
                },
                {text: '단위', width: 70, style: 'text-align:center', dataIndex: 'unit_name', sortable: false},
                {text: '측정도구', width: 70, style: 'text-align:center', dataIndex: 'measuring_tool', sortable: false},
                {text: '측정기준', width: 200, style: 'text-align:center', dataIndex: 'inspection_standard', sortable: false},
                {text: '정렬순서', width: 70, style: 'text-align:center', dataIndex: 'order_number', sortable: false},
            ],
            // name: 'po',
            autoScroll: true
        });
        ...
        this.mesuringToolStore = Ext.create('Mplm.store.CommonCodeStore', {parentCode:'MEASURNIG_TOOL'});
    },
        ...
        var form = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                },
                {
                    fieldLabel: '측정도구',
                    xtype: 'combo',
                    id: gu.id('measuring_tool'),
                    name: 'measuring_tool',
                    store: gm.me().mesuringToolStore,
    ...
    modifySpcItemView: function () {
        ...
        console_logs('>>> aaa', rec);
        gm.me().spcChartTypeStore2.load();
        ...
        var form = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                },
                {
                    ...
                    id: 'inspection_standard',
                    name: 'inspection_standard',
                    value: rec.get('inspection_standard')
                },
                {
                    fieldLabel: '정렬순서',
                    xtype: 'numberfield',
