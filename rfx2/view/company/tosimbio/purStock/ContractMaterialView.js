Ext.define('Rfx2.view.company.tosimbio.purStock.ContractMaterialView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.tosimbio.ContractMaterial', [{
            property: 'unique_id',
            direction: 'DESC'
        }], gm.pageSize
            , {},
                ...
                if (selections.length > 0) {
                    ...
                    var form = Ext.create('Ext.form.Panel', {
                        ...
                        items: [
                            ...
                            // },
                             {
                                fieldLabel:  gm.me().getMC('msg_product_add_dia_price', '단가'),
                                xtype: 'textfield',
                                id: gu.id('sales_price'),
                                allowBlank: true,
                                name: 'sales_price',
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    text: '계약시작일', width: 100, style: 'text-align:center', editor: 'datefield', dataIndex: 'start_date', sortable: false,
                    renderer: Ext.util.Format.dateRenderer('Y-m-d')
                },
                {
                    text: '계약종료일', width: 100, style: 'text-align:center', editor: 'datefield', dataIndex: 'end_date', sortable: false,
                    renderer: Ext.util.Format.dateRenderer('Y-m-d')
                },
            ],
            title: '계약 업체 리스트',
        ...
        this.gridContractMaterial = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: this.getMC('msg_product_add_search_field3', '규격'), width: 200, style: 'text-align:center', dataIndex: 'concat_spec_desc', sortable: false },
                {
                    text: '계약단가', width: 100, style: 'text-align:center', dataIndex: 'sales_price', align: 'right', sortable: false,
                    editor: 'textfield',
                    renderer: function (value, context, tmeta) {
                        if (context.field == 'sales_price') {
                            context.record.set('sales_price', Ext.util.Format.number(value, '0,00/i'));
    ...
    searchStore: Ext.create('Rfx2.store.company.tosimbio.MaterialStore2', {})
});
