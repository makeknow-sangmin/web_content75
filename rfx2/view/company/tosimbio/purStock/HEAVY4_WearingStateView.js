Ext.define('Rfx2.view.company.chmr.purStock.HEAVY4_WearingStateView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField('desc_concat_spec');
                    ...
                    buttons: [
                        {
                            ...
                            //scope:this,
                            handler: function () {
                                var input_gr_date_year = gu.getCmp('gr_date').getValue().getFullYear();
                                var input_gr_date_month = gu.getCmp('gr_date').getValue().getMonth() + 1;
                                if(input_gr_date_month < 10) {
                                    input_gr_date_month = '0' + input_gr_date_month;
                                }
                                var input_gr_date_day = gu.getCmp('gr_date').getValue().getDate();
                                if(input_gr_date_day < 10) {
                                    input_gr_date_day = '0' + input_gr_date_day;
                                }
                                var input_val = input_gr_date_year + '-' + input_gr_date_month + '-'+ input_gr_date_day
                                Ext.Ajax.request({
                                    url: CONTEXT_PATH + '/quality/wgrast.do?method=changeGrDateSyncStohst',
                                    params: {
                                        unique_id : gm.me().grid.getSelectionModel().getSelection()[0].get('unique_id_long'),
                                        change_gr_date : input_val,
                                        before_gr_date :  gm.me().grid.getSelectionModel().getSelection()[0].get('gr_date'),
                                        before_gr_quan :  gm.me().grid.getSelectionModel().getSelection()[0].get('gr_qty'),
                                        change_gr_quan : gu.getCmp('gr_qty').getValue(),
                                        srcahd_uid : gm.me().grid.getSelectionModel().getSelection()[0].get('srcahd_uid'),
                                    },
                    ...
                    buttons: [{
                        ...
                        handler: function (btn) {
                            ...
                            if (btn == 'no') {
                                ...
                                Ext.Ajax.request({
                                    url: CONTEXT_PATH + '/sales/productStock.do?method=printBarcodeCommon',
        ...
        this.gridWearingState = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: '바코드', width: 200, style: 'text-align:center', dataIndex: 'unique_id', sortable: false}
            ],
            title: '상세',
            name: 'po',
            autoScroll: true,
