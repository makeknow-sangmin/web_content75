// 출하검사
Ext.define('Rfx2.view.company.hsct.qualManage.DeliveryInspectionView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField({
            ...
            text: "출하예정",
            sdate: new Date(),
            edate:Ext.Date.add(new Date(), Ext.Date.DAY, +7),
        });
        ...
        this.addPopupBtn = Ext.create('Ext.Action', {
            ...
            iconCls: 'af-save',
            text: '저장',
            tooltip: this.getMC('msg_btn_prd_add', '출하검사 저장'),
            // 비활성화
            // disabled: true,
            disabled: false,
            handler: function () {
        ...
        this.store.on('beforeload', function(store, operation, eOpts) {
            store.getProxy().setExtraParam('isResult', 'N');
          })
