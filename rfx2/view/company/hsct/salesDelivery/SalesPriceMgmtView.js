Ext.define('Rfx2.view.company.hsct.salesDelivery.SalesPriceMgmtView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.gongbang.SalesPriceMgmt', [{
                property: 'unique_id',
                direction: 'DESC'
            }], gm.pageSize
            , {},
        ...
        this.copySalesPriceAction = Ext.create('Ext.Action', {
            ...
            tooltip: '단가 갱신',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('copySalesPriceAction'),
            handler: function () {
                var mStore = Ext.create('Mplm.store.CombstStore', {pageSize: 2000});
                var cStore = Ext.create('Mplm.store.ComCstStore', {pageSize: 2000});
                var currencyStore = Ext.create('Mplm.store.CommonCodeExStore', {parentCode: "CURRENCY_GROUP"})
        ...
        this.modifySalesPriceAction = Ext.create('Ext.Action', {
            ...
            tooltip: '단가 수정',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('modifySalesPriceAction'),
            handler: function () {
                var mStore = Ext.create('Mplm.store.CombstStore', {pageSize: 2000});
                var cStore = Ext.create('Mplm.store.ComCstStore', {pageSize: 2000});
                var currencyStore = Ext.create('Mplm.store.CommonCodeExStore', {parentCode: "CURRENCY_GROUP"})
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
                        ...
                        '->',
                        {
                            ...
                            listeners: {
                                change: function (cb, newValue, oldValue, eOpts) {
                                    ...
                                    gm.me().salesPriceListStore.load();
                                }
            ...
            columns: [
                ...
                {
                    text: this.getMC('msg_product_add_dia_div', '사업부'),
                    width: 150,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_sales_price_contractname', '계약명'),
                    width: 150,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_sales_price_contractstart', '계약시작일'),
                    width: 100,
                    style: 'text-align:center',
                ...
                {
                    text: this.getMC('msg_sales_price_contractend', '계약종료일'),
                    width: 100,
                    style: 'text-align:center',
                    dataIndex: 'end_date',
                    sortable: false,
        ...
        this.gridContractMaterial = Ext.create('Ext.grid.Panel', {
            ...
            dockedItems: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'checkbox',
                            id: gu.id('is_end_buyer'),
                            fieldLabel: '종료포함',
                            listeners: {
                                change: function (cb, newValue, oldValue, eOpts) {
                                    // console_logs('cb>>>>>', newValue);
                                    if (newValue === true) {
                                        gm.me().salesPriceByCompanyListStore.getProxy().setExtraParam('end_date_not_view', 'N');
                                    } else {
                                        gm.me().salesPriceByCompanyListStore.getProxy().setExtraParam('end_date_not_view', 'Y');
                                    }
            ...
            columns: [
                {
                    text: this.getMC('msg_product_add_search_field1', gm.getMC('CMD_Product', '제품군')),
                    width: 100,
                    style: 'text-align:center',
        ...
        this.twoGrid.getSelectionModel().on({
            selectionchange: function (sm, selections) {
                ...
                if (selections.length) {
                    ...
                    var is_end = gu.getCmp('is_end_buyer').getValue();
        ...
        this.setGridOnCallback(function (selections) {
            ...
            if (selections.length) {
                ...
                var is_end = gu.getCmp('is_end').getValue();
                console_logs('>>>> is_end', is_end);
                this.salesPriceListStore.getProxy().setExtraParam('fix_type', 'SE');    // 판매용 단가 리스트 구분
                if (is_end === false) {
                    this.salesPriceListStore.getProxy().setExtraParam('end_date_not_view', 'Y');
                } else {
                    this.salesPriceListStore.getProxy().setExtraParam('end_date_not_view', 'N');
                }
