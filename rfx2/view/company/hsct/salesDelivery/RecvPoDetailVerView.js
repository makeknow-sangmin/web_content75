Ext.define('Rfx2.view.company.hsct.salesDelivery.RecvPoDetailVerView', {
    ...
    initComponent: function () {
                                    ...
                                    items: [
                                        {
                                            ...
                                            fieldLabel: gm.me().getMC('msg_order_dia_order_customer', '거래처'),
                                            allowBlank: false,
                                            xtype: 'combo',
                                            width: '45%',
                                        ...
                                        },
                                        {
                                            id: gu.id('uid_comcst'),
                                            name: 'uid_comcst',
                                            fieldLabel: gm.me().getMC('msg_sales_order_site', '소속'),
                                            xtype: 'combo',
                                            width: '45%',
                                            padding: '0 0 5px 30px',
                                            allowBlank: false,
                            ...
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    for (var j = 0; j < storeData.data.items.length; j++) {
                                        ...
                                        objv['uid_comcst'] = item.get('uid_comcst');
                                        objs.push(objv);
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: '단위', width: 70, style: 'text-align:center', dataIndex: 'unit_code', sortable: false },
                {
        ...
        var action = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                var searchItemGrid = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        {
                            text: gm.me().getMC('msg_product_add_dia_div', '고객사'),
                            flex: 1,
                            style: 'text-align:center',
                    ...
                    dockedItems: [
                        {
                            ...
                            items: [
                                {
                                    width : partGridWidth,
                                    field_id : 'search_buyer_name',
                                    id : gu.id('search_buyer_name'),
                                    name : 'search_buyer_name',
                                    xtype : 'triggerfield',
                                    emptyText : gm.me().getMC('msg_product_add_search_field1', '고객사'),
            ...
            handler: function (widget, event) {
                ...
                var searchItemGrid = Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        ...
                        {
                            text: gm.me().getMC('msg_product_start', '계약시작일'),
                            flex: 0.8,
                            style: 'text-align:center',
                        ...
                        {
                            text: gm.me().getMC('msg_product_start', '계약종료일'),
                            flex: 0.8,
                            style: 'text-align:center',
                            dataIndex: 'end_date',
                            format: 'Y-m-d',
    ...
    redrawSearchStore: function () {
        ...
        if (vCompanyReserved4 == 'SKNH01KR') {
            ...
            buyer_name = gu.getValue('search_buyer_name');
        }
        ...
        if(buyer_name.length > 0){
            store.getProxy().setExtraParam('buyer_name', buyer_name);
        }
