//출고요청 카트
Ext.define('Rfx2.view.company.hsct.stockMgmt.MyCartGoView', {
                            ...
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() === Ext.EventObject.ENTER) {
                                        gm.me().mtrlStore.getProxy().setExtraParam('item_code', '%'
                                            + gu.getCmp('srch_item_code').getValue() + '%');
                                        gm.me().mtrlStore.load();
                                    }
                                }
                            },
                        ...
                        },
                        {
                            ...
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() === Ext.EventObject.ENTER) {
                                        gm.me().mtrlStore.getProxy().setExtraParam('item_name', '%'
                                            + gu.getCmp('srch_item_name').getValue() + '%');
                                        gm.me().mtrlStore.load();
                                    }
                                }
                            },
                        ...
                        },
                        {
                            ...
                            listeners: {
                                specialkey: function (field, e) {
                                    if (e.getKey() === Ext.EventObject.ENTER) {
                                        gm.me().mtrlStore.getProxy().setExtraParam('specification', '%'
                                            + gu.getCmp('srch_specification').getValue() + '%');
                                        gm.me().mtrlStore.load();
                                    }
                                }
                            },
