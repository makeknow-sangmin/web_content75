//출고확인
Ext.define('Rfx2.view.company.hsct.stockMgmt.GoRequestRptView', {
    ...
    initComponent: function () {
        ...
        this.printPDFAction = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                // var cartmap_uid = gm.me().grid.getSelectionModel().getSelection()[0].get('uid_comcst');
        ...
        buttonToolbar.insert(4, this.modifyGoAction);
