//주문작성
Ext.define('Rfx2.view.company.hsct.fopurchaseMgmt.CreatePoView', {
    ...
    initComponent: function () {
        ...
        // 반려 Action
        this.removePrAction = Ext.create('Ext.Action',{
            iconCls : 'af-remove',
            text : '반려',
            tooltip : '반려',
            disabled : true,
                                ...
                                fn: function (result) {
                                    if (result == 'yes') {
                                        ...
                                        for(var i = 0; i < selections.length; i++){
                                            ...
                                            var uniqueuid = rec.get('cartmap_uid');
                                        }
        ...
        buttonToolbar.insert(2, this.removePrAction);
        ...
        this.store.getProxy().setExtraParam('sp_code','G');
