Ext.define('Rfx2.view.company.bioprotech.criterionInfo.ProcessCodeMachineView', {
    ...
    initComponent: function () {
        ...
        this.createAddChildProcessAction = Ext.create('Ext.Action', {
            ...
            tooltip: '소공정 추가',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('createAddChildProcessAction'),
            handler: function () {
        ...
        this.modifyChildProcessAction = Ext.create('Ext.Action', {
            ...
            tooltip: '소공정 수정',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('modifyChildProcessAction'),
            handler: function () {
        ...
        this.removeChildProcessAction = Ext.create('Ext.Action', {
            ...
            tooltip: '소공정 삭제',
            disabled: true,
            hidden: gu.setCustomBtnHiddenProp('removeChildProcessAction'),
            handler: function () {
                var selection = gm.me().gridPcsstd.getSelectionModel().getSelection();
                var rec = selection[0];
                console_logs('rec >>>>> ', rec);
