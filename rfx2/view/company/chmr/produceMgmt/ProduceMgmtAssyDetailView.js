Ext.define('Rfx2.view.company.chmr.produceMgmt.ProduceMgmtAssyDetailView', {
    ...
    initComponent: function () {
        ...
        this.addSearchField('item_name_concat_desc');
        this.addSearchField({
            type: 'text',
        ...
        this.createStore('Rfx2.model.company.chmr.ProductMgmtAssy', [{
            property: 'unique_id',
            direction: 'DESC'
        }],
            gMain.pageSize
        ...
        this.setRowClass(function (record, index) {
            var s = record.get('stock_qty');
            var o = record.get('sloast_po_qty_sum');
            if(o > s) {
                return 'red-row';
            }
        });
        ...
        this.gridContractMaterial = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                // { text: '품명', width: 100, style: 'text-align:center', dataIndex: 'item_name', sortable: true },
                // { text: '규격', width: 200, style: 'text-align:center', dataIndex: 'concat_spec_desc', sortable: true },
                { text: '내용', width: 150, style: 'text-align:center', dataIndex: 'change_reason', sortable: true },
                { text: '수정이력', width: 250, style: 'text-align:center', dataIndex: 'change_history', sortable: true },
            ],
            title: '계획변동이력',
            name: 'po',
            autoScroll: true,
        ...
        this.setGridOnCallback(function (selections) {
            if (selections.length) {
                ...
                this.productPlanStore.getProxy().setExtraParam('srcahd_uid', rec.get('unique_id_long'));
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        //     name: 'mix_rate',
                        //     anchor: '100%',
                        //     fieldLabel: '<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span>' + '배합비율 선택',
                        //     width: '99%',
                        //     editable: true,
                        //     displayField: 'item_name',
                        //     store: gm.me().mixratioStore,
    ...
    mixratioStore : Ext.create('Rfx2.store.company.chmr.BomverListStore', {}),
    productPlanStore: Ext.create('Rfx2.store.company.sejun.ProductChangeHistoryStore', { pageSize: 100000 })
    // searchItemStore: Ext.create('Mplm.store.BomverListStore', {}),
});