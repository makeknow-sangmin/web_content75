Ext.define('Rfx2.view.company.chmr.produceMgmt.ProduceWorkOrderView', {
    ...
    initComponent: function () {
        ...
        this.createStore('Rfx2.model.company.chmr.ProduceWorkOrder', [{
                    ...
                    Ext.MessageBox.show({
                        ...
                        fn: function (btn) {
                            if (btn == "no") {
                                ...
                                form.submit({
                                    url: CONTEXT_PATH + '/index/process.do?method=addWorkOrderPlanPrd',
                                    params: {
