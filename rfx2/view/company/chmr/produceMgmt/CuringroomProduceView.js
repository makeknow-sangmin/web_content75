Ext.define('Rfx2.view.company.chmr.produceMgmt.CuringroomProduceView', {
    ...
    initComponent: function () {
        ...
        this.downloadSheetAction = Ext.create('Ext.Action', {
            ...
            handler: function () {
                ...
                var store = Ext.create('Rfx2.store.company.chmr.CuringStateXlsxStore', {});
                ...
                // store.getProxy().setExtraParam('pcsmchn_uid', rec.get('unique_id_long'))
                store.getProxy().setExtraParam("menuCode", 'SDL5_CURING_EXL');
