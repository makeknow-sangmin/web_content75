//설비현황
Ext.define('Rfx2.view.company.chmr.produceMgmt.ProductPerformStateView', {
    ...
    initComponent    : function () {
        ...
        this.printProduceResult = Ext.create('Ext.Action', {
            ...
            disabled: false,
            handler : function () {
                const dateRangeId = 'SRO5_PERFORM' + '-' + gMain.getSearchField('produce_start_date');
        ...
        this.downloadSheetActionByProduct = Ext.create('Ext.Action', {
            ...
            handler : function () {
                ...
                store.getProxy().setExtraParam("start_date", sDate);
                store.getProxy().setExtraParam("end_date", eDate);
