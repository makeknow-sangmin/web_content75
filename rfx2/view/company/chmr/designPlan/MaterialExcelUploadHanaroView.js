Ext.define('Rfx2.view.company.chmr.designPlan.MaterialExcelUploadHanaroView', {
    ...
    initComponent: function(){
        ...
        this.saveAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
   			 handler: function() {
   				Ext.Ajax.request({
             		url : CONTEXT_PATH + '/sales/excelRecvPo.do?method=createSrcahdMaterialBuffer',
         			params:{
		...
		var excel_sample = Ext.create('Ext.Action', {
			...
			handler : function(widget, event) {
				...
				switch (lang) {
				case 'ko':
					path = vContent_full_path + '/cab/chrm_item_upload_file.xlsx'; // 상대경로 사용
					break;
				case 'zh':
					path = vContent_full_path + '/cab/chrm_item_upload_file.xlsx';
					break;
				case 'en':
					path = vContent_full_path + '/cab/chrm_item_upload_file.xlsx';
					break;
