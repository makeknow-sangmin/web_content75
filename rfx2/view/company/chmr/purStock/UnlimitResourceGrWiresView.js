Ext.define('Rfx2.view.company.chmr.purStock.UnlimitResourceGrWiresView', {
    ...
    initComponent: function () {
        ...
        //모델을 통한 스토어 생성
        this.createStore('Rfx.model.UnlimitMaterialGrWires', [{
            property: 'unique_id',
            direction: 'ASC'
        }],
            gm.pageSize
        ...
        this.unlimitMatGr = Ext.create('Ext.Action', {
            ...
            handler: function () {
                ...
                var contractStore =  Ext.create('Rfx2.store.company.kbtech.ContractMaterialStore', { pageSize: 100000 });
                contractStore.getProxy().setExtraParam('srcahd_uid', select.get('srcahd_uid'));
                contractStore.getProxy().setExtraParam('fix_type', 'PR');
                contractStore.load();
                                        ...
                                        },
                                        {
                                            ...
                                            listConfig: {
                                                ...
                                                getInnerTpl: function () {
                                                    return '<div data-qtip="{supplier_code}">[{supplier_code}] {supplier_name}</div>';
                                                }
                                            }
                                        },
                                        // {
                        ...
                        handler: function (btn) {
                            if (btn == "no") {
                                ...
                                if (form.isValid()) {
                                    ...
                                    form.submit({
                                        url: CONTEXT_PATH + '/quality/wgrast.do?method=goodsReceiptNopoWires',
                                        params: {
