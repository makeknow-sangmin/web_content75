Ext.define('Rfx2.view.company.chmr.salesDelivery.SalesPriceMgmtView', {
    ...
    initComponent: function () {
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    text: this.getMC('msg_product_add_dia_price', '판매단가'), width: 100, style: 'text-align:center', dataIndex: 'sales_price', sortable: false,
                    //editor: 'textfield'
                },
                {
        ...
        this.gridContractMaterial = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                { text: this.getMC('msg_product_add_search_field1', gm.getMC('CMD_Product', '제품군')), width: 100, style: 'text-align:center', dataIndex: 'class_name', sortable: true },
        ...
        this.govPriceStore = Ext.create('Rfx2.store.company.chmr.ProduceStateByPlanStore', { pageSize: 100 });
        // this.govPriceStore.getProxy().setExtraParams('isModelNo','true');
        this.govPriceStore.load();
        // this.govPriceStore.sorters.removeAll();
        ...
        var lastContainer = new Ext.container.Container({
            title: '관급단가표',
            region: 'center',
            layout: {
                type: 'border'
        ...
        var mainTab = Ext.widget('tabpanel', {
            ...
            region: 'center',
            tabPosition: 'top',
            items: [leftContainer, rightContainer, lastContainer]
        });
