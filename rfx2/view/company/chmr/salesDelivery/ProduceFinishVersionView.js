//생산완료 현황
Ext.define('Rfx2.view.company.chmr.salesDelivery.ProduceFinishVersionView', {
    ...
    initComponent: function () {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    listConfig: {
                                        ...
                                        emptyText: '일치하는 항목 없음',
                                        getInnerTpl: function () {
                                            return '<div data-qtip="{shipment_type}">{ship_kr}</div>';
                                        }
                                    }
                                }
                            ]
        ...
        this.gridContractCompany = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: '현장명', width: 300, style: 'text-align:center', dataIndex: 'pj_name'/*, sortable: false*/ },
                { text: '고객사', width: 300, style: 'text-align:center', dataIndex: 'final_wa_name'/*, sortable: false*/ },
                ...
                { 
                    ...
                    decimalPrecision: 5, dataIndex: 'sales_price'/*, sortable: false*/, 
                    align: 'right',
                    renderer: function (value, context, tmeta) {
                        return Ext.util.Format.number(value, '0,00/i');
                    }, 
