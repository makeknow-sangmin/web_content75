//자재 관리
Ext.define('Rfx2.view.company.chmr.stockMgmt.StocktakingView', {
        ...
        */
        ...
        this.downloadSheetActionResource = Ext.create('Ext.Action', {
            ...
            handler: function () {
                ...
                store.getProxy().setExtraParam("menuCode", 'PMS2_EXL_MAT');
        ...
        buttonToolbar.insert(1, this.downloadSheetActionResource);
