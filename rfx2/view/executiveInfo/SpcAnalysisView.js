Ext.define('Rfx2.view.executiveInfo.SpcAnalysisView', {
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            html: '<div style="height:370px;" id='
                            + gu.id('chartSpc1') + '></div><hr><div style="height:370px;" id='
                            + gu.id('chartSpc2') + '></div>',
                            flex: 0.4
                        }
                    ]
            ...
            critPointStore.load(function(record2) {
                ...
                for (var i = 0; i < record.length; i++) {
                    ...
                    if (record[i].get('v002') == gm.me().v010_1) {
                        ...
                        unit_name_1 = record[i].get('unit_name');
                        ...
                        unit_name_2 = record[i].get('unit_name');
