Ext.define('Rfx2.view.executiveInfo.SpcDataSettingsView', {
    extend: 'Rfx2.base.BaseView',
    xtype: 'spc-data-settings-view',
    temper: 1,
            ...
            items: [
                {
                    ...
                    items: [{
                        ...
                        fieldLabel: '구분',
                        items: [
                            {boxLabel: 'Despooling', name: 'radio1', inputValue: 'DPMO', checked: true},
                            {boxLabel: '열처리 린스', name: 'radio1', inputValue: 'PPM'}
                        ],
                        listeners: {
                    ...
                    items: [
                        {
                            items: [{
                                ...
                                tbar: [{
                                    text: "업로드",
                                    handler: function () {
                                        console_logs('>>>ddddddd', gMain.menu_check);
                                        ...
                                        for (var i = 0; i < l_store.data.items.length; i++) {
                                            if (!(l_store.getData().getAt(i).data.status === "완료")) {
                                                ...
                                                gm.me().postDocument(CONTEXT_PATH + '/xdview/spcMgmt.do?method=uploadSpcMaterial&file_itemcode=' + gUtil.RandomString(10),
                                                    l_store, i, tabname);
                                            }
                                        }
