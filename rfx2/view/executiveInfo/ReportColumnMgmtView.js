Ext.define('Rfx2.view.executiveInfo.ReportColumnMgmtView', {
    ...
    initComponent: function(){
        ...
        this.storeViewTable.getProxy().setExtraParam('class_code', 'Q1REPORT');
                ...
                if(rec!=null) {
                    ...
                    storeSampleProperty.load(function() {
                        if(storeSampleProperty.getAt(0) != null) {
                            ...
                            Ext.getCmp('sampleForm9').loadRecord(storeSampleProperty.getAt(0));
                            ...
                            Ext.getCmp('sampleForm9').getForm().reset(true);
                        }
                    });
                } else {
                    saveAction.disable();
        ...
        var saveSampleAction = Ext.create('Ext.Action', {
            ...
            disabled: true,
            handler: function() {
                gm.me().saveSample(gridViewTable, FormSampleInfo3, FormSampleInfo6,
                    FormSampleInfo7,FormSampleInfo8, FormSampleInfo9);
            }
        });
       ...
       var FormSampleInfo7 = Ext.create('Ext.form.Panel', {
            ...
            items: [
                {
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Density' , style: {'text-align': 'center'}, width: 100},
                        {
                            style: {'text-align': 'right'},minValue: 1,
                            fieldLabel: 'Density',
                            xtype:'numberfield',
        ...
        var FormSampleInfo9 = Ext.create('Ext.form.Panel', {
            // renderTo: document.body,
            id: 'sampleForm9',
            // height: 350,
            width: '100%',
            ...
            items: [
                {
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random1' , style: {'text-align': 'center'}, width:100},
                        {
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random2' , style: {'text-align': 'center'}, width:100},
                        {
                            style: {'text-align': 'right'},
                            fieldLabel: 'Min',
                            xtype:'numberfield',
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random3' , style: {'text-align': 'center'}, width:100},
                        {
                            style: {'text-align': 'right'},
                            fieldLabel: 'Min',
                            xtype:'numberfield',
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random4' , style: {'text-align': 'center'}, width:100},
                        {
                            style: {'text-align': 'right'},
                            fieldLabel: 'Min',
                            xtype:'numberfield',
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random5' , style: {'text-align': 'center'}, width:100},
                        {
                            style: {'text-align': 'right'},
                            fieldLabel: 'Min',
                            xtype:'numberfield',
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random6' , style: {'text-align': 'center'}, width:100},
                        {
                            style: {'text-align': 'right'},
                            fieldLabel: 'Min',
                            xtype:'numberfield',
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random7' , style: {'text-align': 'center'}, width:100},
                        {
                            style: {'text-align': 'right'},
                            fieldLabel: 'Min',
                            xtype:'numberfield',
                    ...
                    margin: '3 3 3 3',
                    items:[
                        {xtype: 'tbtext', text: 'Random8' , style: {'text-align': 'center'}, width:100},
                        {
                            style: {'text-align': 'right'},
                            fieldLabel: 'Min',
                            xtype:'numberfield',
