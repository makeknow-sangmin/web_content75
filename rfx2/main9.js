...
// 		            });
	...
	Ext.onReady(function(){
		...
		//Main();
		console_logs('create Main', 'start');
		...
		if(jsonLeftMenuStruct!='') {
			...
			//console.log('이거 모냐2', lmenuStruct);
	...
	function createTopMenu() {
		...
		if(vUse_workspace == true) {
			...
			var createNewnote = function(a,b,c) {
				...
				//console_logs('selMainPanelName', gm.selMainPanelName);
			    ...
			    items: [{
			        ...
			        handler: function() {
						...
						mm.getLastId(function(lastUid) {
							...
							console_logs('group_code lastUid', lastUid);
			                ...
			                me.mon(me.uploadDialog, 'uploadcomplete', function(uploadPanel, manager, items, errorCount) {
			                	...
			                	console_logs('this.mon uploadcomplete lastUid', me.lastUid);
