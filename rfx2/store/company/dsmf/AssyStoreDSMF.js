Ext.define('Rfx2.store.company.dsmf.AssyStoreDSMF', {
    ...
    proxy : {
        type : 'ajax',
        url : CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahd&standard_flag=A&sp_code_list=FG&limit=20',  // &sg_code=AASSY
        reader : {
            type : 'json',
            root : 'datas',
            totalProperty : 'count',
