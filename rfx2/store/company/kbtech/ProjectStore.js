Ext.define('Rfx2.store.company.kbtech.ProjectStore', {
    ...
    proxy : {
        type : 'ajax',
        url : CONTEXT_PATH + '/design/project.do?method=readProject',
        reader : {
            type : 'json',
            root : 'datas',
            totalProperty : 'count',
    ...
    listeners: {
        ...
        beforeload: function(){
            if(this.srchNull){
                ...
                if(this.cmpName!=null){
                    console_logs('Mplm.store.readProject beforeload', this.cmpName);
