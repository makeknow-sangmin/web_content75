Ext.define('Rfx2.store.company.hanjung.WthInTypeStore', {
    ...
    proxy : {
        type : 'ajax',
        url : CONTEXT_PATH + '/account/arap.do?method=readWithdrawList&type=I&type_list=I,CAR,SVP,VAP,CSV,CVP,SVP,SAP,ETP,CSP,RFP',
        reader : {
            type : 'json',
            root : 'datas',
            totalProperty : 'count',
