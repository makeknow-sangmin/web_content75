Ext.define('Rfx2.store.company.hanjung.WthOutTypeAllStore', {
    ...
    proxy : {
        type : 'ajax',
        url : CONTEXT_PATH + '/account/arap.do?method=readWithdrawList&type=O&type_list=M,O,S,P,E,R,UP,AN,ETWP,SVWP,VAWP,EXM',
        reader : {
            type : 'json',
            root : 'datas',
            totalProperty : 'count',
