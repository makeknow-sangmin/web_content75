Ext.define('Rfx2.store.company.hanjung.StockLineSearchStore', {
    ...
    proxy : {
        type : 'ajax',
        url: CONTEXT_PATH + '/inventory/prchStock.do?method=readStockWithWhouse&not_sp_code_list=PRD&standard_flag=R',
        reader : {
            type : 'json',
            root : 'datas',
            totalProperty : 'count',
