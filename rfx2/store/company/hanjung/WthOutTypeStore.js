Ext.define('Rfx2.store.company.hanjung.WthOutTypeStore', {
    ...
    proxy : {
        type : 'ajax',
        url : CONTEXT_PATH + '/account/arap.do?method=readWithdrawList&type=O&type_list=M,O,S,P,E,R,UP,AN,EXM,CAR,CSP,CSV,CVP,ETP,RFP,SAP,SVP',
        reader : {
            type : 'json',
            root : 'datas',
            totalProperty : 'count',
