Ext.define('Rfx2.model.RecvMgmtVerBioProtech', {
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            //read: CONTEXT_PATH + '/sales/poreceipt.do?method=cloudread&menu_code=EPJ2', /*1recoed, search by cond, search */
            read: CONTEXT_PATH + '/production/schdule.do?method=readAssyTopVer&not_restart=Y&not_cancel_po_dc=Y&sortCond=p.pj_code DESC',
