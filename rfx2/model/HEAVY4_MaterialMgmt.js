Ext.define('Rfx2.model.HEAVY4_MaterialMgmt', {

    extend: 'Rfx.model.Base',
    proxy: {
        type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahd&standard_flag=R&orderBy=item_code', /*1recoed, search by cond, search */
