Ext.define('Rfx2.model.company.tosimbio.HEAVY4_MaterialMgmt', {

    extend: 'Rfx.model.Base',
    proxy: {
        type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahd&orderBy=item_code&sp_code_list=M,S,B', /*1recoed, search by cond, search */
