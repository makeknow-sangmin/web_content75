Ext.define('Rfx2.model.company.bioprotech.MaterialSplit', {

    extend: 'Rfx.model.Base',
    proxy: {
        type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahd&exchange_flag=M', /*1recoed, search by cond, search */
