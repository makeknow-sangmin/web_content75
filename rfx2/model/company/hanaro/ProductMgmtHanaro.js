Ext.define('Rfx2.model.company.hanaro.ProductMgmtHanaro', {
	
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/sales/poreceipt.do?method=getHanaroManufact&standard_flag=A&sg_code=BOM&bom_flag=T', /*1recoed, search by cond, search */
