Ext.define('Rfx2.model.company.daeji.ProductVerMgmt', {

    extend: 'Rfx.model.Base',
    proxy: {
        type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahdWithBomVer&standard_flag=A&sp_code_list=E', /*1recoed, search by cond, search */
