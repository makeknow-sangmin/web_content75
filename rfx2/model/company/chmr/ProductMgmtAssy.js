Ext.define('Rfx2.model.company.chmr.ProductMgmtAssy', {

    extend: 'Rfx.model.Base',
    proxy: {
        type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahdWithBom&standard_flag=A&sp_code_list=P&ctr_flag=G', /*1recoed, search by cond, search */
