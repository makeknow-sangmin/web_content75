Ext.define('Rfx2.model.company.chmr.ProductMgmt', {

    extend: 'Rfx.model.Base',
    proxy: {
        type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahdWithBom&standard_flag=A&sp_code_listC=F,G,H,A&orderBy=stosum.disorder', /*1recoed, search by cond, search */
