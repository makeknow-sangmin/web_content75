Ext.define('Rfx2.model.company.kbtech.MaterialMgmt', {
	
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahdWithBom&not_sp_code_list=KA,KB,KC,KL', /*1recoed, search by cond, search */
