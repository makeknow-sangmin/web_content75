Ext.define('Rfx2.model.company.dsmf.MaterialMgmt', {
	
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahdWithBom&not_sp_code_list=TOP,DSU,DSR,DSC&standard_flag=R', /*1recoed, search by cond, search */
