Ext.define('Rfx2.model.company.sejun.ProductStock', {
    ...
    proxy: {
        ...
        api: {
           // read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahd&sp_code_list=G,F,H', /*1recoed, search by cond, search */
            read: CONTEXT_PATH + '/inventory/prchStock.do?method=readStockWithWhouse&not_sp_code_list=S,K,H,R&orderBy=sp_code&&ascDesc=desc',
