Ext.define('Rfx2.model.ProductMgmtExtend', {
	
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readExtendSrcahd&standard_flag=A&extend=true', /*1recoed, search by cond, search */
