...
(function() {
    ...
    var scriptEls = document.getElementsByTagName('script'),
        ...
        themeName = (getQueryParam('theme') || 'crisp' /*'triton'*/).replace(/^([-A-Za-z]*)(.*)/, '$1'),
        ...
        themePackageDir, sdkRoot, d3JS, uxJS, chartsJS, themeOverrideJS, extPrefix, extPackagesRoot, exporterJS;
    ...
    var extPackagesRootGpl = 'http://hosu.io/ext-6.7.0/build/';
    var sdkRootGpl = 'http://hosu.io/ext-6.7.0/';
    ...
    exporterJS = extPackagesRoot + '/packages/exporter/build/' + toolkit + '/exporter.js';

    if (includeCSS) {
        loadCss(extPackagesRootGpl + 'classic/theme-crisp/resources/theme-' + themeName + '-all' + cssSuffix);
        if (toolkit === 'modern') {
            loadCss(extPackagesRootGpl + '/packages/charts/modern/modern-' + themeName + '/resources/charts-all' + cssSuffix);
        } else {
            loadCss(extPackagesRootGpl + '/packages/charts/' + toolkit + '/' + themeName + '/resources/charts-all' + cssSuffix);
        }
        loadCss(extPackagesRootGpl + '/packages/ux/' + toolkit + '/' + themeName + '/resources/ux-all' + cssSuffix);
        if (devMode === 2) {
