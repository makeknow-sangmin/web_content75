Ext.define('Rfx.model.MtrlbuyMgmtK', {
	
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readSalesMap&not_standard_flag=A&item_code_is_not_null=Y'/*&class_code_is_null=Y'*/, /*&class_code_is_null=Y*//*1recoed, search by cond, search */
