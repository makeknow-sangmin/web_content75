Ext.define('Rfx.model.Heavy4MaterialMgmtPnl', {
	
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/purchase/material.do?method=readHeavy&not_standard_flag=T&not_sp_code=P', /*1recoed, search by cond, search */
