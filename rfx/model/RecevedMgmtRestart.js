Ext.define('Rfx.model.RecevedMgmtRestart', {
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            //read: CONTEXT_PATH + '/sales/poreceipt.do?method=cloudread&menu_code=EPJ2', /*1recoed, search by cond, search */
            read: CONTEXT_PATH + '/production/schdule.do?method=readAssyTop&sp_code=PRD&reserved20=Y&orderBy=change_date&ascDesc=DESC',
