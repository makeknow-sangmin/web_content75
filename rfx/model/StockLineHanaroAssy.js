Ext.define('Rfx.model.StockLineHanaroAssy', {
 extend: 'Rfx.model.Base',
    proxy: {
		type: 'ajax',
        api: {
            read: CONTEXT_PATH + '/inventory/prchStock.do?method=readStock&standard_flag=R&sg_code=ASSY', /*1recoed, search by cond, search */
