Ext.define('Rfx.model.RapMgmt', {
	
    extend: 'Rfx.model.Base',
       proxy: {
           type: 'ajax',
           api: {
               read: CONTEXT_PATH + '/sales/poreceipt.do?method=getSeriesManufact&standard_flag=A&sg_code=BOM&bom_flag=T', /*1recoed, search by cond, search */
