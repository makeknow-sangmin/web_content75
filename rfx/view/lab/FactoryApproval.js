 ...
 */
Ext.define('Rfx.view.lab.FactoryApproval', {
    extend: 'Rfx.base.BaseView',
    xtype: 'factory-approval-view',
    initComponent: function(){
		...
		switch(vSYSTEM_TYPE) {
		case 'MES':
			this.setDefComboValue('gubun', 'valueField', 'FA');//ComboBOX의 ValueField 기준으로 디폴트 설정.
			break;
		case 'PLACE':
		...
		this.store.getProxy().setExtraParam('gubun', 'FA');
	...
	createWest: function() {
		...
		this.grid.getSelectionModel().on({
			selectionchange: function(sm, selections) {
				...
				gm.me().docuStore.getProxy().setExtraParam('menu_code', 'FAC1');
