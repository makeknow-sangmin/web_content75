 ...
 */
Ext.define('Rfx.view.lab.IntelProperty', {
    extend: 'Rfx.base.BaseView',
    xtype: 'intel-property-view',
    initComponent: function(){
		...
		switch(vSYSTEM_TYPE) {
		case 'MES':
			this.setDefComboValue('gubun', 'valueField', 'IP');//ComboBOX의 ValueField 기준으로 디폴트 설정.
			break;
		case 'PLACE':
		...
		this.store.getProxy().setExtraParam('gubun', 'IP');
	...
	createWest: function() {
		...
		this.grid.getSelectionModel().on({
			selectionchange: function(sm, selections) {
				...
				gm.me().docuStore.getProxy().setExtraParam('menu_code', 'IPR1');
