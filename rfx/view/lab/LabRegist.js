 ...
 */
Ext.define('Rfx.view.lab.LabRegist', {
    extend: 'Rfx.base.BaseView',
    xtype: 'lab-regist-view',
    initComponent: function(){
		...
		switch(vSYSTEM_TYPE) {
		case 'MES':
			this.setDefComboValue('gubun', 'valueField', 'L');//ComboBOX의 ValueField 기준으로 디폴트 설정.
			break;
		case 'PLACE':
		...
		this.store.getProxy().setExtraParam('gubun', 'L');
	...
	createWest: function() {
		...
		this.grid.getSelectionModel().on({
			selectionchange: function(sm, selections) {
				...
				gm.me().docuStore.getProxy().setExtraParam('menu_code', 'LAB1');
