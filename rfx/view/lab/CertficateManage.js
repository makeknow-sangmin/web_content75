 ...
 */
Ext.define('Rfx.view.lab.CertficateManage', {
    extend: 'Rfx.base.BaseView',
    xtype: 'certificate-manage-view',
    initComponent: function(){
		...
		switch(vSYSTEM_TYPE) {
		case 'MES':
			this.setDefComboValue('gubun', 'valueField', 'CM');//ComboBOX의 ValueField 기준으로 디폴트 설정.
			break;
		case 'PLACE':
		...
		this.store.getProxy().setExtraParam('gubun', 'CM');
	...
	createWest: function() {
		...
		this.grid.getSelectionModel().on({
			selectionchange: function(sm, selections) {
				...
				gm.me().docuStore.getProxy().setExtraParam('menu_code', 'CFC1');
