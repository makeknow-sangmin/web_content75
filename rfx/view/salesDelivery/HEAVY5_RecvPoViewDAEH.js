//수주관리 메뉴
Ext.define('Rfx.view.salesDelivery.HEAVY5_RecvPoViewDAEH', {
    extend: 'Rfx.base.BaseView',
    xtype: 'heavy5-recvPoDaeh-view',
    /*requires: [
		'Ext.grid.*',
		'Ext.data.*',
...
//	    }
        ...
        default:
        	this.createStoreSimple({
        		modelClass: 'Rfx.model.HEAVY5RecvPoSubViewModel',
    	        pageSize: 100,//gMain.pageSize,
    	        sorters: [{
...
//                 });
      ...
      //group Action 생성
        ...
        default :
        	...
        	buttonToolbar.insert(5, this.barcodeAction);
            buttonToolbar.insert(5, '-');
            break;
        }
