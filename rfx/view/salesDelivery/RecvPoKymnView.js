//수주관리 메뉴
Ext.define('Rfx.view.salesDelivery.RecvPoKymnView', {
    ...
    initComponent: function() {
        ...
        var multiToolbar =  this.createMultiSearchToolbar({first:3, length:4});
            ...
            handler: function() {
                switch(parent_code) {
                    case "SRO5_DS":
                        ...
                        var cannot_produce = false;
                        for(var i = 0; i < selections.length; i++) {
                            if((selections[i].get("can_produce") == "자재미입고") || selections[i].get("can_produce") == "BOM미등록") {
                                cannot_produce = true;
                            }
                        }
                        ...
                        if (!cannot_produce) {
                            ...
                            Ext.MessageBox.alert('알림', '하위 자재를 등록하지 않았거나, 미입고 상태입니다.');
                        }
                        break;
                    case "SRO5_KM":
                    case "SRO5_KM3":
                        ...
                        for(var i=0; i<gUtil.mesTplProcessBig.length; i++) {
                            ...
                            /*if(parent_code == 'SRO5_KM' || parent_code == 'SRO5_DS7') {
                            ...
                            buttons: [
                                {text: CMD_OK,
                                    ...
                                    handler:function(){
                                        ...
                                        gMain.selPanel.doRequest(form.getValues(), prWin);
        ...
        switch(vCompanyReserved4){
            ...
            default :
                ...
                buttonToolbar.insert(3, this.requestAction);
                break;
        }
        ...
        switch(this.link){
            ...
            case "SRO5_KM" :
                ...
                //this.store.getProxy().setExtraParam('order_com_unique', 79070000002);
                this.store.getProxy().setExtraParam('status', "BM");
                this.store.getProxy().setExtraParam('pj_type', 'ST');
            ...
            case "SRO5_KM3" :
                ...
                //this.store.getProxy().setExtraParam('order_com_unique', 79070000002);
                this.store.getProxy().setExtraParam('status', "BM");
                this.store.getProxy().setExtraParam('pj_type', 'SS');

                break;
            default :
                this.store.getProxy().setExtraParam('order_com_unique',  -1);
                this.store.getProxy().setExtraParam('pj_type',  'P');
                break;
        }
        //디폴트 로드
...
//		Ext.getCmp(	this.link + '-'+ 'grid-top-paperQty' ).setText('원지수량: ' + bm_quan1);
    ...
    //구매/제작요청
    doRequest: function(big_pcs_codes) {
