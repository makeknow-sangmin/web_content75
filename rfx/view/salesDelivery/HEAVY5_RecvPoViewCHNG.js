//수주관리 메뉴
Ext.define('Rfx.view.salesDelivery.HEAVY5_RecvPoViewCHNG', {
   ...
   // Heavy_attachform: null,
    ...
    initComponent: function(){
		...
		this.addSearchField({
			...
			field_id: 'pj_name',       // js에서의 필드 명
			fieldName: 'pj_name' //실재 Table Field Name
		});
		this.addSearchField({
			type: 'distinct',
			width: 140,
			tableName: 'project', //Table 명
			field_id: 'pj_reserved_varchar2',       // js에서의 필드 명
			fieldName: 'reserved_varchar2' //실재 Table Field Name
		});
		this.addSearchField({
			type: 'distinct',
			width: 140,
			tableName: 'srcahd', //Table 명
			field_id: 'item_name',       // js에서의 필드 명
			fieldName: 'item_name' //실재 Table Field Name
		});
		this.addSearchField({
			type: 'distinct',
			width: 140,
		...
		this.addSearchField({
			...
			field_id: 'h_reserved3',       // js에서의 필드 명
			fieldName: 'h_reserved3' //실재 Table Field Name
		});
	            ...
	            items   : [
	                       {
	                           ...
	                           xtype: 'fieldcontainer',
	                           fieldLabel: gMain.selPanel.bigPcscode,
	                           combineErrors: true,
	                           msgTarget : 'side',
	                           layout: 'hbox',
	                           defaults: {
	                           ...
	                           items: [
	                               {
	                                   ...
	                                   name      : 'pcs_code',
	                                   margin: '0 5 0 0',
	                                   value : gMain.selPanel.bigPcscode,
	                                   width: 150,
	                                   allowBlank: false
	                               }
