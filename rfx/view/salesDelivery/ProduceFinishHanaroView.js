//생산완료 현황
Ext.define('Rfx.view.salesDelivery.ProduceFinishHanaroView', {
    extend: 'Rfx.base.BaseView',
    xtype: 'produce-finish-hanaro-view',
    ...
    initComponent: function () {
        ...
        //this.store.getProxy().setExtraParam('is_complished', 'Y');
