...
//자재 관리
Ext.define('Rfx.view.designPlan.HEAVY5_MyCart', {
    ...
    initComponent: function(){
       ...
       this.reReceiveAction = Ext.create('Ext.Action', {
				 ...
				 if (selections.length) {
                        ...
                        var   request_dates =[];  
		          	    ...
		          	    for(var i=0;i<selections.length;i++){
                            ...
                            var request_date =  o.get('req_date');

                            console_logs('src_currencies------------------', src_currencies);
                            request_dates.push(request_date + ' 00:00:00.000');
                            ...
                            buttons: [
                                {text: CMD_OK,
                                    ...
                                    handler:function(){
                                        ...
                                        //요청사항 값, 추가작성
                                        var commentReq = (Ext.getCmp('commentReq') == undefined || Ext.getCmp('commentReq') == null)
                                        ? null : Ext.getCmp('commentReq').getValue();
                                        ...
                                        console_logs('test>>>>>>>>>>>>>>>>>>>>>>>>> ', selections[0].get('req_date'));
                                        console_logs('request_dates>>>>>>>>>>>>>>>>>>>>> ', request_date);
            ...
            //	            	        		url: CONTEXT_PATH + '/purchase/request.do?method=createheavy',
                                                ...
                                                url: CONTEXT_PATH + '/purchase/request.do?method=createBuyingDateRequest',
                                                params:{
                                                   ...
                                                   // request_dates: Ext.Date.format(request_dates,'Y-m-d H:i:s'),
...
// 					});
      ...
      // buttonToolbar.insert(6, this.outGoAction);
       ...
       buttonToolbar.insert(4, {   name: 'req_date',
       id: gu.id('req_date'),
        format: 'Y-m-d',
        ...
        buttonToolbar.insert(5,this.updateCartmapReqdate);
            ...
            if (selections.length) {
    	    	...
    	    	var my_child=[];
          		...
          		gMain.selPanel.vSELECTED_item_name = rec.get('item_name');    // 품명
                   ...
                   gMain.selPanel.updateCartmapReqdate.enable();
            
             } else {

                 gMain.selPanel.reReceiveAction.disable();
                 gMain.selPanel.updateCartmapReqdate.disable();
             }
             })	
    ...
    refreshStandard_flag: function(record) {
        ...
        treatCartmapReqdate: function() {
            ...
            if (uniqueId == undefined || uniqueId < 0) {
                ...
                Ext.Ajax.request({
                    url: CONTEXT_PATH + '/purchase/request.do?method=updateMyCartReqsate',
                    params: {
                        unique_uids: myCartUids,
                        req_date: req_date
                    },
                    success: function(result, request) {
