...
Ext.define('Rfx.view.ProjectTotalKynl', {
    	...
    	//this.setLoading(true);
	 	Ext.Ajax.request({
			...
			success : function(response, request) {
			    ...
			    for(var i = 0; i < 15; i++) {
                    var d = gu.getNextday(7 * i - today.getDay() - 105);
	            ...
	            sProjectTotalEastNorth['type'] = 'line';
	             ocProjectTotalEastNorth = new Highcharts.Chart({
    				...
    				title: {
    						text: '<div class="title02"><span>' + '납기달성율' + '</span> 종합추이 (주) ' + '</div>',
    	    	            margin: 5,
    	    	            align: 'left',
    	    	            useHTML: true
    	    	        },
     	...
     	Ext.Ajax.request({
           ...
           var sProjectTotalEastCenter = gColumnChartStyle;
            ...
            ocProjectTotalEastCenter = new Highcharts.Chart({
    				...
    				title: {
	    	            text: '<div class="title02"><span>' + '계획생산량' + '</span>  추이 (주)' + '</div>',
	    	            margin: 5,
	    	            margin: 5,
	    	            align: 'left',
	    	            useHTML: true
