...
Ext.define('Ext.calendar.view.Day', {
     ...
     */
    ddCreateEventText: '{0} 에 대한 일정 생성', //'Create event for {0}',
    /**
     ...
     */
    ddMoveEventText: '{0} 로 일정 이동', //'Move event to {0}',
    /**
     * @cfg {Number} dayCount
    ...
    setStartDate: function(dt){
    	//console_logs('Day header.setStartDate', dt)
        this.header.setStartDate(dt, true);
    	//console_logs('Day body.setStartDate', dt)
