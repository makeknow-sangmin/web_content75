...
Ext.define('Rfx.view.groupWare.AccountsReceivableView', {
...
//    	    	var wa_code = Ext.getCmp('wa_code_PPO1TURN').getValue();
   	    	// gm.me().buyerStore.getProxy().setExtraParam('sdate', s_date);
   	    	// gm.me().buyerStore.getProxy().setExtraParam('edate', e_date);
...
//    	    	
//    	    	console_logs('gm.me().SELECTED_UID@@@@@@@@@@@@@', gm.me().SELECTED_UID);
//    	    	
//    	    	var unique_id = gm.me().SELECTED_UID;
...
//			            	    	var wa_code = Ext.getCmp('wa_code_PPO1TURN').getValue();
//			            	    	gm.me().productStore.getProxy().setExtraParam('sdate', s_date);
//			            	    	gm.me().productStore.getProxy().setExtraParam('edate', e_date);
//			            	    	gm.me().productStore.getProxy().setExtraParam('req_date', s_date+":"+e_date);
			            	    	gm.me().buyerStore.getProxy().setExtraParam('name', '%'+lot_no+'%');
//			            	    	gm.me().productStore.getProxy().setExtraParam('wa_code', wa_code);
					...
					},
					{
						...
						listeners: {
							'select': function(rec,data) {
								gm.me().buyerStore.getProxy().setExtraParam('wa_code', data.get('wa_code'));
...
//		this.buyerStore.getProxy().setExtraParam('s_date', s_date);
//		this.buyerStore.getProxy().setExtraParam('e_date', e_date);
