...
Ext.define('Rfx.view.groupWare.AccountsPayableListViewKWLM', {
    extend: 'Rfx.base.BaseView',
    xtype: 'account-list-view-kwlm',
...
//		this.addReadonlyField('board_count');
        ...
        this.addPayMentAction = Ext.create('Ext.Action', {
			itemId:'addPayMentAction',
						...
						handler: function(btn) {
							 if (btn == "no") {
								...
								if (form.isValid()) {
                                    ...
                                    form.submit({
                                        url: CONTEXT_PATH + '/account/arap.do?method=addPayMentDate',
...
//        this.removeAction.setText('반려');
        ...
        buttonToolbar.insert(5, this.addPayMentAction);
       ...
       this.setGridOnCallback(function(selections) {
           if (selections.length) {
            ...
            var final_rec = this.finalGrid.getSelectionModel().getSelection();
               ...
               gm.me().addPayMentAction.disable();
    ...
    useRouting : (vCompanyReserved4 == 'KWLM01KR') ? true : false,
