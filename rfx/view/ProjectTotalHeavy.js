...
Ext.define('Rfx.view.ProjectTotalHeavy', {
    ...
    redrawTotalChart1: function () {
    	...
    	TOTAL_PARAMS['projectChartType'] = 'DAY_PO_CNT';
			...
			success : function(response, request) {
	            ...
	            sProjectTotalEastNorth['type'] = 'column';
	             ocProjectTotalEastNorth = new Highcharts.Chart({
    				...
    				title: {
    						text: '<div class="title02"><span>' + '생산(량)지표' + '</span> 종합추이 (일) ' + '</div>',
    	    	            margin: 5,
    	    	            align: 'left',
    	    	            useHTML: true
    	    	        },
     	...
     	Ext.Ajax.request({
           ...
           var sProjectTotalEastCenter = gColumnChartStyle;
            ...
            ocProjectTotalEastCenter = new Highcharts.Chart({
    				...
    				title: {
	    	            text: '<div class="title02"><span>' + 'W/O 수주현황' + '</span> 종합추이 (일) ' + '</div>',
	    	            margin: 5,
	    	            margin: 5,
	    	            align: 'left',
	    	            useHTML: true
