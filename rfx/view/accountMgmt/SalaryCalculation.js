Ext.define('Rfx.view.accountMgmt.SalaryCalculation', {
    ...
    initComponent: function(){
        ...
        // this.summaryGrid['editingPlugin'] = new Ext.grid.plugin.CellEditing({ clicksToEdit: 1,
        //     listeners: {
        //         'beforeedit': function(e) {
        //             console_logs('>>> beforeedit', e);
        //             var me = this; 
        ...
        this.summaryGrid = Ext.create('Rfx.base.BaseGrid', {
            ...
            listeners: {
                ...
                cellclick: function(iView, iCellEl, iColIdx, iRecord, iRowEl, iRowIdx, iEvent) {
                    ...
                    // this.iCol_idx = iColIdx;
                    // this.iRow_idx = iRowIdx;
                },
                edit: function (editor, e, eOpts) {
                    var idx = this.selColIdx;
                    var pos = Math.trunc(idx/2);
