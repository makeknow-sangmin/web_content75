Ext.define('Rfx.view.accountMgmt.PaySystem', {
    ...
    initComponent: function(){
        ...
        this.grid.normalGrid.on('viewready', function(grid){
            console.log('Normal: View Ready');
        });
         
        this.grid.lockedGrid.on('viewready', function(grid){
            console.log('Locked: View Ready');
        });
    ...
    // cellNextRow: vCompanyReserved4 == 'KWLM01KR' ? true : false,
