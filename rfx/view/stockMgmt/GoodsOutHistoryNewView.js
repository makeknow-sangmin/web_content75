Ext.define('Rfx.view.stockMgmt.GoodsOutHistoryNewView', {
    extend: 'Rfx.base.BaseView',
    xtype: 'goods-out-history-new-view',
    initComponent: function () {
        ...
        this.store.getProxy().setExtraParam('orderBy', 'reserved_timestamp1');
        ...
        //         groupHeaderTpl: '<div><font color=#003471><b>{name} - {[values.rows[0].data.pj_name]}</b></font> ({rows.length})</div>'
        //     }
        // };

        //grid 생성.
        // this.createGridCore(arr, option);
        this.createGridCore(arr,{selModel:{
