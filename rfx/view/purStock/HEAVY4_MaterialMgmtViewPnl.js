...
//자재 관리
Ext.define('Rfx.view.purStock.HEAVY4_MaterialMgmtViewPnl', {
...
//	            					url: CONTEXT_PATH + '/purchase/prch.do?method=create',
            ...
            handler: function (widget, event) {
                ...
                for (var i = 0; i < selections.length; i++) {
                    ...
                    if (item_type == 'S') {
                        ...
                        gm.editAjax('srcahd', 'change_date', new Date(), 'unique_id', srcahd_uid, {type: ''});
                        gm.editAjax('srcahd', 'changer', vCUR_USER_ID, 'unique_id', srcahd_uid, {type: ''});
                    } else {
        ...
        if(vCompanyReserved4 != 'WOWT01KR'){
            if(vCompanyReserved4 == 'SKNH01KR' && this.link == 'PMT1_PNL2'){
                    ...
                    form.submit({
                        ...
                        params:{ 
                           // barcodes: uniqueIdArr
                            barcodeUidArr : srcahdUidArr,
                            print_type : 'SRCAHD',
                            print_qty : val.print_qty,
                            itemNameArr : itemNameArr,
                            itemCodeArr : itemCodeArr,
                            specificationArr : spcArr,
                            spcStr : spcStr,
                            modelNoArr : modelNoArr
                        },
