Ext.define('Rfx.view.purStock.HEAVY4_WearingStateNewView', {
    extend: 'Rfx.base.BaseView',
    xtype: 'wearing-new-view',
    initComponent: function () {
        ...
        this.createStoreSimple({
            modelClass: 'Rfx2.model.WearingNoSumState',
            sorters: [{
                property: 'gr_date',
                direction: 'DESC'
            }],
        ...
        this.store.getProxy().setExtraParam('orderBy', "gr_date");
        ...
        this.setGridOnCallback(function (selections) {
            ...
            if (vCompanyReserved4 == 'SKNH01KR' || vCompanyReserved4 == 'KWLM01KR') {
                ...
                this.buttonToolbar3.items.items[1].update('총 금액 : ' + gUtil.renderNumber(total_price_sum) + ' / 주문 총 수량 : ' + total_qty);
            }
