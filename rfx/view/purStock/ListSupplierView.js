...
Ext.define('Rfx.view.purStock.ListSupplierView', {
		...
		switch(vCompanyReserved4) {
			case 'KYNL01KR':
                ...
                this.addSearchField({
                    ...
                    sqlName: 'supast',
                    tableName: 'supast',
                    field_id: 'business_condition',
                    fieldName: 'business_condition',
                    params: {
                    }
                });
                this.addSearchField({
...
//            layout: 'border',
    ...
    updateComment: function(rec) {
        ...
        var sourcing_comment = rec.get('sourcing_comment');
