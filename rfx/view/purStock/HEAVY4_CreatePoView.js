            ...
            case 'KWLM01KR':
                ...
                Ext.each(this.columns, function (columnObj, index) {
                    ...
                    switch (dataIndex) {
                        ...
                        case 'item_code':
                            columnObj['renderer'] = function (value) {
                                return '<a href="javascript:gMain.selPanel.renderMoveBom()">' + value + '</a>'
                            };
                            break;
                        case 'sales_price':
                            columnObj["editor"] = {};
        ...
        switch (vCompanyReserved4) {
            ...
            case 'SKNH01KR':
                ...
                buttonToolbar.insert(6, {
                    ...
                    id: gu.id('req_date'),
                    format: 'Y-m-d',
                    fieldStyle: 'background-color: #D6E8F61; background-image: none;',
                    submitFormat: 'Y-m-d',// 'Y-m-d H:i:s',
                    dateFormat: 'Y-m-d',// 'Y-m-d H:i:s'
                    allowBlank: true,
                    xtype: 'datefield',
                ...
                buttonToolbar.insert(12, this.splitPrAction);
