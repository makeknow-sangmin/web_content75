Ext.define('Rfx.view.executiveInfo.SpcAnalysisRealTimeView', {
    ...
    initComponent: function(){
        ...
        var gridViewTable2 = Ext.create('Ext.grid.Panel', {
            //title: '분석표 목록',
            store: storeViewTable,
            cls : 'rfx-panel',
            //region:'west',
        ...
        var tabView2 = Ext.create('Ext.tab.Panel', {
            // frame: true,
            region: 'center',
            collapsible: false,
            border: false,
            ...
            items: [{
                ...
                margin: '5 0 0 0',
                width: '45%',
                items: [gridInspect, gridViewTable]
            }*/]
            ,
            listeners: {
                tabchange: function(tabPanel, newTab, oldTab, eOpts)  {
