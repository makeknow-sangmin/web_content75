Ext.define('Rfx.view.executiveInfo.MeasureDataUploadView', {
                    ...
                    for(var j = 2; j < 30; j++) {
                        ...
                        if(value2 !== null) {
                            ...
                            switch(columnName2) {
                                ...
                                case 'Diameter':
                                case 'counts':
                                case 'Sn':case 'Ag':case 'Cu':case 'Ni':case 'Sb':case 'Al':case 'Cd':
                                case 'Fe':case 'Zn':case 'Bi':case 'As':case 'In':case 'Pb':case 'Au':
                                case 'P':case 'Ge':case 'S':case 'Co':
                                    var subSplit = columnSplit2[1].split(';');
                                    for(var k = 0; k < subSplit.length - 1; k++) {
                                        if(j == 2) {
                                            var objv = {};
