Ext.define('Rfx.base.BaseGrid', {
    ...
    listeners: {
        ...
        cellkeydown (td, cellIndex, record, tr, rowIndex, e, eOpts) {

            if (eOpts.ctrlKey && eOpts.keyCode === 67) {

                var obj = JSON.parse(JSON.stringify(cellIndex));
                var isSynchronized = obj._extData.isSynchronized;
